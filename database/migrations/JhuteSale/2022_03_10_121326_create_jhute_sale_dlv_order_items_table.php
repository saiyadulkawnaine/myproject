...
class CreateJhuteSaleDlvOrderItemsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('jhute_sale_dlv_order_items', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('jhute_sale_dlv_order_items');
    }
}
