...
class CreateGateOutItemsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('gate_out_items', function (Blueprint $table) {
            $table->increments('id');
            $table->Integer('gate_out_id')->unsigned();
            $table->foreign('gate_out_id')->references('id')->on('gate_outs')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('gate_out_items');
    }
}
