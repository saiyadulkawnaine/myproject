...
class CreateInvFinishFabItemsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('inv_finish_fab_items', function (Blueprint $table) {
            ...
            $table->unique(['autoyarn_id', 'gmtspart_id','fabric_look_id','fabric_shape_id','gsm_weight','dia','measurment','roll_length','stitch_length','shrink_per','colorrange_id','color_id'],'finish_fab_item_uq');
    ...
    {
        Schema::dropIfExists('inv_finish_fab_items');
    }
}
