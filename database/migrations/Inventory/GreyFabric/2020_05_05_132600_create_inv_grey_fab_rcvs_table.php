...
class CreateInvGreyFabRcvsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('inv_grey_fab_rcvs', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->foreign('prod_knit_dlv_id')->references('id')->on('prod_knit_dlvs')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('inv_grey_fab_rcvs');
    }
}
