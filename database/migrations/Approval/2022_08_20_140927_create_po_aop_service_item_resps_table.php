...
class CreatePoAopServiceItemRespsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('po_aop_service_item_resps', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('po_aop_service_item_resps');
    }
}
