...
class CreatePoFabricItemRespsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('po_fabric_item_resps', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('po_fabric_item_resps');
    }
}
