...
class CreatePoEmbServiceItemRespsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('po_emb_service_item_resps', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('po_emb_service_item_resps');
    }
}
