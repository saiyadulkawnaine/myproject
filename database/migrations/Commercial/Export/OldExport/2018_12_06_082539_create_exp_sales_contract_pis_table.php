...
class CreateExpSalesContractPisTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('exp_sales_contract_pis', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('exp_sales_contract_pis');
    }
}
