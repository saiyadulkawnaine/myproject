...
class CreateExpProRlzAmountsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('exp_pro_rlz_amounts', function (Blueprint $table) {
            ...
            $table->integer('ac_loan_id')->unsigned()->nullable();
            $table->integer('acc_term_loan_payment_id')->unsigned()->nullable();
            $table->foreign('acc_term_loan_payment_id')->references('id')->on('acc_term_loan_payments');
