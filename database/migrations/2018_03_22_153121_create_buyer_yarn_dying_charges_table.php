...
class CreateBuyerYarnDyingChargesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('buyer_yarn_dying_charges', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('buyer_yarn_dying_charges');
    }
}
