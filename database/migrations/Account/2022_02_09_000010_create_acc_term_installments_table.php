...
class CreateAccTermInstallmentsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('acc_term_installments', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('acc_term_installments');
    }
}
