...
class CreateAccTransChldsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('acc_trans_chlds', function (Blueprint $table) {
            ...
            $table->unsignedTinyInteger('party_type_id')->nullable();
            ...
            $table->unsignedInteger('import_lc_id')->nullable();
            $table->string('import_lc_ref_no',100)->nullable();
    ...
    {
        Schema::dropIfExists('acc_trans_chlds');
    }
}
