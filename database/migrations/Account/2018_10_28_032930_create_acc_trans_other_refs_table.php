...
class CreateAccTransOtherRefsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('acc_trans_other_refs', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('acc_trans_other_refs');
    }
}
