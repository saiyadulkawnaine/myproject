...
class CreatePoFabricsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('po_fabrics', function (Blueprint $table) {
            ...
            $table->unsignedInteger('is_system_generated')->nullable()->default(0);
            ...
            $table->unsignedInteger('indentor_id')->nullable();
    ...
    {
        Schema::dropIfExists('po_fabrics');
    }
}
