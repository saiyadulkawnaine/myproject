...
class CreateKnitChargeSuppliersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('knit_charge_suppliers', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('knit_charge_suppliers');
    }
}
