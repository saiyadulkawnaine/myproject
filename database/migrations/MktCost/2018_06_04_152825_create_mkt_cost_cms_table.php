...
class CreateMktCostCmsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('mkt_cost_cms', function (Blueprint $table) {
          $table->increments('id')->unsignedInteger();
          $table->unsignedInteger('mkt_cost_id');
    ...
    {
        Schema::dropIfExists('mkt_cost_cms');
    }
}
