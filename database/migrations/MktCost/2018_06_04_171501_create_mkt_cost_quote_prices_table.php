...
class CreateMktCostQuotePricesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('mkt_cost_quote_prices', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('mkt_cost_quote_prices');
    }
}
