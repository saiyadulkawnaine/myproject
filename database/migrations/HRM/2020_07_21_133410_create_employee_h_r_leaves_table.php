...
class CreateEmployeeHRLeavesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        Schema::dropIfExists('employee_h_r_leaves');
    }
}
