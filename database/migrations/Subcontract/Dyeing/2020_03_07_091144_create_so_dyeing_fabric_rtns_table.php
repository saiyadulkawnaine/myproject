...
class CreateSoDyeingFabricRtnsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('so_dyeing_fabric_rtns', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('so_dyeing_fabric_rtns');
    }
}
