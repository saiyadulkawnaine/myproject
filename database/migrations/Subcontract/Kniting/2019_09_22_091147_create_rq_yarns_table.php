...
class CreateRqYarnsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('rq_yarns', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->unsignedSmallInteger('ready_to_approve_id')->nullable();
