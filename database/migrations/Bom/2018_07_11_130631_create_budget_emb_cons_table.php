...
class CreateBudgetEmbConsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('budget_emb_cons', function (Blueprint $table) {
            $table->increments('id')->unsignedInteger();
            $table->unsignedInteger('budget_emb_id')->unsigned();
    ...
    {
        Schema::dropIfExists('budget_emb_cons');
    }
}
