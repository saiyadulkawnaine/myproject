...
class CreateBudgetTrimConsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('budget_trim_cons', function (Blueprint $table) {
          ...
          $table->foreign('sales_order_gmt_color_size_id')->references('id')->on('sales_order_gmt_color_sizes')->onDelete('cascade');
		      $table->string('style_gmt_id',10)->nullable();
          ...
          $table->string('measurment',100)->nullable();
    ...
    {
        Schema::dropIfExists('budget_trim_cons');
    }
}
