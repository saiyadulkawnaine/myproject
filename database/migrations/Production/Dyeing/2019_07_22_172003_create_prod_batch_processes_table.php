...
class CreateProdBatchProcessesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('prod_batch_processes', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->integer('root_batch_process_id')->unsigned();
    ...
    {
        Schema::dropIfExists('prod_batch_processes');
    }
}
