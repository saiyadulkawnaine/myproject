...
var MsStyleFabricationStripeModel = __webpack_require__(300);

var MsStyleFabricationStripeController = function () {
	function MsStyleFabricationStripeController(MsStyleFabricationStripeModel) {
		_classCallCheck(this, MsStyleFabricationStripeController);
	...
	_createClass(MsStyleFabricationStripeController, [{
		key: 'submit',
	...
	return MsStyleFabricationStripeController;
}();
...
var MsStyleFabricationStripeModel = function (_MsModel) {
	_inherits(MsStyleFabricationStripeModel, _MsModel);

	function MsStyleFabricationStripeModel() {
		_classCallCheck(this, MsStyleFabricationStripeModel);

		return _possibleConstructorReturn(this, (MsStyleFabricationStripeModel.__proto__ || Object.getPrototypeOf(MsStyleFabricationStripeModel)).call(this));
	}

	return MsStyleFabricationStripeModel;
}(MsModel);

module.exports = MsStyleFabricationStripeModel;
