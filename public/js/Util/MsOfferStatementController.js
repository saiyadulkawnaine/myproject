...
var MsOfferStatementModel = __webpack_require__(47);
__webpack_require__(3);

var MsOfferStatementController = function () {
	function MsOfferStatementController(MsOfferStatementModel) {
		_classCallCheck(this, MsOfferStatementController);
	...
	_createClass(MsOfferStatementController, [{
		key: 'get',
		value: function get() {
			var params = {};
		...
		value: function showGrid(data) {
			...
			dg.datagrid({
				...
				onLoadSuccess: function onLoadSuccess(data) {
					...
					$(this).datagrid('reloadFooter', [{ pdf: ' ' }]);
				}
			});
		...
		key: 'imageWindow',
		value: function imageWindow(flie_src) {
		...
		key: 'formatpdf',
		value: function formatpdf(value, row) {
		...
		key: 'formatimage',
		value: function formatimage(value, row) {
		...
		key: 'quotedprice',
		value: function quotedprice(value, row, index) {
		...
		key: 'frofitformat',
		value: function frofitformat(value, row, index) {
			if (value < 0) {
				return 'color:red;';
			}
		}
	...
	return MsOfferStatementController;
}();
...
var MsOfferStatementModel = function (_MsModel) {
	_inherits(MsOfferStatementModel, _MsModel);

	function MsOfferStatementModel() {
		_classCallCheck(this, MsOfferStatementModel);

		return _possibleConstructorReturn(this, (MsOfferStatementModel.__proto__ || Object.getPrototypeOf(MsOfferStatementModel)).call(this));
	}

	return MsOfferStatementModel;
}(MsModel);

module.exports = MsOfferStatementModel;
