...
var MsStyleFabricationModel = __webpack_require__(297);

var MsStyleFabricationController = function () {
	function MsStyleFabricationController(MsStyleFabricationModel) {
		_classCallCheck(this, MsStyleFabricationController);
	...
	_createClass(MsStyleFabricationController, [{
		key: 'submit',
	...
	return MsStyleFabricationController;
}();
...
var MsStyleFabricationModel = function (_MsModel) {
	_inherits(MsStyleFabricationModel, _MsModel);

	function MsStyleFabricationModel() {
		_classCallCheck(this, MsStyleFabricationModel);

		return _possibleConstructorReturn(this, (MsStyleFabricationModel.__proto__ || Object.getPrototypeOf(MsStyleFabricationModel)).call(this));
	}

	return MsStyleFabricationModel;
}(MsModel);

module.exports = MsStyleFabricationModel;
