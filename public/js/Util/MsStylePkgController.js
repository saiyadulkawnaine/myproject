...
var MsStylePkgModel = __webpack_require__(306);

var MsStylePkgController = function () {
	function MsStylePkgController(MsStylePkgModel) {
		_classCallCheck(this, MsStylePkgController);
	...
	_createClass(MsStylePkgController, [{
		key: 'submit',
...
var MsStylePkgModel = function (_MsModel) {
	_inherits(MsStylePkgModel, _MsModel);

	function MsStylePkgModel() {
		_classCallCheck(this, MsStylePkgModel);

		return _possibleConstructorReturn(this, (MsStylePkgModel.__proto__ || Object.getPrototypeOf(MsStylePkgModel)).call(this));
	}

	return MsStylePkgModel;
}(MsModel);

module.exports = MsStylePkgModel;
