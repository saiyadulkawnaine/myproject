...
var MsSalesOrderCountryModel = __webpack_require__(325);

var MsSalesOrderCountryController = function () {
	function MsSalesOrderCountryController(MsSalesOrderCountryModel) {
		_classCallCheck(this, MsSalesOrderCountryController);
	...
	_createClass(MsSalesOrderCountryController, [{
		key: 'submit',
		...
		value: function response(d) {
			...
			//$('#SalesOrderCountryFrm  [name=id]').val(d.id);
	...
	return MsSalesOrderCountryController;
}();
...
var MsSalesOrderCountryModel = function (_MsModel) {
	_inherits(MsSalesOrderCountryModel, _MsModel);

	function MsSalesOrderCountryModel() {
		_classCallCheck(this, MsSalesOrderCountryModel);

		return _possibleConstructorReturn(this, (MsSalesOrderCountryModel.__proto__ || Object.getPrototypeOf(MsSalesOrderCountryModel)).call(this));
	}

	return MsSalesOrderCountryModel;
}(MsModel);

module.exports = MsSalesOrderCountryModel;
