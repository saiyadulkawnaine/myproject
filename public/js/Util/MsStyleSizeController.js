...
var MsStyleSizeModel = __webpack_require__(324);

var MsStyleSizeController = function () {
	function MsStyleSizeController(MsStyleSizeModel) {
		_classCallCheck(this, MsStyleSizeController);
	...
	_createClass(MsStyleSizeController, [{
		key: 'submit',
...
var MsStyleSizeModel = function (_MsModel) {
	_inherits(MsStyleSizeModel, _MsModel);

	function MsStyleSizeModel() {
		_classCallCheck(this, MsStyleSizeModel);

		return _possibleConstructorReturn(this, (MsStyleSizeModel.__proto__ || Object.getPrototypeOf(MsStyleSizeModel)).call(this));
	}

	return MsStyleSizeModel;
}(MsModel);

module.exports = MsStyleSizeModel;
