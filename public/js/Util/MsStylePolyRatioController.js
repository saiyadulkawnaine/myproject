...
var MsStylePolyRatioModel = __webpack_require__(315);

var MsStylePolyRatioController = function () {
	function MsStylePolyRatioController(MsStylePolyRatioModel) {
		_classCallCheck(this, MsStylePolyRatioController);
	...
	_createClass(MsStylePolyRatioController, [{
		key: 'submit',
	...
	return MsStylePolyRatioController;
}();
...
var MsStylePolyRatioModel = function (_MsModel) {
	_inherits(MsStylePolyRatioModel, _MsModel);

	function MsStylePolyRatioModel() {
		_classCallCheck(this, MsStylePolyRatioModel);

		return _possibleConstructorReturn(this, (MsStylePolyRatioModel.__proto__ || Object.getPrototypeOf(MsStylePolyRatioModel)).call(this));
	}

	return MsStylePolyRatioModel;
}(MsModel);
