...
var MsStyleGmtsModel = __webpack_require__(303);

var MsStyleGmtsController = function () {
	function MsStyleGmtsController(MsStyleGmtsModel) {
		_classCallCheck(this, MsStyleGmtsController);
	...
	_createClass(MsStyleGmtsController, [{
		key: 'submit',
		...
		value: function response(d) {
			...
			$('#stylecolorFrm  [name=style_gmt_id]').val(d.id);
			$('#stylecolorFrm  [name=style_id]').val(d.style_id);

			msApp.resetForm('stylesizeFrm');
			$('#stylesizeFrm  [name=style_gmt_id]').val(d.id);
			$('#stylesizeFrm  [name=style_id]').val(d.style_id);
		...
		value: function edit(index, row) {
			...
			this.MsStyleGmtsModel.get(index, row);
			msApp.resetForm('styleembelishmentFrm');
			...
			msApp.resetForm('stylecolorFrm');
			$('#stylecolorFrm  [name=style_gmt_id]').val(row.id);
			$('#stylecolorFrm  [name=style_id]').val(row.style_id);
			MsStyleColor.showGrid(row.id);

			msApp.resetForm('stylesizeFrm');
			$('#stylesizeFrm  [name=style_gmt_id]').val(row.id);
			$('#stylesizeFrm  [name=style_id]').val(row.style_id);
...
var MsStyleGmtsModel = function (_MsModel) {
	_inherits(MsStyleGmtsModel, _MsModel);

	function MsStyleGmtsModel() {
		_classCallCheck(this, MsStyleGmtsModel);

		return _possibleConstructorReturn(this, (MsStyleGmtsModel.__proto__ || Object.getPrototypeOf(MsStyleGmtsModel)).call(this));
	}

	return MsStyleGmtsModel;
}(MsModel);

module.exports = MsStyleGmtsModel;
