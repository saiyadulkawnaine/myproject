...
var MsStyleSampleCsModel = __webpack_require__(321);

var MsStyleSampleCsController = function () {
	function MsStyleSampleCsController(MsStyleSampleCsModel) {
		_classCallCheck(this, MsStyleSampleCsController);
	...
	_createClass(MsStyleSampleCsController, [{
		key: 'submit',
	...
	return MsStyleSampleCsController;
}();
...
var MsStyleSampleCsModel = function (_MsModel) {
	_inherits(MsStyleSampleCsModel, _MsModel);

	function MsStyleSampleCsModel() {
		_classCallCheck(this, MsStyleSampleCsModel);

		return _possibleConstructorReturn(this, (MsStyleSampleCsModel.__proto__ || Object.getPrototypeOf(MsStyleSampleCsModel)).call(this));
	}

	return MsStyleSampleCsModel;
}(MsModel);

module.exports = MsStyleSampleCsModel;
