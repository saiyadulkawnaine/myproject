...
var MsStyleSampleModel = __webpack_require__(318);

var MsStyleSampleController = function () {
	function MsStyleSampleController(MsStyleSampleModel) {
		_classCallCheck(this, MsStyleSampleController);
	...
	_createClass(MsStyleSampleController, [{
		key: 'submit',
	...
	return MsStyleSampleController;
}();
...
var MsStyleSampleModel = function (_MsModel) {
	_inherits(MsStyleSampleModel, _MsModel);

	function MsStyleSampleModel() {
		_classCallCheck(this, MsStyleSampleModel);

		return _possibleConstructorReturn(this, (MsStyleSampleModel.__proto__ || Object.getPrototypeOf(MsStyleSampleModel)).call(this));
	}

	return MsStyleSampleModel;
}(MsModel);

module.exports = MsStyleSampleModel;
