...
var MsSalesOrderColorModel = __webpack_require__(328);

var MsSalesOrderColorController = function () {
	function MsSalesOrderColorController(MsSalesOrderColorModel) {
		_classCallCheck(this, MsSalesOrderColorController);
	...
	_createClass(MsSalesOrderColorController, [{
		key: 'submit',
		...
		key: 'setColorDetails',
		value: function setColorDetails(style_color_id) {
			axios.get(msApp.baseUrl() + '/stylecolor/' + style_color_id + "/edit").then(function (response) {
	...
	return MsSalesOrderColorController;
}();
...
var MsSalesOrderColorModel = function (_MsModel) {
	_inherits(MsSalesOrderColorModel, _MsModel);

	function MsSalesOrderColorModel() {
		_classCallCheck(this, MsSalesOrderColorModel);

		return _possibleConstructorReturn(this, (MsSalesOrderColorModel.__proto__ || Object.getPrototypeOf(MsSalesOrderColorModel)).call(this));
	}

	return MsSalesOrderColorModel;
}(MsModel);

module.exports = MsSalesOrderColorModel;
