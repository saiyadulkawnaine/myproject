...
var MsSalesOrderSizeModel = __webpack_require__(331);

var MsSalesOrderSizeController = function () {
	function MsSalesOrderSizeController(MsSalesOrderSizeModel) {
		_classCallCheck(this, MsSalesOrderSizeController);
	...
	_createClass(MsSalesOrderSizeController, [{
		key: 'submit',
		...
		value: function response(d) {
			...
			//$('#SalesOrderSizeFrm  [name=id]').val(d.id);
		...
		key: 'calculate',
		value: function calculate(iteration, count) {
			var qty = $('input[name="qty[' + iteration + ']"]').val();
			var rate = $('input[name="rate[' + iteration + ']"]').val();
			var amount = msApp.multiply(qty, rate);
			$('input[name="amount[' + iteration + ']"]').val(amount);
			this.copy(qty, rate, amount, iteration, count);
		}
	}, {
		key: 'copy',
		value: function copy(qty, rate, amount, iteration, count) {
	...
	return MsSalesOrderSizeController;
}();
...
var MsSalesOrderSizeModel = function (_MsModel) {
	_inherits(MsSalesOrderSizeModel, _MsModel);

	function MsSalesOrderSizeModel() {
		_classCallCheck(this, MsSalesOrderSizeModel);

		return _possibleConstructorReturn(this, (MsSalesOrderSizeModel.__proto__ || Object.getPrototypeOf(MsSalesOrderSizeModel)).call(this));
	}

	return MsSalesOrderSizeModel;
}(MsModel);

module.exports = MsSalesOrderSizeModel;
