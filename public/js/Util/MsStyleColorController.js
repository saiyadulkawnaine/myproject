...
var MsStyleColorModel = __webpack_require__(288);

var MsStyleColorController = function () {
	function MsStyleColorController(MsStyleColorModel) {
		_classCallCheck(this, MsStyleColorController);
	...
	_createClass(MsStyleColorController, [{
		key: 'submit',
...
var MsStyleColorModel = function (_MsModel) {
	_inherits(MsStyleColorModel, _MsModel);

	function MsStyleColorModel() {
		_classCallCheck(this, MsStyleColorModel);

		return _possibleConstructorReturn(this, (MsStyleColorModel.__proto__ || Object.getPrototypeOf(MsStyleColorModel)).call(this));
	}

	return MsStyleColorModel;
}(MsModel);

module.exports = MsStyleColorModel;
