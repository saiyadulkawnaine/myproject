...
var MsStyleEvaluationModel = __webpack_require__(294);

var MsStyleEvaluationController = function () {
	function MsStyleEvaluationController(MsStyleEvaluationModel) {
		_classCallCheck(this, MsStyleEvaluationController);
	...
	_createClass(MsStyleEvaluationController, [{
		key: 'submit',
	...
	return MsStyleEvaluationController;
}();
...
var MsStyleEvaluationModel = function (_MsModel) {
	_inherits(MsStyleEvaluationModel, _MsModel);

	function MsStyleEvaluationModel() {
		_classCallCheck(this, MsStyleEvaluationModel);

		return _possibleConstructorReturn(this, (MsStyleEvaluationModel.__proto__ || Object.getPrototypeOf(MsStyleEvaluationModel)).call(this));
	}

	return MsStyleEvaluationModel;
}(MsModel);

module.exports = MsStyleEvaluationModel;
