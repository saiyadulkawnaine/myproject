...
var MsMktCostFabricModel = __webpack_require__(333);

var MsMktCostFabricController = function () {
	function MsMktCostFabricController(MsMktCostFabricModel) {
		_classCallCheck(this, MsMktCostFabricController);
	...
	_createClass(MsMktCostFabricController, [{
		key: 'submit',
		value: function submit(formObj, idx) {
			var self = this;
			//let formObj=msApp.get(this.formId);
			if (formObj.id) {
				this.MsMktCostFabricModel.saves(this.route + "/" + formObj.id, 'put', msApp.qs.stringify(formObj), this.response);
			} else {
				var data = this.MsMktCostFabricModel.saves(this.route, 'post', msApp.qs.stringify(formObj), this.response);
				data.then(function (response) {
		...
		value: function response(d) {
			/*$('#mktcostfabricTbl').datagrid('reload');
   msApp.resetForm('mktcostfabricFrm');*/
		}
	}, {
		key: 'openConsWindow',
		value: function openConsWindow(id) {
			var data = axios.get(this.route + "/" + id + '/edit');
		...
		value: function edit(index, row) {
			...
			var data = this.MsMktCostFabricModel.get(index, row);
		}
	}, {
		key: 'showGrid',
...
var MsMktCostFabricModel = function (_MsModel) {
	_inherits(MsMktCostFabricModel, _MsModel);

	function MsMktCostFabricModel() {
		_classCallCheck(this, MsMktCostFabricModel);

		return _possibleConstructorReturn(this, (MsMktCostFabricModel.__proto__ || Object.getPrototypeOf(MsMktCostFabricModel)).call(this));
	}

	return MsMktCostFabricModel;
}(MsModel);
