...
var MsStylePkgRatioModel = __webpack_require__(309);

var MsStylePkgRatioController = function () {
	function MsStylePkgRatioController(MsStylePkgRatioModel) {
		_classCallCheck(this, MsStylePkgRatioController);
	...
	_createClass(MsStylePkgRatioController, [{
		key: 'submit',
   ...
   console.log(error);
	...
	return MsStylePkgRatioController;
}();
...
var MsStylePkgRatioModel = function (_MsModel) {
	_inherits(MsStylePkgRatioModel, _MsModel);

	function MsStylePkgRatioModel() {
		_classCallCheck(this, MsStylePkgRatioModel);

		return _possibleConstructorReturn(this, (MsStylePkgRatioModel.__proto__ || Object.getPrototypeOf(MsStylePkgRatioModel)).call(this));
	}

	return MsStylePkgRatioModel;
}(MsModel);

module.exports = MsStylePkgRatioModel;
