...
var MsSalesOrderModel = __webpack_require__(322);

var MsSalesOrderController = function () {
	function MsSalesOrderController(MsSalesOrderModel) {
		_classCallCheck(this, MsSalesOrderController);
	...
	_createClass(MsSalesOrderController, [{
		key: 'submit',
		...
		value: function response(d) {
			...
			//$('#SalesOrderFrm  [name=id]').val(d.id);
...
var MsSalesOrderModel = function (_MsModel) {
	_inherits(MsSalesOrderModel, _MsModel);

	function MsSalesOrderModel() {
		_classCallCheck(this, MsSalesOrderModel);

		return _possibleConstructorReturn(this, (MsSalesOrderModel.__proto__ || Object.getPrototypeOf(MsSalesOrderModel)).call(this));
	}

	return MsSalesOrderModel;
}(MsModel);

module.exports = MsSalesOrderModel;
