...
var MsTrimsOrderProgressReportModel = __webpack_require__(182);
__webpack_require__(2);

var MsTrimsOrderProgressReportController = function () {
	function MsTrimsOrderProgressReportController(MsTrimsOrderProgressReportModel) {
		_classCallCheck(this, MsTrimsOrderProgressReportController);
	...
	_createClass(MsTrimsOrderProgressReportController, [{
		key: 'getParams',
		...
		key: 'openTrimsReportStyleWindow',
		value: function openTrimsReportStyleWindow() {
			$('#trimsreportstyleWindow').window('open');
		}
	}, {
		key: 'getTrimsReportStyleParams',
		value: function getTrimsReportStyleParams() {
			var params = {};
		...
		key: 'searchTrimsReportStyle',
		value: function searchTrimsReportStyle() {
			var params = this.getTrimsReportStyleParams();
			var d = axios.get(msApp.baseUrl() + "/trimsorderprogressreport/gettrimsstyle", { params: params }).then(function (response) {
		...
		key: 'showTrimsReportStyleGrid',
		value: function showTrimsReportStyleGrid(data) {
			var self = this;
		...
		key: 'openTrimsReportTeammemberDlmWindow',
		value: function openTrimsReportTeammemberDlmWindow() {
			$('#trimsreportteammemberDlmWindow').window('open');
		}
	}, {
		key: 'getTdlmParams',
		value: function getTdlmParams() {
			var params = {};
			params.team_id = $('#trimsreportteammemberdlmFrm  [name=team_id]').val();
			return params;
		}
	}, {
		key: 'searchTrimsTeammemberDlmGrid',
		value: function searchTrimsTeammemberDlmGrid() {
			var params = this.getTdlmParams();
			var dlm = axios.get(msApp.baseUrl() + "/trimsorderprogressreport/gettrimsteammemberdlm", { params: params }).then(function (response) {
		...
		key: 'showTrimsTeammemberDlmGrid',
		value: function showTrimsTeammemberDlmGrid(data) {
			var self = this;
		...
		key: 'potrimqtyWindow',
		value: function potrimqtyWindow(sales_order_id, itemclass_id) {
			var params = this.getParams();
			params.sales_order_id = sales_order_id;
			params.itemclass_id = itemclass_id;
			var data = axios.get(msApp.baseUrl() + "/trimsorderprogressreport/getpotrimqty", { params: params });
			data.then(function (response) {
		...
		key: 'showGridPoTrimQty',
		value: function showGridPoTrimQty(data) {
		...
		key: 'formatpotrimqty',
		value: function formatpotrimqty(value, row) {
		...
		key: 'rcvtrimqtyWindow',
		value: function rcvtrimqtyWindow(sales_order_id, itemclass_id) {
			var params = this.getParams();
			params.sales_order_id = sales_order_id;
			params.itemclass_id = itemclass_id;
			var data = axios.get(msApp.baseUrl() + "/trimsorderprogressreport/getrcvtrimqty", { params: params });
			data.then(function (response) {
		...
		key: 'showGridRcvTrimQty',
		value: function showGridRcvTrimQty(data) {
		...
		key: 'formatrcvtrimqty',
		value: function formatrcvtrimqty(value, row) {
	...
	return MsTrimsOrderProgressReportController;
}();
...
var MsTrimsOrderProgressReportModel = function (_MsModel) {
	_inherits(MsTrimsOrderProgressReportModel, _MsModel);

	function MsTrimsOrderProgressReportModel() {
		_classCallCheck(this, MsTrimsOrderProgressReportModel);

		return _possibleConstructorReturn(this, (MsTrimsOrderProgressReportModel.__proto__ || Object.getPrototypeOf(MsTrimsOrderProgressReportModel)).call(this));
	}

	return MsTrimsOrderProgressReportModel;
}(MsModel);

module.exports = MsTrimsOrderProgressReportModel;
