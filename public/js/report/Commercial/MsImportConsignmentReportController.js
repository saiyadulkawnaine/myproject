...
var MsImportConsignmentReportModel = __webpack_require__(194);
__webpack_require__(2);

var MsImportConsignmentReportController = function () {
	function MsImportConsignmentReportController(MsImportConsignmentReportModel) {
		_classCallCheck(this, MsImportConsignmentReportController);
	...
	_createClass(MsImportConsignmentReportController, [{
		key: 'getParams',
		...
		key: 'fileWindow',
		value: function fileWindow(id) {

			var data = axios.get(msApp.baseUrl() + "/importconsignmentreport/getfile?id=" + id);
			data.then(function (response) {
		...
		key: 'showGridFileSrc',
		value: function showGridFileSrc(data) {
		...
		key: 'formatImportfile',
		value: function formatImportfile(value, row) {
			return '<a href="javascript:void(0)" onClick="MsImportConsignmentReport.fileWindow(' + row.id + ')">' + row.menu_id + '</a>';
		}
	}, {
		key: 'formatShowFile',
		value: function formatShowFile(value, row) {
			return '<a download href="' + msApp.baseUrl() + "/images/" + row.file_src + '">' + row.original_name + '</a>';
		}
	}, {
		key: 'getbankpending',
		value: function getbankpending() {

			var params = this.getParams();
			var d = axios.get(this.route + '/bankpending', { params: params }).then(function (response) {
	...
	return MsImportConsignmentReportController;
}();
...
var MsImportConsignmentReportModel = function (_MsModel) {
	_inherits(MsImportConsignmentReportModel, _MsModel);

	function MsImportConsignmentReportModel() {
		_classCallCheck(this, MsImportConsignmentReportModel);

		return _possibleConstructorReturn(this, (MsImportConsignmentReportModel.__proto__ || Object.getPrototypeOf(MsImportConsignmentReportModel)).call(this));
	}

	return MsImportConsignmentReportModel;
}(MsModel);

module.exports = MsImportConsignmentReportModel;
