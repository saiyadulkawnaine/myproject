...
<table cellspacing="0" cellpadding="2" border="1">
    <thead>
        <tr>
            ...
            <td width="65" align="center">R. Color</td>
            <td width="65" align="center">B. Color</td>
    ...
    <tbody>
        ...
        <tr nobr="true">
            ...
            <td width="65" align="center">{{$row->batch_color_name}}</td>
        ...
        @endforeach
        <tr>
            <td width="620" align="right">Total</td>
