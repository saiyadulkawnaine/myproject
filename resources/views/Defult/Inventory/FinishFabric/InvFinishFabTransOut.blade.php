<div class="easyui-tabs animated rollIn" style="width:100%;height:100%; border:none" id="invfinishfabtransouttabs">
    <div title="Finish Fabric Item Transfer Out" style="padding:2px">
        <div class="easyui-layout" data-options="fit:true">
            <div data-options="region:'center',border:true,title:'List'" style="padding:2px">
                <table id="invfinishfabtransoutTbl" style="width:500px">
                    <thead>
                        <tr>
            ...
            <div data-options="region:'west',border:true,title:'Finish Fabric Transfer Out Reference',footer:'#invfinishfabtransoutFrmft'" style="width: 400px; padding:2px">
                <form id="invfinishfabtransoutFrm">
                    <div id="container">
                        <div id="body">
                            <code>
                    ...
                    <div id="invfinishfabtransoutFrmft" style="padding:0px 0px; text-align:right; background:#F3F3F3;">
                        <a href="javascript:void(0)" class="easyui-linkbutton c1" style="height:25px; border-radius:1px" iconCls="icon-save" plain="true" id="save" onClick="MsInvFinishFabTransOut.submit()">Save</a>
                        <a href="javascript:void(0)" class="easyui-linkbutton c6" style="height:25px;border-radius:1px" iconCls="icon-remove" plain="true" id="delete" onClick="MsInvFinishFabTransOut.resetForm()">Reset</a>
                        <a href="javascript:void(0)" class="easyui-linkbutton c5" style="height:25px;border-radius:1px" iconCls="icon-remove" plain="true" id="delete" onClick="MsInvFinishFabTransOut.remove()">Delete</a>
                        <a href="javascript:void(0)" class="easyui-linkbutton c5" style="height:25px;border-radius:1px" iconCls="icon-pdf" plain="true" id="delete" onClick="MsInvFinishFabTransOut.showPdf()">PDF</a>
                        <a href="javascript:void(0)" class="easyui-linkbutton c5" style="height:25px;border-radius:1px" iconCls="icon-pdf" plain="true" id="delete" onClick="MsInvFinishFabTransOut.showPdfTwo()">Challan</a>
                    </div>
                </form>
            </div>
        </div>
    ...
    <div title="Item" style="padding:2px">
        <div class="easyui-layout" data-options="fit:true">
            ...
            <div data-options="region:'center',border:true,title:'List',footer:'#invfinishfabtransoutitemTblFt'" style="padding:2px">
                <table id="invfinishfabtransoutitemTbl" style="width:500px">
                    <thead>
                        <tr>
                ...
                <div id="invfinishfabtransoutitemTblFt" style="padding:0px 0px; text-align:right; background:#F3F3F3;">
                
                <a href="javascript:void(0)" class="easyui-linkbutton c5" style="height:25px;border-radius:1px" iconCls="icon-remove" plain="true" id="delete" onClick="MsInvFinishFabTransOutItem.import()">Import</a>
                </div>
            </div>
        </div>
    </div>
...
<div id="invfinishfabtransoutitemsearchwindow" class="easyui-window" title="Finish Fabric Roll" data-options="modal:true,closed:true,iconCls:'icon-save'" style="width:100%;height:100%;padding:2px;">
    <div class="easyui-layout" data-options="fit:true">
        <div data-options="region:'west',border:true,title:'Search',iconCls:'icon-more',footer:'#invfinishfabtransoutitemsearchFrmFt'" style="width:400px; padding:2px">
                <form id="invfinishfabtransoutitemsearchFrm" >
                    <div id="container">
                        <div id="body">
                            <code>  
                                <div class="row">
                                ...
                                <div class="row middle">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        MsInvFinishFabTransOutItem.openStyleWindow()" placeholder=" Double Click" />
                                ...
                                <div class="row middle">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        MsInvFinishFabTransOutItem.openOrderWindow()" placeholder=" Double Click" />
                    ...
                    <div id="invfinishfabtransoutitemsearchFrmFt" style="padding:0px 0px; text-align:right; background:#F3F3F3;">
                        <a href="javascript:void(0)" class="easyui-linkbutton  c1" style="height:25px; border-radius:1px" iconCls="icon-save" plain="true" id="save" onClick="MsInvFinishFabTransOutItem.getItem()">Show</a>
                        <a href="javascript:void(0)" class="easyui-linkbutton c6" style="height:25px;border-radius:1px" iconCls="icon-remove" plain="true" id="delete" onClick="msApp.resetForm('invfinishfabtransoutitemsearchFrm')">Reset</a>
        ...
        <div data-options="region:'center'" style="padding:10px;">
            ...
            <table id="invfinishfabtransoutitemsearchTbl" style="width:100%">
                    <thead>
                        <tr>
                        <th data-options="field:'cdf'" width="100" formatter="MsInvFinishFabTransOutItem.formatsv">Action</th>
                          <th data-options="field:'id'" width="70">ID</th>
                          <th data-options="field:'prod_knit_item_roll_id'" width="70">Roll No</th>
                          <th data-options="field:'custom_no'" width="70">Custom No</th>
...
<div id="invfinishfabtransoutitemwindow" class="easyui-window" title="Save/Edit" data-options="modal:true,closed:true,iconCls:'icon-save'" style="width:450px;height:100%;padding:2px;">
    <div class="easyui-layout" data-options="fit:true">
        <div data-options="region:'center',footer:'#invfinishfabtransoutitemFrmFt'" style="padding:10px;">
            <form id="invfinishfabtransoutitemFrm" >
                    <div id="container">
                        <div id="body">
                            <code>                               
                    ...
                    <div id="invfinishfabtransoutitemFrmFt" style="padding:0px 0px; text-align:right; background:#F3F3F3;">
                        <a href="javascript:void(0)" class="easyui-linkbutton  c1" style="height:25px; border-radius:1px" iconCls="icon-save" plain="true" id="save" onClick="MsInvFinishFabTransOutItem.submit()">Save</a>
                        <a href="javascript:void(0)" class="easyui-linkbutton c6" style="height:25px;border-radius:1px" iconCls="icon-remove" plain="true" id="delete" onClick="msApp.resetForm('invfinishfabtransoutitemFrm')">Reset</a>
                        <a href="javascript:void(0)" class=" easyui-linkbutton c5" style="height:25px;border-radius:1px" iconCls="icon-remove" plain="true" id="delete" onClick="MsInvFinishFabTransOutItem.remove()">Delete</a>
                    </div>
                </form>
        </div>
    </div>
    ...
    <div class="easyui-layout" data-options="fit:true">
        <div data-options="region:'north',split:true, title:'Search'" style="height:130px">
            <div class="easyui-layout" data-options="fit:true">
                ...
                <p class="footer">
                    <a href="javascript:void(0)" class="easyui-linkbutton c2" style="width:70px; height:25px" onClick="MsInvFinishFabTransOutItem.searchStyleGrid()">Search</a>
                </p>
            </div>
        </div>
        <div data-options="region:'center'" style="padding:10px;">
    ...
    <div class="easyui-layout" data-options="fit:true">
        <div data-options="region:'west',split:true, title:'Search'" style="width:350px;height:130px">
            <div class="easyui-layout" data-options="fit:true">
                ...
                <p class="footer">
                    <a href="javascript:void(0)" class="easyui-linkbutton c2" style="width:70px; height:25px" onClick="MsInvFinishFabTransOutItem.searchOrderGrid()">Search</a>
                </p>
            </div>
        </div>
        <div data-options="region:'center'" style="padding:10px;">
...
<script type="text/javascript" src="<?php echo url('/');?>/js/Inventory/FinishFabric/MsAllInvFinishFabTransOutController.js"></script>
<script>
...
$('#invfinishfabtransoutitemsearchFrm [id="buyer_id"]').combobox();
</script>
