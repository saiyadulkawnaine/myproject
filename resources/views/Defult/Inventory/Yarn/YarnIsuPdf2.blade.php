...
<table cellspacing="0" cellpadding="2" border="1">
    <thead>
        <tr>
            ...
            <td width="60" align="center">Color Range</td>
            <td width="45" align="center">Count</td>
            <td width="100" align="center">Yarn Description</td>
            <td width="50" align="center">Lot</td>
            <td width="60" align="center">Supplier</td>
            <td width="60" align="center">Buyer & Style</td>
            ...
            <td width="46" align="center">Rq No</td>
        </tr>
    </thead>
    <tbody>
        <?php
        ...
        <tr>
            ...
            <td width="100" align="center">{{$row->fabrication}},{{$row->gsm_weight}}</td>
            <td width="60" align="center">{{$row->colorrange_name}}</td>
            <td width="45" align="center">{{$row->yarn_count}}</td>
            <td width="100" align="left">{{$row->composition}}, {{$row->yarn_type}},  {{$row->brand}}, {{$row->color_name}}</td>
            ...
            <td width="60" align="center">{{$row->sale_order_no}} <br/> {{$row->company_name}}</td>
            <td width="60" align="right">{{number_format($row->store_qty,2)}}</td>
            ...
            <td width="60" align="center">{{number_format($row->returnable_qty,2)}}</td>
            <td width="90" align="center">{{$row->remarks}}</td>
            <td width="46" align="center">{{$row->rq_no}}</td>
        </tr>
        <?php
        $i++;
        ?>
        ...
        <tr>
            ...
            <td width="60" align="right">{{number_format($data['details']->sum('store_qty'),2)}}</td>
            <td width="30" align="center"></td>
            <td width="60" align="right">{{number_format($data['details']->sum('amount'),2)}}</td>
            <td width="30" align="center"></td>
