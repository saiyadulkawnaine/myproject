...
<table cellspacing="0" cellpadding="2" border="1">
    <thead>
        <tr>
            ...
            <td width="130" align="center">Fabric Description</td>
            <td width="60" align="center">Color Range</td>
            <td width="45" align="center">Count</td>
            <td width="140" align="center">Yarn Description</td>
            ...
            <td width="66" align="center">Rq No</td>
        </tr>
    </thead>
    <tbody>
        <?php
        ...
        <tr>
            ...
            <td width="130" align="center">{{$row->fabrication}},{{$row->gsm_weight}}</td>
            <td width="60" align="center">{{$row->colorrange_name}}</td>
            <td width="45" align="center">{{$row->yarn_count}}</td>
            <td width="140" align="left">{{$row->composition}}, {{$row->yarn_type}},  {{$row->brand}}, {{$row->color_name}}</td>
            ...
            <td width="66" align="center">{{$row->rq_no}}</td>
        </tr>
        <?php
        $i++;
        ?>
        @endforeach
        <tr>
            <td width="635" align="right">Total</td>
