<div class="easyui-tabs animated rollIn" style="width:100%;height:100%; border:none" id="invgreyfabisutabs">
    <div title="Grey Fabric Issue Entry" style="padding:2px">
        <div class="easyui-layout" data-options="fit:true">
            <div data-options="region:'center',border:true,title:'List'" style="padding:2px">
                <table id="invgreyfabisuTbl" style="width:500px">
                    <thead>
                        <tr>
            ...
            <div data-options="region:'west',border:true,title:'Receive Reference',footer:'#ft2'" style="width: 400px; padding:2px">
                <form id="invgreyfabisuFrm">
                    ...
                    <div id="ft2" style="padding:0px 0px; text-align:right; background:#F3F3F3;">
                        <a href="javascript:void(0)" class="easyui-linkbutton c1" style="height:25px; border-radius:1px" iconCls="icon-save" plain="true" id="save" onClick="MsInvGreyFabIsu.submit()">Save</a>
                        <a href="javascript:void(0)" class="easyui-linkbutton c6" style="height:25px;border-radius:1px" iconCls="icon-remove" plain="true" id="delete" onClick="MsInvGreyFabIsu.resetForm()">Reset</a>
                        <a href="javascript:void(0)" class="easyui-linkbutton c5" style="height:25px;border-radius:1px" iconCls="icon-remove" plain="true" id="delete" onClick="MsInvGreyFabIsu.remove()">Delete</a>
                        <a href="javascript:void(0)" class="easyui-linkbutton c5" style="height:25px;border-radius:1px" iconCls="icon-pdf" plain="true" id="delete" onClick="MsInvGreyFabIsu.showPdf()">PDF</a>
                        <a href="javascript:void(0)" class="easyui-linkbutton c5" style="height:25px;border-radius:1px" iconCls="icon-pdf" plain="true" id="delete" onClick="MsInvGreyFabIsu.showPdfTwo()">Challan</a>
    ...
    <div title="Item" style="padding:2px">
        <div class="easyui-layout" data-options="fit:true">
            <div data-options="region:'center',border:true,title:'List',footer:'#invgreyfabisuitemTblFt'" style="padding:2px">
                <table id="invgreyfabisuitemTbl" style="width:500px">
                    <thead>
                        <tr>
                ...
                <div id="invgreyfabisuitemTblFt" style="padding:0px 0px; text-align:right; background:#F3F3F3;">
                
                <a href="javascript:void(0)" class="easyui-linkbutton c5" style="height:25px;border-radius:1px" iconCls="icon-remove" plain="true" id="delete" onClick="MsInvGreyFabIsuItem.import()">Import</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="easyui-layout" data-options="fit:true">
        <div data-options="region:'north',split:true, title:'Search'" style="height:130px">
            <div class="easyui-layout" data-options="fit:true">
                ...
                <p class="footer">
                    <a href="javascript:void(0)" class="easyui-linkbutton c2" style="width:70px; height:25px" onClick="MsInvGreyFabIsuItem.searchStyleGrid()">Search</a>
                </p>
            </div>
        </div>
    ...
    <div class="easyui-layout" data-options="fit:true">
        <div data-options="region:'west',split:true, title:'Search'" style="width:350px;height:130px">
            <div class="easyui-layout" data-options="fit:true">
                ...
                <p class="footer">
                    <a href="javascript:void(0)" class="easyui-linkbutton c2" style="width:70px; height:25px" onClick="MsInvGreyFabIsuItem.searchOrderGrid()">Search</a>
                </p>
            </div>
        </div>
        <div data-options="region:'center'" style="padding:10px;">
...
<div id="invgreyfabisuitemsearchwindow" class="easyui-window" title="Grey Fabric Roll" data-options="modal:true,closed:true,iconCls:'icon-save'" style="width:100%;height:100%;padding:2px;">
    <div class="easyui-layout" data-options="fit:true">
        <div data-options="region:'west',border:true,title:'Search',iconCls:'icon-more',footer:'#invgreyfabisuitemsearchFrmFt'" style="width:400px; padding:2px">
                <form id="invgreyfabisuitemsearchFrm" >
                    <div id="container">
                        <div id="body">
                            <code>  
                                <div class="row">
                                ...
                                <div class="row middle">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        MsInvGreyFabIsuItem.openStyleWindow()" placeholder=" Double Click"  value="" />
                                ...
                                <div class="row middle">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        MsInvGreyFabIsuItem.openOrderWindow()" placeholder=" Double Click" value="" />
                                        <input type="hidden" name="sales_order_id" id="sales_order_id" value="" />
                                    </div>
                                </div>
                                <div class="row middle">
                                    <div class="col-sm-4">Total</div>
                                    <div class="col-sm-8" id="invgreyfabisuitemsearchFrmTotal">
                    ...
                    <div id="invgreyfabisuitemsearchFrmFt" style="padding:0px 0px; text-align:right; background:#F3F3F3;">
                        <a href="javascript:void(0)" class="easyui-linkbutton  c1" style="height:25px; border-radius:1px" iconCls="icon-save" plain="true" id="save" onClick="MsInvGreyFabIsuItem.getItem()">Show</a>
                        <a href="javascript:void(0)" class="easyui-linkbutton c6" style="height:25px;border-radius:1px" iconCls="icon-remove" plain="true" id="delete" onClick="msApp.resetForm('invgreyfabisuitemsearchFrm')">Reset</a>
        ...
        <div data-options="region:'center'" style="padding:10px;">
            ...
            <table id="invgreyfabisuitemsearchTbl" style="width:100%">
                    <thead>
                        <tr>
                          <th data-options="field:'cdf'" width="100" formatter="MsInvGreyFabIsuItem.formatsv">Action</th>
                          <th data-options="field:'id'" width="70">ID</th>
                          <th data-options="field:'prod_knit_item_roll_id'" width="70">Roll No</th>
                          <th data-options="field:'custom_no'" width="70">Custom No</th>
...
<div id="invgreyfabisuitemwindow" class="easyui-window" title="Save/Edit" data-options="modal:true,closed:true,iconCls:'icon-save'" style="width:450px;height:100%;padding:2px;">
    <div class="easyui-layout" data-options="fit:true">
        <div data-options="region:'center',footer:'#invgreyfabisuitemFrmFt'" style="padding:10px;">
            <form id="invgreyfabisuitemFrm" >
                    <div id="container">
                        <div id="body">
                            <code>                               
                    ...
                    <div id="invgreyfabisuitemFrmFt" style="padding:0px 0px; text-align:right; background:#F3F3F3;">
                        <a href="javascript:void(0)" class="easyui-linkbutton  c1" style="height:25px; border-radius:1px" iconCls="icon-save" plain="true" id="save" onClick="MsInvGreyFabIsuItem.submit()">Save</a>
                        <a href="javascript:void(0)" class="easyui-linkbutton c6" style="height:25px;border-radius:1px" iconCls="icon-remove" plain="true" id="delete" onClick="msApp.resetForm('invgreyfabisuitemFrm')">Reset</a>
                        <a href="javascript:void(0)" class=" easyui-linkbutton c5" style="height:25px;border-radius:1px" iconCls="icon-remove" plain="true" id="delete" onClick="MsInvGreyFabIsuItem.remove()">Delete</a>
                    </div>
                </form>
        </div>
    </div>
</div>
<script type="text/javascript" src="<?php echo url('/');?>/js/Inventory/GreyFabric/MsAllInvGreyFabIsuController.js"></script>
<script>
    $('#invgreyfabisuFrm [id="supplier_id"]').combobox();
    $('#invgreyfabisuFrm [id="buyer_id"]').combobox();
    $('#invgreyfabisuitemsearchFrm [id="buyer_id"]').combobox();
