    ...
    <tbody>    
        ...
        @foreach($prodknitqc as $row)
         <tr align="center">
            ...
            <input type="hidden" name="prod_knit_dlv_roll_id[{{ $i }}]" id="prod_knit_dlv_roll_id{{ $i }}" value="{{ $row->id }}" readonly />
            ...
            <input type="text" name="qty[{{ $i }}]" id="qty{{ $i }}" value="{{ $row->qc_pass_qty }}" readonly />
             ...
             <td align="left">
            <input type="text" name="room[{{ $i }}]" id="room{{ $i }}" onchange="MsInvGreyFabRcvItem.copyRoom(this.value,{{ $i }},{{ $loop->count}})"/>
            </td>
            <td align="left">
            <input type="text" name="rack[{{ $i }}]" id="rack{{ $i }}" onchange="MsInvGreyFabRcvItem.copyRack(this.value,{{ $i }},{{ $loop->count}})"/>
            </td>
            <td>
            <input type="text" name="shelf[{{ $i }}]" id="shelf{{ $i }}" onchange="MsInvGreyFabRcvItem.copyShelf(this.value,{{ $i }},{{ $loop->count}})"/>            
            </td>
            <td>
            {{ $row->body_part }}
