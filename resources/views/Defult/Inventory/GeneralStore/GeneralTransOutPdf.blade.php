...
<table cellspacing="0" cellpadding="2" border="1">
    <thead>
        <tr>
            ...
            <td width="120" align="center">Specification</td>
            <td width="70" align="center">Qty</td>
            <td width="45" align="center">UOM</td>
            <td width="70" align="center">Rate</td>
            <td width="115" align="center">Amount</td>
            
            <td width="176" align="center">Remarks</td>
        </tr>
    </thead>
    <tbody>
        ...
        <tr>
            ...
            <td width="200" align="left">{{$row->item_desc}},</td>
            <td width="120" align="left">{{$row->specification}}</td>
            <td width="70" align="right">{{$row->qty}}</td>
            <td width="45" align="center">{{$row->uom_code}}</td>
            <td width="70" align="center">{{$row->rate}}</td>
            <td width="115" align="right">{{$row->amount}}</td>
            <td width="176" align="center">{{$row->remarks}}</td>
    ...
    ?>
        @endforeach
        <tr>
            <td width="470" align="right">Total</td>
            <td width="70" align="right">{{$data['details']->sum('qty')}}</td>
            <td width="45" align="center"></td>
            <td width="70" align="center"></td>
            <td width="115" align="right">{{$data['details']->sum('store_amount')}}</td>
