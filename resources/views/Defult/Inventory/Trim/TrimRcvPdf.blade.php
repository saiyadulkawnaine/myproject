...
<table cellspacing="0" cellpadding="2" border="1">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td width="60" align="center">{{$row->style_color_name}}</td>
            <td width="60" align="center">{{$row->style_size_name}}</td>
            <td width="200" align="left">{{$row->class_name}} {{$row->description}} {{$row->item_color_name}}  {{$row->measurment}}</td>
            ...
            <td width="60" align="right">{{$row->po_no}}</td>
