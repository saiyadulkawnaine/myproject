<div class="easyui-tabs" style="width:100%;height:100%; border:none" id="soembprintdlvinhtabs">
	<div title="Delivery" style="padding:2px">
		<div class="easyui-layout" data-options="fit:true">
			<div data-options="region:'center',border:true,title:'Delivery Reference List'" style="padding:2px">
				<table id="soembprintdlvinhTbl" style="width:100%">
					<thead>
						<tr>
			...
			<div data-options="region:'west',border:true,title:'Delivery Reference',footer:'#soembprintdlvinhFrmft'"
				style="width: 350px; padding:2px">
				<form id="soembprintdlvinhFrm">
					<div id="container">
						<div id="body">
							<code>
        <div class="row middle">
          ...
          <div class="col-sm-7">
           ...
           <input type="hidden" name="id" id="id">
					...
					<div id="soembprintdlvinhFrmft" style="padding:0px 0px; text-align:right; background:#F3F3F3;">
						<a href="javascript:void(0)" class="easyui-linkbutton c1" style="height:25px; border-radius:1px"
							iconCls="icon-save" plain="true" id="save" onClick="MsSoEmbPrintDlvInh.submit()">Save</a>
						<a href="javascript:void(0)" class="easyui-linkbutton c6" style="height:25px;border-radius:1px"
							iconCls="icon-remove" plain="true" id="delete"
							onClick="msApp.resetForm('soembprintdlvinhFrm')">Reset</a>
						<a href="javascript:void(0)" class="easyui-linkbutton c5" style="height:25px;border-radius:1px"
							iconCls="icon-remove" plain="true" id="delete"
							onClick="MsSoEmbPrintDlvInh.remove()">Delete</a>
						<a href="javascript:void(0)" class="easyui-linkbutton c5" style="height:25px;border-radius:1px"
							iconCls="icon-pdf" plain="true" id="cfdc" onClick="MsSoEmbPrintDlvInh.pdf()">BILL</a>
						<a href="javascript:void(0)" class="easyui-linkbutton c5" style="height:25px;border-radius:1px"
							iconCls="icon-pdf" plain="true" id="cfdc" onClick="MsSoEmbPrintDlvInh.challan()">Challan</a>
					</div>
				</form>
			</div>
		</div>
	...
	<div title="Delivery Item Details" style="padding:2px">
		<div class="easyui-layout" data-options="fit:true">
			<div data-options="region:'west',border:true,title:'Item Delivery Information',iconCls:'icon-more',footer:'#soembprintdlvinhitemFrmft'"
				style="width:350px; padding:2px">
				<form id="soembprintdlvinhitemFrm">
					<div id="container">
						<div id="body">
							<code>
		                                <div class="row">
                                      ...
                                      <input type="hidden" name="so_emb_print_dlv_id" id="so_emb_print_dlv_id" value="" />
																																		...
																																		<div class="row middle">
																																			...
																																			<div class="col-sm-8">
																																				<input type="text" name="gmtspart" id="gmtspart" placeholder="Browse"
																																					ondblclick="MsSoEmbPrintDlvInhItem.openProdEmbPrintOpen()">
		                                ...
		                                <div class="row middle">
		                                    ...
		                                    <div class="col-sm-8">
		                                        <input type="text" name="dlv_qty" id="dlv_qty" value="" class="number integer" onchange="MsSoEmbPrintDlvInhItem.calculate()" />
		                                    </div>
		                                </div>
		                                <div class="row middle">
		                                ...
		                                <div class="row middle">
		                                    ...
		                                    <div class="col-sm-8">
		                                        <input type="text" name="additional_charge" id="additional_charge" value="" onchange="MsSoEmbPrintDlvInhItem.calculate()" class="number integer"/>
		                                    </div>
		                                </div>
		                                <div class="row middle">
					...
					<div id="soembprintdlvinhitemFrmft" style="padding:0px 0px; text-align:right; background:#F3F3F3;">
						<a href="javascript:void(0)" class="easyui-linkbutton  c1"
							...
							onClick="MsSoEmbPrintDlvInhItem.submit()">Save</a>
						<a href="javascript:void(0)" class="easyui-linkbutton c6" style="height:25px;border-radius:1px"
							iconCls="icon-remove" plain="true" id="delete"
							onClick="MsSoEmbPrintDlvInhItem.resetForm()">Reset</a>
						<a href="javascript:void(0)" class=" easyui-linkbutton c5" style="height:25px;border-radius:1px"
							iconCls="icon-remove" plain="true" id="delete"
							onClick="MsSoEmbPrintDlvInhItem.remove()">Delete</a>
					</div>
				</form>
			</div>
			<div data-options="region:'center',border:true,title:'Item Delivery Lists'" style="padding:2px">
				<table id="soembprintdlvinhitemTbl" style="width:100%">
					<thead>
						<tr>
...
{{-- Delivery window --}}
<div id="soembprintdlvinhitemWindow" class="easyui-window" title="Sales Order No Search Window"
	...
	<div class="easyui-layout" data-options="fit:true">
			...
			<div class="easyui-layout" data-options="fit:true">
				...
				<p class="footer">
					<a href="javascript:void(0)" class="easyui-linkbutton c2" style="width:70px; height:25px"
						onClick="MsSoEmbPrintDlvInhItem.searchProdEmbItem()">Search</a>
				</p>
			</div>
		</div>
		...
		<div data-options="region:'south',border:false" style="text-align:right;padding:5px 0 0;">
			<a class="easyui-linkbutton c1" data-options="iconCls:'icon-ok'" href="javascript:void(0)"
				onclick="$('#soembprintdlvinhitemWindow').window('close')" style="width:80px">Close</a>
		</div>
	</div>
</div>

<script type="text/javascript"
	src="<?php echo url('/');?>/js/Subcontract/Embelishment/MsAllSoEmbPrintDlvInhController.js">
</script>
<script>
	(function(){
      ...
      $('#soembprintdlvinhFrm [id="buyer_id"]').combobox();
   })(jQuery);
</script>