<div class="easyui-tabs" style="width:100%;height:100%; border:none" id="soaopmktcosttabs">
    <div title="Start Up" style="padding:2px">
        <div class="easyui-layout" data-options="fit:true">
            <div data-options="region:'center',border:true,title:'List'" style="padding:2px">
                <table id="soaopmktcostTbl" style="width:100%">
                    <thead>
                        <tr>
            ...
            <div data-options="region:'west',border:true,title:'AOP Marketing Costing',iconCls:'icon-more',hideCollapsedContent:false,collapsed:false,footer:'#soaopmktcostft'" style="width:450px; padding:2px">
                <div id="container">
                    <div id="body">
                        <code>
                            <form id="soaopmktcostFrm">
                                <div class="row">
                                 ...
                                 <div class="row middle">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text" name="sub_inb_service_id" id="sub_inb_service_id" ondblclick="MsSoAopMktCost.subinbserviceWindow()" placeholder="Double Click"/>
                                    </div>
                                </div>
                                <div class="row middle">
                ...
                <div id="soaopmktcostft" style="padding:0px 0px; text-align:right; background:#CCC;">
                    <a href="javascript:void(0)" class="easyui-linkbutton c1" style="height:25px; border-radius:1px" iconCls="icon-save" plain="true" id="save" onClick="MsSoAopMktCost.submit()">Save</a>
                    <a href="javascript:void(0)" class="easyui-linkbutton c6" style="height:25px;border-radius:1px" iconCls="icon-remove" plain="true" id="delete" onClick="msApp.resetForm('soaopmktcostFrm')">Reset</a>
                    <a href="javascript:void(0)" class="easyui-linkbutton c5" style="height:25px;border-radius:1px" iconCls="icon-remove" plain="true" id="delete" onClick="MsSoAopMktCost.remove()">Delete</a>
                </div>
            </div>
        </div>
    </div>
    <div title="Parameters" style="padding:2px">
        <div class="easyui-layout" data-options="fit:true">
            <div data-options="region:'west',border:true,title:'Add', iconCls:'icon-more', footer:'#soaopmktcostparamFrmFt'" style="width:450px; padding:2px">
                <form id="soaopmktcostparamFrm">
                    <div id="container">
                        <div id="body">
                            <code>
                                <div class="row">
                                ...
                                {{-- <div class="row middle">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" name="fabrication" id="fabrication" placeholder="Double Click" ondblclick="MsSoAopMktCostFab.fabricItemWindowOpen()" readonly />
                    ...
                    <div id="soaopmktcostparamFrmFt" style="padding:0px 0px; text-align:right; background:#F3F3F3;">
                        <a href="javascript:void(0)" class="easyui-linkbutton  c1" style="height:25px; border-radius:1px" iconCls="icon-save" plain="true" id="save" onClick="MsSoAopMktCostParam.submit()">Save</a>
                        <a href="javascript:void(0)" class="easyui-linkbutton c6" style="height:25px;border-radius:1px" iconCls="icon-remove" plain="true" id="delete" onClick="MsSoAopMktCostParam.resetForm()">Reset</a>
                        <a href="javascript:void(0)" class=" easyui-linkbutton c5" style="height:25px;border-radius:1px" iconCls="icon-remove" plain="true" id="delete" onClick="MsSoAopMktCostParam.remove()">Delete</a>
                    </div>
                </form>  
            </div>
            <div data-options="region:'center',border:true,title:'Lists'" style="padding:2px">
                <table id="soaopmktcostparamTbl" style="width:100%">
                    <thead>
                        <tr>
                            <th data-options="field:'id'" width="80">ID</th>
    ...
    <div title="Dyes & Chemical" style="padding:2px">
        <div class="easyui-layout" data-options="fit:true">
            <div data-options="region:'west',border:true,title:'Add Opening Balance',iconCls:'icon-more',footer:'#soaopmktcostparamitemFrmFt'" style="width:400px; padding:2px">
                <form id="soaopmktcostparamitemFrm" >
                    <div id="container">
                        <div id="body">
                            <code>                               
                                <div class="row">
                                ...
                                <div class="row middle">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <input type="text" name="item_account_id" id="item_account_id" ondblclick="MsSoAopMktCostParamItem.openitemWindow()" readonly placeholder="Double Click"    />
                                    </div>
                                </div>
                                <div class="row middle">
                                ...
                                <div class="row middle">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" name="rto_on_paste_wgt" id="rto_on_paste_wgt" value="" class="number integer" onchange="MsSoAopMktCostParamItem.calculate_qty('rto_on_paste_wgt')" />
                                    </div>
                                </div>
                                <div class="row middle">
                                ...
                                <div class="row middle">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" name="rate" id="rate" value="" class="number integer"  onchange="MsSoAopMktCostParamItem.calculate_amount()" 
                                         />
                                    </div>
                                </div>
                                <div class="row middle">
                        ...
                        <div id="body">
                            <code>
                                <div class="row middle">
                                    ...
                                    <div class="col-sm-5">
                                        <input type="text" name="master_fab_id" id="master_fab_id" ondblclick="MsSoAopMktCostParamItem.openitemCopyWindow()" />
                                    </div>
                                    <div class="col-sm-3">
                                        <a href="javascript:void(0)" class="easyui-linkbutton  c1" style="height:25px; border-radius:1px" iconCls="icon-save" plain="true" id="save" onClick="MsSoAopMktCostParamItem.itemCopy()">Copy</a>
                                    </div>
                                </div>
                            </code>
                        </div>
                    </div>
                    <div id="soaopmktcostparamitemFrmFt" style="padding:0px 0px; text-align:right; background:#F3F3F3;">
                        <a href="javascript:void(0)" class="easyui-linkbutton  c1" style="height:25px; border-radius:1px" iconCls="icon-save" plain="true" id="save" onClick="MsSoAopMktCostParamItem.submit()">Save</a>
                        <a href="javascript:void(0)" class="easyui-linkbutton c6" style="height:25px;border-radius:1px" iconCls="icon-remove" plain="true" id="delete" onClick="MsSoAopMktCostParamItem.resetForm()">Reset</a>
                        <a href="javascript:void(0)" class=" easyui-linkbutton c5" style="height:25px;border-radius:1px" iconCls="icon-remove" plain="true" id="delete" onClick="MsSoAopMktCostParamItem.remove()">Delete</a>
                    </div>
                </form>
            </div>
            <div data-options="region:'center',border:true,title:'List',footer:'#soaopmktcostparamitemTblFt'" style="padding:2px">
                <table id="soaopmktcostparamitemTbl" style="width:100%">
                    <thead>
                        <tr> 
    ...
    <div title="Special Finish" style="padding:2px">
        <div class="easyui-layout" data-options="fit:true">
            <div data-options="region:'west',border:true,title:'Add', iconCls:'icon-more', footer:'#soaopmktcostspfinFrmFt'" style="width:350px; padding:2px">
                <form id="soaopmktcostparamfinFrm">
                    <div id="container">
                        <div id="body">
                            <code>
                                <div class="row">
                    ...
                    <div id="soaopmktcostspfinFrmFt" style="padding:0px 0px; text-align:right; background:#F3F3F3;">
                        <a href="javascript:void(0)" class="easyui-linkbutton  c1" style="height:25px; border-radius:1px" iconCls="icon-save" plain="true" id="save" onClick="MsSoAopMktCostParamFin.submit()">Save</a>
                        <a href="javascript:void(0)" class="easyui-linkbutton c6" style="height:25px;border-radius:1px" iconCls="icon-remove" plain="true" id="delete" onClick="MsSoAopMktCostParamFin.resetForm()">Reset</a>
                        <a href="javascript:void(0)" class=" easyui-linkbutton c5" style="height:25px;border-radius:1px" iconCls="icon-remove" plain="true" id="delete" onClick="MsSoAopMktCostParamFin.remove()">Delete</a>
                    </div>
                </form>  
            </div>
            <div data-options="region:'center',border:true,title:'Lists'" style="padding:2px">
                <table id="soaopmktcostparamfinTbl" style="width:100%">
                    <thead>
                        <tr>
    ...
    <div title="Quoted Price" style="padding:2px">
        <div class="easyui-layout" data-options="fit:true">
                    ...
                    style="height:250px; padding:2px">
                        <form id="soaopmktcostqpriceFrm">
                            ...
                            <div id="ft4" style="padding:0px 0px; text-align:right; background:#F3F3F3;">
                                ...
                                iconCls="icon-save" plain="true" id="save" onClick="MsSoAopMktCostQprice.submit()">Save</a>
                                <a href="javascript:void(0)" class="easyui-linkbutton c6" style="height:25px;border-radius:1px"
                                iconCls="icon-remove" plain="true" id="delete"
                                onClick="MsSoAopMktCostQprice.resetForm()">Reset</a>
                                <a href="javascript:void(0)" class="easyui-linkbutton c5" style="height:25px;border-radius:1px"
                                iconCls="icon-remove" plain="true" id="delete" onClick="MsSoAopMktCostQprice.remove()">Delete</a>
                                <a href="javascript:void(0)" class="easyui-linkbutton c5" style="height:25px;border-radius:1px"
                                iconCls="icon-remove" plain="true" id="delete" onClick="MsSoAopMktCostQprice.pdf()">PDF</a>
                            </div>
                        </form>
                    </div>
                    <div data-options="region:'center',border:true,title:'Lists'" style="padding:2px">
                        <table id="soaopmktcostqpriceTbl" style="width:100%">
                            <thead>
                                <tr>
                                    <th data-options="field:'id'" width="80">ID</th>
            ...
            <div data-options="region:'center',border:true,title:'Quoted Price Details',footer:'#ftqpricedtl'" style="padding:2px;width:100%;">
                <form id="soaopmktcostqpricedtlFrm" >
                    <input type="hidden" name="id" id="id" value="" />
                    <code id="soaopmktcostqpricedtlcosi">
                    </code>
                    <div id="ftqpricedtl" style="padding:0px 0px; text-align:right; background:#F3F3F3;">
                        <a href="javascript:void(0)" class="easyui-linkbutton  c1" style="height:25px; border-radius:1px"
                        iconCls="icon-save" plain="true" id="save" onClick="MsSoAopMktCostQpricedtl.submit()">Save</a>
                        <a href="javascript:void(0)" class="easyui-linkbutton c6" style="height:25px;border-radius:1px"
                        iconCls="icon-remove" plain="true" id="delete" onClick="msApp.resetForm('soaopmktcostqpricedtlFrm')">Reset</a>
                        <a href="javascript:void(0)" class=" easyui-linkbutton c5" style="height:25px;border-radius:1px"
                        iconCls="icon-remove" plain="true" id="delete" onClick="MsSoAopMktCostQpricedtl.remove()">Delete</a>
                    </div>
                </form>
            </div>
        </div>
    ...
    <div class="easyui-layout" data-options="fit:true">
        <div data-options="region:'west',split:true, title:'Search',footer:'#subinbserviceWindowFt'" style="width:350px;height:130px">
            ...
            <div id="subinbserviceWindowFt" style="padding:0px 0px; text-align:right; background:#F3F3F3;">
                <a href="javascript:void(0)" class="easyui-linkbutton c2" style="border-radius:1px" onClick="MsSoAopMktCost.getSubInbService()">Search</a>
            </div>
        </div>
...
<div id="soaopmktcostparamitemWindow" class="easyui-window" title="Item" data-options="modal:true,closed:true,iconCls:'icon-save'" style="width:100%;height:100%;padding:2px;">
    <div class="easyui-layout" data-options="fit:true">
        <div data-options="region:'west', split:true, title:'Search',footer:'#soaopmktcostparamitemsearchFrmFt'" style="width:350px;height:130px">
            <div class="easyui-layout" data-options="fit:true">
                <div id="body">
                    <code>
                        <form id="">
                ...
                <div id="soaopmktcostparamitemsearchFrmFt" style="padding:0px 0px; text-align:right; background:#F3F3F3;">
                <a href="javascript:void(0)" class=" easyui-linkbutton c5" style="height:25px;border-radius:1px" iconCls="icon-remove" plain="true" id="delete" onClick="MsSoAopMktCostParamItem.serachItem()">Search</a>
                </div>
            </div>
        </div>
        <div data-options="region:'center',footer:'#soaopmktcostparamitemsearchTblFt'" style="padding:10px;">
            <table id="soaopmktcostparamitemsearchTbl" style="width:100%">
                <thead>
                    <tr>
...
<div id="soaopmktcostparamMasterCopyWindow" class="easyui-window" title="Fabric Window" data-options="modal:true,closed:true,iconCls:'icon-save'" style="width:100%;height:100%;padding:2px;">
    <div class="easyui-layout" data-options="fit:true">
        <div data-options="region:'center'" style="padding:10px;">
            <table id="soaopmktcostparamMasterCopyTbl" style="width:100%">
                <thead>
                    <tr>
                        <th data-options="field:'id'" width="30">ID</th>
                        <th data-options="field:'gsm_weight'" width="70" align="right">GSM/Weight</th>
...
<script type="text/javascript" src="<?php echo url('/');?>/js/Subcontract/Aop/MsAllAopMktCostController.js"></script>
...
$(document).ready(function() {
    ...
    $('#soaopmktcostparamFrm [id="uom_id"]').combobox();
