...
<table border="1">
  ...
  <tr align="center">
    ...
    <td width="100px" class="text-center">
      <input type="text" name="quoted_price_bdt[{{ $i }}]" id="quoted_price_bdt{{ $i }}" value="" class="number integer" onchange="MsSoAopMktCostQpricedtl.calculateProfitQuotePrice({{ $i }},{{ $loop->count}})"/>
    </td>
    <td width="100px" class="text-center">
...
<table border="1">
 ...
 <tbody>
  ...
  <tr align="center">
    ...
    <td width="100px" class="text-center">
      <input type="text" name="quoted_price_bdt[{{ $i }}]" id="quoted_price_bdt{{ $i }}" value="{{ $data->quoted_price_bdt }}" class="number integer" onchange="MsSoAopMktCostQpricedtl.calculateProfitQuotePrice({{ $i }},{{ $loop->count}})"/>
    </td>
    <td width="100px" class="text-center">
    ...
    <td width="100px"><a href="javascript:void(0)"
      onclick="MsSoAopMktCostQpricedtl.delete(event,{{ $data->so_aop_mktcost_qpricedtl_id }})">Remove</a></td>
  </tr>
  <?php
    $i++;
