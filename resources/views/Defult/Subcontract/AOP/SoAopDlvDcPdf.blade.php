...
<table cellspacing="0" cellpadding="2" border="1">
    ...
    <td width="150" align="left">{{$row->fabrication}},{{$row->fabriclooks}},{{$row->fabricshape}}</td>
    <td width="70" align="center">{{$row->impression}}</td>
    ...
    <td width="60" align="left">{{$row->aoptype}}</td>
    <td width="50" align="center">{{$row->design_no}}</td>
    ...
    <tr>
        <td width="240" align="right">Total</td>
