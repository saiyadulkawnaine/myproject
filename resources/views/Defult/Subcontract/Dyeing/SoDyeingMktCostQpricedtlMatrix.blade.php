...
<table border="1">
  <tr align="center">
    ...
    <th width="70px" class="text-center">Fabrication</th>
    <th width="60px" class="text-center">Color Range</th>
  ...
  <tr align="center">
    ...
    <td width="70px"  align="left">
        {{ $data->fabrication }}
        <input type="hidden" name="so_dyeing_mkt_cost_fab_id[{{ $i }}]" id="so_dyeing_mkt_cost_fab_id{{ $i }}" value="{{ $data->so_dyeing_mkt_cost_fab_id }}" />
        <input type="hidden" name="so_dyeing_mkt_cost_qprice_id[{{ $i }}]" id="so_dyeing_mkt_cost_qprice_id{{ $i }}" value="{{ $data->so_dyeing_mkt_cost_qprice_id }}" />
    </td>
    <td width="60px" class="text-center">{{ $data->colorrange_name }}</td>
    ...
    <td width="100px" class="text-center">
      <input type="text" name="quoted_price_bdt[{{ $i }}]" id="quoted_price_bdt{{ $i }}" value="" class="number integer" onchange="MsSoDyeingMktCostQpricedtl.calculateProfitQuotePrice({{ $i }},{{ $loop->count}})"/>
    </td>
    <td width="100px" class="text-center">
...
<table border="1">
 ...
 <tbody>
  ...
  <tr align="center">
    ...
    <td width="60px" align="left">{{ $data->colorrange_name }}</td>
    <td width="40px" align="right">{{ $data->color_ratio_from }}</td>
    <td width="40px" align="right">{{ $data->color_ratio_to }}</td>
    <td width="40px" align="right">
      <input type="text" name="exch_rate[{{ $i }}]" id="exch_rate{{ $i }}" value="{{ $data->exch_rate }}" readonly />
    ...
    <td width="100px" class="text-center">
      <input type="text" name="quoted_price_bdt[{{ $i }}]" id="quoted_price_bdt{{ $i }}" value="{{ $data->quoted_price_bdt }}" class="number integer" onchange="MsSoDyeingMktCostQpricedtl.calculateProfitQuotePrice({{ $i }},{{ $loop->count}})"/>
    </td>
    <td width="100px" class="text-center">
    ...
    <td width="100px"><a href="javascript:void(0)"
      onclick="MsSoDyeingMktCostQpricedtl.delete(event,{{ $data->so_dyeing_mktcost_qpricedtl_id }})">Remove</a></td>
  </tr>
  <?php
    $i++;
