...
<table id="sodyeingtargetTbl" style="width:100%">
  <thead>
      <tr>
          ...
          <th data-options="field:'qty'" width="80">Dyeing Qty</th>
...
<div data-options="region:'west',border:true,title:'Add New Dyeing Subcon Sales Target',footer:'#ft2'" style="width:350px; padding:2px">
<form id="sodyeingtargetFrm">
    <div id="container">
         <div id="body">
           <code>
                        ...
                        <div class="row middle">
                        <div class="col-sm-4 req-text">Dyeing Qty</div>
                        <div class="col-sm-8"><input type="text" name="qty" id="qty" class="number integer" 
                          onchange="MsSoDyeingTarget.calculate()" />
                        </div>
                        </div>
                        <div class="row middle">
                        <div class="col-sm-4 req-text">Rate/Unit</div>
                        <div class="col-sm-8"><input type="text" name="rate" id="rate" class="number integer" 
                          onchange="MsSoDyeingTarget.calculate()" />
                        </div>
                        </div> 
                        <div class="row middle">
    ...
    <div id="ft2" style="padding:0px 0px; text-align:right; background:#F3F3F3;" >
        <a href="javascript:void(0)" class="easyui-linkbutton c1" style="height:25px; border-radius:1px" iconCls="icon-save" plain="true" id="save" onClick="MsSoDyeingTarget.submit()">Save</a>
        <a href="javascript:void(0)" class="easyui-linkbutton c6" style="height:25px;border-radius:1px" iconCls="icon-remove" plain="true" id="delete" onClick="msApp.resetForm('sodyeingtargetFrm')" >Reset</a>
        <a href="javascript:void(0)" class="easyui-linkbutton c5" style="height:25px;border-radius:1px" iconCls="icon-remove" plain="true" id="delete" onClick="MsSoDyeingTarget.remove()" >Delete</a>
    </div>
  </form>
</div>
</div>
<script type="text/javascript" src="<?php echo url('/');?>/js/Subcontract/Dyeing/MsSoDyeingTargetController.js"></script>
<script>
...
$('.integer').keyup(function () {
 ...
 $('#sodyeingtargetFrm [id="buyer_id"]').combobox();
 $('#sodyeingtargetFrm [id="teammember_id"]').combobox();
