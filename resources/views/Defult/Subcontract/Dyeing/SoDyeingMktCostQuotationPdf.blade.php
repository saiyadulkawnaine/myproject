...
@endif
<h3 align="center">Dyeing Price Quotation</h3>
...
<table border="1" cellpadding="2" cellspacing="0">
    <tr>
        ...
        <td width="120px" align="center"><strong>Fabrication</strong></td>
    ...
    ?>
    @foreach ($datas['sodyeingmktcosquotaionpricedetails'] as $data)
    <?php
    ...
    <tbody>
        <tr>
            ...
            <td width="120px" align="left">{{ $data->fabrication }}</td>
            ...
            <td width="40px" align="right">{{ number_format($data->chem_cost,2) }}</td>
    ...
    <tfoot>
        <tr>
            ...
            <td width="120px" align="left"><strong>TOTAL</strong></td>
...
<table>
    <tr>
        <td width="1000" align="center">
            <form id="sodyeingmktcostqpriceapprovalreturncommentFrm">
