...
<div class="col-sm-8">
<input type="text" name="item_description" id="item_description"  ondblclick="MsSmpCostYarn.openyarnsearchWindow()" placeholder="Double Click To Search" readonly/>
<input type="hidden" name="item_account_id" id="item_account_id" value="" readonly/>
<input type="hidden" name="id" id="id" value=""readonly/>
<input type="hidden" name="smp_cost_id" id="smp_cost_id" value="{{ $fabricyarn->smp_cost_id }}"readonly/>
<input type="hidden" name="smp_cost_fabric_id" id="smp_cost_fabric_id" value="{{ $fabricyarn->id }}"readonly/>
<input type="hidden" name="fab_cons" id="fab_cons" value="{{ $fabricyarn->req_cons }}"readonly/>
</div>
</div>
<div class="row middle">
<div class="col-sm-4 req-text">Ratio  </div>
<div class="col-sm-8"><input type="text" name="ratio" id="ratio" onChange="MsSmpCostYarn.claculateCons()" class="number integer"/></div>
</div>
<div class="row middle">
...
<div class="col-sm-8"><input type="text" name="rate" id="rate" onChange="MsSmpCostYarn.claculateAmount()" class="number integer"/></div>
</div>
<div class="row middle">
