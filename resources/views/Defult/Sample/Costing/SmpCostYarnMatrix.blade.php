	 ...
	 ?>
        ...
        <?php
            ...
            <tr>
                    ...
                    <input type="hidden" name="smp_cost_id[{{ $i }}]" id="smp_cost_id{{ $i }}"  value="{{ $value['smp_cost_id'] }}"/>
                    ...
                    <td width="70px" align="right">{{ $cons }}</td>
                    <td width="70px" align="right">{{ $value['rate'] }}</td>
                    <td width="80px" align="right">{{ $value['amount'] }}</td>
                    <td width="80px" align="center"><a href="javascript:void(0)" onclick="MsSmpCostYarn.openYarnWindow({{ $value['id'] }})">Add</a></td>
            </tr>
			<?php 
			 $tot+= $value['amount'];
            $i++;
