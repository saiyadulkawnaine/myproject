...
<td width="100">
  <input type="text" name="qty[{{ $i }}]" id="qty{{ $i }}" class="number integer" onchange="MsPoYarnDyeingShortItemBomQty.calculateAmount({{ $i }},{{$loop->count}},'qty')"/>
</td> 

<td width="100">
  <input type="text" name="rate[{{ $i }}]" id="rate{{ $i }}" class="number integer" onchange="MsPoYarnDyeingShortItemBomQty.calculateAmount({{ $i }},{{$loop->count}},'rate')"/>
</td>
<td width="100">
  <input type="text" name="amount[{{ $i }}]" id="amount{{ $i }}" class="number integer" onchange="MsPoYarnDyeingShortItemBomQty.calculateAmount({{ $i }},{{$loop->count}},'amount')"/>
</td>
<td width="100">
    <input type="text" name="process_loss_per[{{ $i }}]" id="process_loss_per{{ $i }}" class="number integer" value=""  onchange="MsPoYarnDyeingShortItemBomQty.calculateReqCone({{ $i }},{{$loop->count}},'wgt_per_cone')"/>
</td>
<td width="100">
  <input type="text" name="wgt_per_cone[{{ $i }}]" id="wgt_per_cone{{ $i }}" class="number integer" value=""  onchange="MsPoYarnDyeingShortItemBomQty.calculateReqCone({{ $i }},{{$loop->count}},'wgt_per_cone')"/>
</td>
<td width="100">
