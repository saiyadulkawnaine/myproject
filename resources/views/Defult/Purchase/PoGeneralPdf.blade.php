<h2 align="center">General Item Purchase Order</h2>
...
<table cellspacing="0" cellpadding="2" border="1">
    <thead>
        <tr>
            ...
            <td width="140" align="center">Item description</td>
            <td width="70" align="center">Item Specification</td>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td width="140" align="left">{{$row->item_description}}</td>
            <td width="70" align="center">{{$row->specification}}</td>
