...
<div data-options="region:'north',border:true,title:'Purchase Order',iconCls:'icon-more',hideCollapsedContent:false,footer:'#ft2'" style="height:250px; padding:2px">
           ...
           <code>
             <div class="row">
                ...
                <div class="row middle">
                  ...
                  <div class="col-sm-2 req-text">Source</div>
                  <div class="col-sm-4">{!! Form::select('source_id', $source,'',array('id'=>'source_id')) !!}</div>
                  <div class="col-sm-2 req-text">Basis</div>
                  <div class="col-sm-4">{!! Form::select('basis_id', $source,'',array('id'=>'basis_id')) !!}</div>
                </div>
                 <div class="row middle">
                 
                  <div class="col-sm-2 req-text">Supplier</div>
                  <div class="col-sm-4">{!! Form::select('supplier_id', $supplier,'',array('id'=>'supplier_id')) !!}</div>
                  <div class="col-sm-2 req-text">Pay Mode</div>
                  <div class="col-sm-4">{!! Form::select('pay_mode', $paymode,'',array('id'=>'pay_mode')) !!}</div>
                </div>
                <div class="row middle">
                  ...
                  <div class="col-sm-4"><input type="text" name="exch_rate" id="exch_rate" class="integer number"/></div>
                </div>
                <div class="row middle">
                  <div class="col-sm-2 req-text">Delivery Start  </div>
                  <div class="col-sm-4"><input type="text" name="delv_start_date" id="delv_start_date" class="datepicker"/></div>
                  <div class="col-sm-2 req-text">Delivery End  </div>
                  <div class="col-sm-4"><input type="text" name="delv_end_date" id="delv_end_date" class="datepicker"/></div>
                </div>
                <div class="row middle">
                  
                  <div class="col-sm-2">PI No.  </div>
                  <div class="col-sm-4"><input type="text" name="pi_no" id="pi_no" value=""/></div>
                  <div class="col-sm-2">PI Date  </div>
                  <div class="col-sm-4"><input type="text" name="pi_date" id="pi_date" class="datepicker"/></div>
                </div>
                <div class="row middle">
                  
                  <div class="col-sm-2">Remarks  </div>
                  <div class="col-sm-10"><input type="text" name="remarks" id="remarks" value=""/></div>
                </div>
...
<script type="text/javascript" src="<?php echo url('/');?>/js/Util/MsAllBulkFabricPurchaseController.js"></script>
<script>
