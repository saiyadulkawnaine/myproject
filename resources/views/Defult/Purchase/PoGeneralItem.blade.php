...
<input type="hidden" name="po_general_id[{{ $i }}]" id="po_general_id{{ $i }}" class="number integer" value="{{ $row->po_general_id}}" readonly/>
</td>
<td>
  {{ $row->category_name }}
</td>
...
<td width="70px">
<input type="text" name="qty[{{ $i }}]" id="qty{{ $i }}" class="number integer" value="" onchange="MsPoGeneralItem.calculateAmount({{ $i }},{{$loop->count}},'qty')"/>
</td>
<td>
<input type="text" name="rate[{{ $i  }}]" id="rate_{{ $i }}" class="number integer"  value="{{ $row->rate}}" onchange="MsPoGeneralItem.calculateAmount({{ $i }},{{$loop->count}},'rate')"/>
</td>
<td>
...
<td>
<input type="text" name="remarks[{{ $i }}]" id="remarks{{ $i }}" class="number integer" value="{{ $row->remarks}}" />
</td>
