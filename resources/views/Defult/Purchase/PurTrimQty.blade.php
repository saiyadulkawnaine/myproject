    ...
    <tbody>
	 ...
	 // $i=1;
	  ...
	  ?>
                    ...
                    <input type="hidden" name="pur_trim_id[{{ $i }}]"  value="{{ $colorsize->pur_trim_id }}"/>
                    ...
                    <td width="70px">
                    <input type="text" name="qty[{{ $i }}]" id="qty{{ $i }}" class="number integer" value="{{ $colorsize->qty }}" onchange="MsPurTrimQty.calculateAmount({{ $i }},{{$loop->count}},'qty')"/>
                    </td>
                    <td>
                    <input type="text" name="rate[{{ $i  }}]" id="rate_{{ $i }}" class="number integer"  value="{{ $colorsize->rate }}" onchange="MsPurTrimQty.calculateAmount({{ $i }},{{$loop->count}},'rate')"/>
                    </td>
                    <td>
...
<caption>Saved Color Size</caption>
    ...
    <tbody>
	  ...
	  ?>
                    ...
                    <td>
                    <input type="text" name="amount[{{ $i }}]" id="amount_{{ $i }}" class="number integer" value="{{ $colorsize->pur_trim_qty_id }}" readonly/>
                    </td>
                    </tr>
		  <?php
		  $i++;
