    ...
    <tbody>
	 ...
	 // $i=1;
	  ...
	  ?>
                    ...
                    <input type="hidden" name="po_fabric_item_id[{{ $i }}]"  value="{{ $colorsize->po_fabric_item_id }}"/>
                    ...
                    <td width="70px">
                    <input type="text" name="qty[{{ $i }}]" id="qty{{ $i }}" class="number integer" value="{{ $colorsize->qty }}" onchange="MsPoFabricItemQty.calculateAmount({{ $i }},{{$loop->count}},'qty')"/>
                    </td>
                    <td>
                    <input type="text" name="rate[{{ $i  }}]" id="rate_{{ $i }}" class="number integer"  value="{{ $colorsize->rate }}" onchange="MsPoFabricItemQty.calculateAmount({{ $i }},{{$loop->count}},'rate')"/>
                    </td>
                    <td>
...
<caption>Saved Color Size</caption>
    ...
    <tbody>
	  ...
	  ?>
                    ...
                    <td>
                    <input type="text" name="po_fabric_item_qty_id[{{ $i }}]" id="po_fabric_item_qty_id_{{ $i }}" class="number integer" value="{{ $colorsize->po_fabric_item_qty_id }}" readonly/>
                    </td>
                    </tr>
		  <?php
		  $i++;
