<div class="easyui-accordion" data-options="multiple:false" style="width:100%;" id="podyechemAccordion">
 <div title="Master" data-options="iconCls:'icon-ok'" style="padding:1px;height:520px">
  <div class="easyui-layout" data-options="fit:true">
   <div data-options="region:'center',border:true,title:'List',footer:'#podyechemTblFt'" style="padding:2px">
    <table id="podyechemTbl">
     <thead>
      <tr>
    ...
    <div id="podyechemTblFt" style="padding:0px 0px; text-align:right; background:#F3F3F3;">
     ...
     <a href="javascript:void(0)" class="easyui-linkbutton c1" style="height:25px; border-radius:1px"
      iconCls="icon-search" plain="true" id="save" onClick="MsPoDyeChem.searchPoDyeChem()">Show</a>
    </div>
   </div>
   <div
    ...
    <form id="podyechemFrm">
     ...
     <div id="ft2" style="padding:0px 0px; text-align:right; background:#F3F3F3;">
      <a href="javascript:void(0)" class="easyui-linkbutton  c1" style="height:25px; border-radius:1px"
       iconCls="icon-save" plain="true" id="save" onClick="MsPoDyeChem.submit()">Save</a>
      <a href="javascript:void(0)" class="easyui-linkbutton c6" style="height:25px;border-radius:1px"
       iconCls="icon-remove" plain="true" id="delete" onClick="msApp.resetForm('podyechemFrm')">Reset</a>
      ...
      <a href="javascript:void(0)" class=" easyui-linkbutton c5" style="height:25px;border-radius:1px"
       iconCls="icon-remove" plain="true" id="pdf" onClick="MsPoDyeChem.pdf()">PDF</a>
      <a href="javascript:void(0)" class=" easyui-linkbutton c5" style="height:25px;border-radius:1px"
       iconCls="icon-remove" plain="true" id="pdf" onClick="MsPoDyeChem.openTopSheetWindow()">Top Sheet</a>
      {{-- <a href="javascript:void(0)" class=" easyui-linkbutton c5" style="height:25px;border-radius:1px" iconCls="icon-remove" plain="true" id="pdf" onClick="MsPoDyeChem.pdf2()" >PDF-2</a> --}}
     </div>
    </form>
   </div>
 ...
 <div title="Items" style="overflow:auto;padding:1px;height:520px">
  <div class="easyui-layout" data-options="fit:true">
   <div data-options="region:'west',border:true,title:'From',footer:'#podyechemitemfrmft'"
    style=" width:350px;padding:2px; ">
    <form id="podyechemitemFrm">
     <div id="container">
      <div id="body">
       <code>
                    <div class="row">
                        <div class="col-sm-4">Item Desc.</div>
                          <div class="col-sm-8">
                            ...
                            <input type="hidden" name="po_dye_chem_id" id="po_dye_chem_id" class="integer number" readonly/>   
                          </div>
                        </div>
                        <div class="row middle">
                          <div class="col-sm-4 req-text" >PO. Qty </div>
                          <div class="col-sm-8"><input type="text" name="qty" id="qty" class="integer number" onchange="MsPoDyeChemItem.calculate()" /></div>
                        </div>
                        <div class="row middle">
                          <div class="col-sm-4 req-text" >Rate</div>
                          <div class="col-sm-8"><input type="text" name="rate" id="rate" class="integer number" onchange="MsPoDyeChemItem.calculate()"/></div>
                        </div>
                        <div class="row middle">
     ...
     <div id="podyechemitemfrmft" style="padding:0px 0px; text-align:right; background:#F3F3F3;">
      <a href="javascript:void(0)" class="easyui-linkbutton  c1" style="height:25px; border-radius:1px"
       iconCls="icon-save" plain="true" id="save" onClick="MsPoDyeChemItem.submit()">Save</a>
      <a href="javascript:void(0)" class="easyui-linkbutton c6" style="height:25px;border-radius:1px"
       iconCls="icon-remove" plain="true" id="delete" onClick="msApp.resetForm('podyechemitemFrm')">Reset</a>
      <a href="javascript:void(0)" class=" easyui-linkbutton c5" style="height:25px;border-radius:1px"
       iconCls="icon-remove" plain="true" id="delete" onClick="MsPoDyeChemItem.remove()">Delete</a>
     </div>
    </form>
   </div>
   <div data-options="region:'center',border:true,title:'List',footer:'#podyechemitemtblft'" style="padding:2px; ">
    <div class="easyui-layout" data-options="fit:true">
     <table id="podyechemitemTbl" style="width:1250px">
      <thead>
       <tr>
     ...
     <div id="podyechemitemtblft" style="padding:0px 0px; text-align:right; background:#F3F3F3;">
      <a href="javascript:void(0)" class="easyui-linkbutton  c1" style="height:25px; border-radius:1px"
       iconCls="icon-save" plain="true" id="save" onClick="MsPoDyeChemItem.openItemWindow()">Import Item</a>
     </div>
    </div>
   </div>
  </div>
...
<div id="importdyechemWindow" class="easyui-window" title="Item"
 data-options="modal:true,closed:true,iconCls:'icon-save'" style="width:100%;height:100%;padding:2px;">
 <div class="easyui-layout" data-options="fit:true">
  <div data-options="region:'center',border:true,footer:'#podyechemsearchtblft'" style="padding:2px">
   <div class="easyui-layout" data-options="fit:true">
    <table id="podyechemsearchTbl" style="width:610px">
     <thead>
      <tr>
       <th data-options="field:'id'" width="50">ID</th>
       <th data-options="field:'requisition_no'" width="100">Requisition No</th>
    ...
    <div id="podyechemsearchtblft" style="padding:0px 0px; text-align:right; background:#F3F3F3;">
     <a href="javascript:void(0)" class="easyui-linkbutton  c1" style="height:25px; border-radius:1px"
      iconCls="icon-save" plain="true" id="save" onClick="MsPoDyeChemItem.closeItemWindow()">Close</a>
    </div>
   </div>
  </div>
  <div data-options="region:'west',border:true,footer:'#podyechemsearchfrmft'" style="padding:2px; width: 350px">
   <div class="easyui-layout" data-options="fit:true">
    <div id="body">
     <code>
                <form id="podyechemsearchFrm">
                    <div class="row ">
    ...
    <div id="podyechemsearchfrmft" style="padding:0px 0px; text-align:right; background:#F3F3F3;">
     <a href="javascript:void(0)" class="easyui-linkbutton  c1" style="height:25px; border-radius:1px"
      iconCls="icon-save" plain="true" id="save" onClick="MsPoDyeChemItem.searchDyeChem()">Search</a>
    </div>
   </div>
...
<div id="podyechemitemWindow" class="easyui-window" title="Item"
 data-options="modal:true,closed:true,iconCls:'icon-save'" style="width:100%;height:100%;padding:2px;">
 <div class="easyui-layout" data-options="fit:true">
  <div data-options="region:'center',border:true,footer:'#podyechemitemmultifrmft'" style="padding:2px">
   <form id="podyechemitemmultiFrm">
    <code id="importdyechemscs" style="margin:0px">
			  	</code>
   </form>
   <div id="podyechemitemmultifrmft" style="padding:0px 0px; text-align:right; background:#F3F3F3;">
    <a href="javascript:void(0)" class="easyui-linkbutton  c1" style="height:25px; border-radius:1px"
     iconCls="icon-save" plain="true" id="save" onClick="MsPoDyeChemItem.submitBatch()">save</a>
   </div>
  </div>
 </div>
</div>

<div id="podyechemtopsheetWindow" class="easyui-window" title="Top Sheet"
 data-options="modal:true,closed:true,iconCls:'icon-save'" style="width:100%;height:100%;padding:2px;">
 <div class="easyui-layout" data-options="fit:true">
  <div data-options="region:'center',border:true,footer:'#podyechemtopsheetWindowFt'" style="padding:2px">
   <table id="podyechemtopsheetTbl" style="width:100%">
    <thead>
     ...
     <th data-options="field:'',halign:'center'" align="right" width="80" formatter="MsPoDyeChem.topsheetporemovebtn">
     </th>
    </thead>
   </table>
  </div>
  <div id="podyechemtopsheetWindowFt" style="padding:0px 0px; text-align:right; background:#F3F3F3;">
   <a href="javascript:void(0)" class="easyui-linkbutton  c1" style="height:25px; border-radius:1px" iconCls="icon-save"
    plain="true" id="save" onClick="MsPoDyeChem.printTopSheet()">PDF</a>
  </div>
 </div>
</div>
...
<script type="text/javascript" src="<?php echo url('/');?>/js/Util/MsPoDyeChemController.js"></script>
<script type="text/javascript" src="<?php echo url('/');?>/js/Util/MsPoDyeChemItemController.js"></script>
...
<script>
 $(".datepicker" ).datepicker({
  ...
  $('#podyechemFrm [id="supplier_id"]').combobox();
  $('#podyechemFrm [id="indentor_id"]').combobox();
</script>