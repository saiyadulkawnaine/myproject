...
<table id="mktcosttrimTbl" style="width:100%">
<thead>
    <tr>
...
<div data-options="region:'west',border:true,title:'Add New MktCostTrim',footer:'#ft2'" style="width:350px; padding:2px">
...
<script type="text/javascript" src="<?php echo url('/');?>/js/Util/MsMktCostTrimController.js"></script>
