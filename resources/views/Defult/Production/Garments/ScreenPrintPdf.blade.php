<table  cellspacing="0" cellpadding="2">
    <tr>
        <th colspan="3" align="center"><h4>Cut Panel Delivery To Print</h4></th>
    </tr>
    <tr>
        <td width="160">&nbsp;&nbsp;&nbsp;&nbsp;To </td>
        <td width="160"></td>
        <td width="160"></td>
        <td width="160">&nbsp;&nbsp;&nbsp;&nbsp;Challan No: {{$prodgmtdlvprint['challan_no']}}</td>
    </tr>
    <tr>
        <td width="160">&nbsp;&nbsp;&nbsp;&nbsp;{{$prodgmtdlvprint['supplier_name']}}</td>
        <td width="160"></td>
        <td width="160"></td>
        <td width="160">&nbsp;&nbsp;&nbsp;&nbsp;Date: {{$prodgmtdlvprint['delivery_date']}}</td>
    </tr>
    <tr>
        <td width="320" colspan="1">&nbsp;&nbsp;&nbsp;&nbsp;{{$prodgmtdlvprint['supplier_address']}}</td>
        {{-- <td width="160"></td> --}}
        <td width="160"></td>
        <td width="160"></td>
    </tr>
