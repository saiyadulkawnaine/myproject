...
<table border="1">
    <tr align="center">
        ...
        <th width="80px"  class="text-center">Total input Qty</th>
        <th width="80px"  class="text-center">Balance Qty</th>
        <th width="80px"  class="text-center">Current input Qty</th>
    </tr>
    <tbody>
...
<table border="1">
    <tr align="center">
        ...
        <th width="80px"  class="text-center">Order Qty</th>
        <th width="80px"  class="text-center">Total input Qty</th>
        <th width="40px"  class="text-center">Balance Qty</th>
        <th width="80px"  class="text-center">Current input Qty</th>
    ...
    <tbody>
        ...
        <td width="80px"><a href="javascript:void(0)" onclick="MsProdGmtSewingLineQty.delete(event,{{ $colorsize->prod_gmt_sewing_line_qty_id }})">Remove</a></td>
    </tr>
        <?php
            $i++;
        ?>
