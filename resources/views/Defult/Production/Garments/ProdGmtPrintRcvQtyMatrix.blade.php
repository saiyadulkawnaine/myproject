...
<table border="1">
 ...
 <tbody>
  ...
  <tr align="center">
   ...
   <td width="80px"><input type="text" name="qty[{{ $i }}]" id="qty{{ $i }}" value="" class="number integer" />
   </td>
   <td width="40px"><input type="text" name="reject_qty[{{ $i }}]" id="reject_qty{{ $i }}" value=""
 ...
 <tbody>
  ...
  <tr align="center">
   ...
   <td width="80px"><input type="text" name="qty[{{ $i }}]" id="qty{{ $i }}" value="{{ $colorsize->qty }}"
     class="number integer" /></td>
   <td width="40px"><input type="text" name="reject_qty[{{ $i }}]" id="reject_qty{{ $i }}"
     value="{{ $colorsize->reject_qty }}" class="number integer" /></td>
   <td width="80px"><a href="javascript:void(0)"
     onclick="MsProdGmtPrintRcvQty.delete(event,{{ $colorsize->prod_gmt_print_rcv_qty_id }})">Remove</a>
   </td>
  </tr>
  <?php
            $i++;
