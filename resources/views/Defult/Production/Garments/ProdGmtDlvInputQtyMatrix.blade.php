...
<table border="1">
    ...
    <tbody>
        ...
        <td width="80px"><a href="javascript:void(0)" onclick="MsProdGmtDlvInputQty.delete(event,{{ $colorsize->prod_gmt_dlv_input_qty_id }})">Remove</a></td>
    </tr>
        <?php
            $i++;
        ?>
