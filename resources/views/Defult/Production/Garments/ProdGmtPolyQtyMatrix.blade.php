...
<table border="1">
    ...
    <tbody>
        ...
        <td width="80px"><a href="javascript:void(0)" onclick="MsProdGmtPolyQty.delete(event,{{ $colorsize->prod_gmt_poly_qty_id }})">Remove</a></td>
    </tr>
        <?php
            $i++;
        ?>
