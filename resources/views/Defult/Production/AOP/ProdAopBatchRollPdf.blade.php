...
<table cellspacing="0" cellpadding="1" border="1">
    <thead>
        <tr>
            ...
            <td width="90" align="center">GSM</td>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td width="90" align="center">{{ $value['dyeing_gsm_weight'] }}</td>
            <td width="45" align="right">{{$value['rcv_qty']}}</td>
        </tr>
        @endforeach
    </tbody>
</table>
...
<td>@if (count($groups)>1)<table cellspacing="0" cellpadding="1" border="1">
    <thead>
        <tr>
            ...
            <!-- <td width="40" align="center">Fin. Dia</td>
            <td width="40" align="center">Actual GSM </td> -->
            <td width="90" align="center">Req. GSM</td>
            <td width="45" align="center">Roll<br/>Wgt</td>
        </tr>
    </thead>
    <tbody>
