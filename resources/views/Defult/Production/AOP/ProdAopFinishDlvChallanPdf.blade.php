...
<table cellspacing="0" cellpadding="2" border="1">
    <thead>
        <tr>
            ...
            <td width="85" align="center">Batch.No</td>
            <td width="100" align="center">Batch.Color</td>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td width="60" align="center">{{$row->aop_sale_order_no}}</td>
            ...
            <td width="85" align="center">{{$row->batch_no}}</td>
            <td width="100" align="center">{{$row->batch_color_name}}</td>
