...
<table cellspacing="0" cellpadding="2" border="1">
    <thead>
        <tr>
            ...
            <td width="50" align="center">Knitting M/C</td>
            <td width="60" align="center">M/C Dia & Guage</td>
    ...
    <tbody>
        ...
        <tr nobr="true">
            ...
            <td width="50" align="left">{{$row->body_part}}</td>
            <td width="100" align="left">{{$row->fabrication}},{{$row->fabric_shape}},{{$row->fabric_look}}</td>
            ...
            <td width="50" align="center">{{$row->machine_no}} </td>
            <td width="60" align="center">{{$row->machine_dia}} & {{$row->machine_gg}} </td>
