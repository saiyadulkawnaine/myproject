...
<div class="easyui-tabs" style="width:100%;height:100%; border:none" id="prodfinishdlvaoptabs">
    <div title="Delivery" style="padding:2px">
        <div class="easyui-layout" data-options="fit:true">
            <div data-options="region:'center',border:true,title:'List'" style="padding:2px">
                <table id="prodfinishdlvaopTbl" style="width:100%">
                    <thead>
                        <tr>
            ...
            <div data-options="region:'west',border:true,title:'Delivery Reference',footer:'#prodfinishdlvaopFrmft'" style="width: 350px; padding:2px">
                <form id="prodfinishdlvaopFrm">
                    <div id="container">
                        <div id="body">
                            <code>
                                <div class="row">
                    ...
                    <div id="prodfinishdlvaopFrmft" style="padding:0px 0px; text-align:right; background:#F3F3F3;">
                        <a href="javascript:void(0)" class="easyui-linkbutton c1" style="height:25px; border-radius:1px" iconCls="icon-save" plain="true" id="save" onClick="MsProdFinishDlvAop.submit()">Save</a>
                        <a href="javascript:void(0)" class="easyui-linkbutton c6" style="height:25px;border-radius:1px" iconCls="icon-remove" plain="true" id="delete" onClick="msApp.resetForm('prodfinishdlvaopFrm')">Reset</a>
                        <a href="javascript:void(0)" class="easyui-linkbutton c5" style="height:25px;border-radius:1px" iconCls="icon-remove" plain="true" id="delete" onClick="MsProdFinishDlvAop.remove()">Delete</a>
                        <a href="javascript:void(0)" class="easyui-linkbutton c5" style="height:25px;border-radius:1px" iconCls="icon-pdf" plain="true" id="cfdc" onClick="MsProdFinishDlvAop.pdf()">BILL</a>
                        <a href="javascript:void(0)" class="easyui-linkbutton c5" style="height:25px;border-radius:1px" iconCls="icon-pdf" plain="true" id="cfdc" onClick="MsProdFinishDlvAop.challan()">Challan</a>
                        <a href="javascript:void(0)" class="easyui-linkbutton c5" style="height:25px;border-radius:1px" iconCls="icon-pdf" plain="true" id="cfdc" onClick="MsProdFinishDlvAop.pdfshort()">Bill-Short</a>
                    </div>
                </form>
            </div>
        </div>
    ...
    <div title="Roll" style="padding:2px">
        <div class="easyui-layout" data-options="fit:true">
            <div data-options="region:'center',border:true,title:'List',footer:'#prodfinishdlvaoprollTblft'" style="padding:2px" >
                <table id="prodfinishdlvaoprollTbl" style="width:100%">
                    <thead>
                        <tr>
                          <th data-options="field:'del'" width="60" formatter="MsProdFinishDlvAopRoll.formatDetail">Action</th>
                 ...
                 <div id="prodfinishdlvaoprollTblft" style="padding:0px 0px; text-align:right; background:#F3F3F3;">
                        <a href="javascript:void(0)" class="easyui-linkbutton c1" style="height:25px; border-radius:1px" iconCls="icon-save" plain="true" id="save" onClick="MsProdFinishDlvAopRoll.import()">Import</a>
...
<div id="prodfinishdlvaoprollWindow" class="easyui-window" title="Production Knitting Roll" data-options="modal:true,closed:true,iconCls:'icon-save'" style="width:100%;height:100%;padding:2px;">
    <div class="easyui-layout"  data-options="fit:true">
        <div data-options="region:'south',border:true,footer:'#prodfinishdlvaoprollWindowFt'" style="padding:2px; height: 250px">
            <table id="prodfinishdlvaoprollselectedTbl" style="width:100%">
            <thead>
            <tr>
              <th data-options="field:'id'" width="70">ID</th>
            ...
            <div id="prodfinishdlvaoprollWindowFt" style="padding:0px 0px; text-align:right; background:#F3F3F3;" >
              

            <a href="javascript:void(0)" class="easyui-linkbutton  c1" style="height:25px; border-radius:1px" iconCls="icon-save" plain="true" id="save" onClick="MsProdFinishDlvAopRoll.submit()">Save</a>
            </div>
        </div>
        <div data-options="region:'center',border:true,footer:'#prodfinishdlvaoprollselectionTblFt'" style="padding:2px">
            <table id="prodfinishdlvaoprollselectionTbl" style="width:100%">
            <thead>
            <tr>
            <th data-options="field:'id'" width="70">ID</th>
            <th data-options="field:'batch_no'" width="70">Batch No</th>
            ...
            <div id="prodfinishdlvaoprollselectionTblFt" style="padding:0px 0px; text-align:right; background:#F3F3F3;" >
             Finish QC Date: <input type="text" name="aop_from_qc_date" id="aop_from_qc_date" class="datepicker" style="width: 100px ;height: 23px" />
            <input type="text" name="aop_to_qc_date" id="aop_to_qc_date" class="datepicker" style="width: 100px;height: 23px" />
            Batch No: <input type="text" name="aop_batch_no" id="aop_batch_no" style="width: 100px ;height: 23px" />
            Batch Date: <input type="text" name="aop_batch_date_from" id="aop_batch_date_from" class="datepicker" style="width: 100px ;height: 23px" />
            <input type="text" name="aop_batch_date_to" id="aop_batch_date_to" class="datepicker" style="width: 100px;height: 23px" />
            <a href="javascript:void(0)" class="easyui-linkbutton  c1" style="height:25px; border-radius:1px" iconCls="icon-save" plain="true" id="save" onClick="MsProdFinishDlvAopRoll.getRoll()">Show</a>
            </div>   
        </div>
    </div>
</div>
<script type="text/javascript" src="<?php echo url('/');?>/js/Production/Dyeing/MsProdFinishDlvAopController.js"></script>
<script type="text/javascript" src="<?php echo url('/');?>/js/Production/Dyeing/MsProdFinishDlvAopRollController.js"></script>
<script>
    (function(){
      ...
      $('#prodfinishdlvaopFrm [id="buyer_id"]').combobox();
   })(jQuery);
</script>
