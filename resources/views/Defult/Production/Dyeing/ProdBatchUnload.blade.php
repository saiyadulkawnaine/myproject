<div class="easyui-tabs animated rollIn" style="width:100%;height:100%; border:none" id="prodbatchunloadtabs">
    <div title="Batch" style="padding:2px">
        <div class="easyui-layout" data-options="fit:true">
            <div data-options="region:'center',border:true,title:'List',footer:'#prodbatchunloadTblFt'" style="padding:2px">
                <table id="prodbatchunloadTbl" style="width:100%">
                    <thead>
                        <tr>
                            ...
                            <th data-options="field:'unload_date'" width="80">Un Load Date</th>
                            <th data-options="field:'unload_time'" width="80">Un Load Time</th>
                            <th data-options="field:'unload_posting_date'" width="80">Prod.Date</th>
                            <th data-options="field:'acl_pro_hour'" width="80">Actual Process Hour</th>
                            <th data-options="field:'unload_remarks'" width="80">Remarks</th>
                    ...
                    <div id="prodbatchunloadTblFt" style="padding:0px 0px; text-align:right; background:#F3F3F3;">
                    Batch Date: <input type="text" name="from_batch_date" id="from_batch_date" class="datepicker" style="width: 80px ;height: 23px" />
                    <input type="text" name="to_batch_date" id="to_batch_date" class="datepicker" style="width: 80px;height: 23px" />
                    Prod Date: <input type="text" name="from_posting_date" id="from_posting_date" class="datepicker" style="width: 80px ;height: 23px" />
                    <input type="text" name="to_posting_date" id="to_posting_date" class="datepicker" style="width: 80px;height: 23px" />
                    Unload Date: <input type="text" name="from_unload_date" id="from_unload_date" class="datepicker" style="width: 80px ;height: 23px" />
                    <input type="text" name="to_unload_date" id="to_unload_date" class="datepicker" style="width: 80px;height: 23px" />
                    <a href="javascript:void(0)" class="easyui-linkbutton c1" style="height:25px; border-radius:1px" iconCls="icon-search" plain="true" id="save" onClick="MsProdBatchUnload.searchList()">Show</a>
                </div>
                </table>
            </div>
            <div data-options="region:'west',border:true,title:'Add Details',footer:'#prodbatchunloadFrmft'" style="width: 400px; padding:2px">
                <form id="prodbatchunloadFrm">
                    <div id="container">
                        <div id="body">
                            <code>
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" name="id" id="id" ondblclick="MsProdBatchUnload.batchWindow()" placeholder=" Double Click"  readonly />
                                    </div>
                                </div>
                                ...
                                <div class="row middle">
                                 ...
                                 <div class="row middle">
                                    ...
                                    <div class="col-sm-4" style="padding-right:0px">
                                        <input type="text" name="load_date" id="load_date" value="{{ date('Y-m-d') }}" placeholder="date" class="datepicker" disabled/>
                                    </div>
                                    <div class="col-sm-4" style="padding-left:0px">
                                        <input type="text" name="load_time" id="load_time" value="" placeholder="time" disabled />
                                    </div>
                                </div>
                                <div class="row middle">
                                    <div class="col-sm-4 req-text">Unload Date Time</div>
                                    <div class="col-sm-4" style="padding-right:0px">
                                ...
                                <div class="row middle">
                                    <div class="col-sm-4">Actual Pro. Hour</div>
                                    <div class="col-sm-8">
                                        <input type="text" name="acl_pro_hour" id="acl_pro_hour" disabled />
                                    </div>
                                </div>
                                <div class="row middle">
                                    <div class="col-sm-4">Prod.Date</div>
                                    <div class="col-sm-8">
                                        <input type="text" name="unload_posting_date" id="unload_posting_date" value="{{-- {{ date('Y-m-d') }} --}}" class="datepicker" />
                                    </div>
                                </div>
                                ...
                                <div class="row middle">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" name="unload_remarks" id="unload_remarks" />
                                    </div>
                                </div>
                            </code>
                        </div>
                    </div>
                    <div id="prodbatchunloadFrmft" style="padding:0px 0px; text-align:right; background:#F3F3F3;">
                        <a href="javascript:void(0)" class="easyui-linkbutton c1" style="height:25px; border-radius:1px" iconCls="icon-save" plain="true" id="save" onClick="MsProdBatchUnload.submit()">Save</a>
                        <a href="javascript:void(0)" class="easyui-linkbutton c6" style="height:25px;border-radius:1px" iconCls="icon-remove" plain="true" id="delete" onClick="MsProdBatchUnload.resetForm()">Reset</a>
                        <a href="javascript:void(0)" class="easyui-linkbutton c5" style="height:25px;border-radius:1px" iconCls="icon-remove" plain="true" id="delete" onClick="MsProdBatchUnload.remove()">Delete</a>
                    </div>
                </form>
            </div>
        </div>
    ...
    <div title="Roll" style="padding:2px">
        <div class="easyui-layout" data-options="fit:true">
            <div data-options="region:'center',border:true,title:'List'" style="padding:2px">
                <table id="prodbatchunloadrollTbl" style="width:100%">
                    <thead>
                        <tr>
...
<div id="prodbatchunloadbatchWindow" class="easyui-window" title="Machine Window" data-options="modal:true,closed:true,iconCls:'icon-save'" style="width:100%;height:100%;padding:2px;">
    <div class="easyui-layout" data-options="fit:true">
       <div data-options="region:'center',border:true,footer:'#prodbatchunloadbatchsearchTblFt'" style="padding:2px">
            <table id="prodbatchunloadbatchsearchTbl" style="width:100%">
                <thead>
                    <tr>
                    <th data-options="field:'id'" width="40">ID</th>
                    <th data-options="field:'company_code'" width="80">Company</th>
                    ...
                    <th data-options="field:'machine_no'" width="80">Machine No</th>
                    <th data-options="field:'batch_color_name'" width="80">Roll Color</th>
            ...
            <div id="prodbatchunloadbatchsearchTblFt" style="padding:0px 0px; text-align:right; background:#F3F3F3;" >
            <a class="easyui-linkbutton c1" data-options="iconCls:'icon-ok'" href="javascript:void(0)" onclick="$('#prodbatchunloadbatchWindow').window('close')" style="width:80px">Close</a>
                </div>
        </div>
        <div data-options="region:'west',border:true,footer:'#prodbatchunloadbatchsearchFrmFt'" style="padding:2px; width:350px">
            <form id="prodbatchunloadbatchsearchFrm">
                <div id="container">
                    <div id="body">
                        <code>
                            <div class="row ">
                ...
                <div id="prodbatchunloadbatchsearchFrmFt" style="padding:0px 0px; text-align:right; background:#F3F3F3;" >
                <a href="javascript:void(0)" class=" easyui-linkbutton c5" style="height:25px;border-radius:1px"  plain="true"  onClick="MsProdBatchUnload.getBatch()" >Search</a>
                </div>
            </form>
        </div>
    </div>
...
<script type="text/javascript" src="<?php echo url('/');?>/js/Production/Dyeing/MsProdBatchUnloadController.js"></script>
