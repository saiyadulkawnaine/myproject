...
<table cellspacing="0" cellpadding="2" border="1">
    <thead>
        <tr>
            ...
            <td width="35" align="center">Req GSM/<br/>Weight</td>
            <td width="30" align="center">Req Dia/<br/>Width</td>
            <td width="60" align="center">Color Range</td>
            <td width="105" align="center">Batch Color &<br/>Batch No</td>
            <td width="70" align="center">Color %</td>
            ...
            <td width="85" align="center">Buyer</td>
    ...
    <tbody>
        ...
        <tr nobr="true">
            ...
            <td width="150" align="left">{{$row->fabrication}},{{$row->fabric_shape}},{{$row->fabric_look}}</td>
            <td width="35" align="center">{{$row->req_gsm_wgt }}</td>
            <td width="30" align="center">{{$row->req_dia }}</td>
            <td width="60" align="left">{{$row->colorrange_name}}</td>
            <td width="105" align="center">{{$row->batch_color_name}} & {{$row->batch_no}}</td>
            <td width="70" align="left">{{$row->ratio}}</td>
            ...
            <td width="85" align="left">{{ $row->buyer_name }}</td>
            <td width="70" align="left">{{$row->style_ref}} & {{$row->sale_order_no}}</td>
        </tr>
        <?php
            $i++;
        ...
        @endforeach
        <tr>
            <td width="575" align="right">Total</td>
