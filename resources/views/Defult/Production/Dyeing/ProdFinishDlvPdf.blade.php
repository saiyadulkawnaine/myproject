...
<table cellspacing="0" cellpadding="2" border="1">
 <thead>
  <tr>
   ...
   <td width="40" align="center">GSM/<br />Weight</td>
   <td width="35" align="center">Dia/<br />Width</td>
 ...
 <tbody>
  ...
  <tr nobr="true">
   ...
   <td width="160" align="left">{{$row->fabrication}},{{$row->fabric_shape}},{{$row->fabric_look}}</td>
   <td width="100" align="center">{{$row->batch_color_name}} & {{$row->batch_no}}</td>
   <td width="40" align="center">{{$row->gsm_weight}}</td>
   <td width="35" align="center">{{$row->dia_width}}</td>
  ...
  @endforeach
  <tr>
   <td width="625" align="right">Total</td>
