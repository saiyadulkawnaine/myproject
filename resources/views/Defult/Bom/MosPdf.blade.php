...
<thead>
    <tr align="center">
        ...
        <td width="50px">Fab. Construction</td>
        <td width="70px">Composition</td>
        ...
        <td width="60px">Finished Fab. Qty</td>
        <td width="60px">Grey Fab. Qty</td>
    ...
    $main_grey_fab=0;
    ?>
    @foreach($budget['fabrics']['main'] as $row)
    @if($row->fin_fab)
    <tr>
        <td width="60px">{{ $row->item_description }}</td>
        <td width="50px"> {{ $row->constructions_name }}</td>
        <td width="70px">{{ $row->fabric_description }}</td>
        ...
        <td width="60px" align="right">{{number_format($row->fin_fab,2)}}</td>
        <td width="60px" align="right">{{number_format($row->grey_fab,2)}}</td>
        <td width="28px">{{$row->uom_name}}</td>
        <td width="" align="right">{{number_format($row->order_qty,2)}}</td>
    </tr>
    <?php 
    ...
    <tfoot>
    <tr>
        <td width="430px" align="right">Total </td>
        

        <td width="60px" align="right">{{number_format($main_fin_fab,2)}}</td>
        <td width="60px" align="right">{{number_format($main_grey_fab,2)}}</td>
        <td width="28px"></td>
        <td width=""></td>
    </tr>
    </tfoot>
...
<thead>
    ...
    $narrow_grey_fab=0;
    ?>
    @foreach($budget['fabrics']['narrow'] as $row)
    @if($row->fin_fab)
    <tr>
        <td width="60px">{{ $row->item_description }}</td>
    ...
    <tr>
        <td width="440" align="right">Fabric Total</td>
