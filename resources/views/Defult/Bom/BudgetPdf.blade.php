...
<thead>
    ...
    <?php 
    $nwtot+= $value['amount'];
    $nwtotcons+= $value['fabric_cons'];
    $nwtotfincons+= $value['req_fin_cons'];
    $i++;
    ?>
    @endforeach
    </tbody>
    ...
    <tr>
        ...
        <td width="80px"></td>
        <td width="30px">Total</td>
        <td width="50px" align="right">{{ number_format($nwtotcons,2)}}</td>
        <td width="40px"></td>
        <td width="60px" align="right">{{ number_format($nwtot,2)}}</td>
    </tr>
    <tr>
        <td width="70px"></td>
        <td width="308px"></td>
        <td width="110px" align="right">Grand Total</td>
        <td width="50px" align="right">{{ number_format($mtotcons+$nwtotcons,2)}}</td>
        <td width="40px"></td>
        <td width="60px" align="right">{{ number_format($mtot+$nwtot,2)}}</td>
    </tr>
    </tfoot>
</table>
...
<thead>
    ...
    <tr>
        ...
        <td width="60px" align="right">{{number_format((($mtot+$nwtot)/$budget['master']->order_qty)*12,2)}}
        </td>
        <td width="60px" align="right">{{number_format($mtot+$nwtot,2)}}
        </td>
        
        <td width="60px" align="right">
        {{number_format((($mtot+$nwtot)*100)/$budget['master']->order_amount,2)}} %
        </td>
    </tr>
    <tr>
...
<td width="300">
    <?php
    //echo $mtotcons."+".$nwtotcons."-".$mtotfincons."+".$nwtotfincons;
    $fabprocesslossper=((($mtotcons+$nwtotcons)-($mtotfincons+$nwtotfincons))*100)/($mtotcons+$nwtotcons);
