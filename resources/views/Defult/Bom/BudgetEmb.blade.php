...
<div data-options="region:'west',border:true,title:'Add New BudgetYarn',footer:'#ft2'" style="width:350px; padding:2px">
<form id="budgetyarnFrm">
         ...
         <div id="body">
           <code>
             ...
             <div class="row middle">
                 ...
                 <div class="col-sm-8">{!! Form::select('embelishment_id', $budgetfabric,'',array('id'=>'embelishment_id')) !!}</div>
             </div>
             <div class="row middle">
    ...
    <div id="ft2" style="padding:0px 0px; text-align:right; background:#F3F3F3;" >
        <a href="javascript:void(0)" class="easyui-linkbutton  c1" style="height:25px; border-radius:1px" iconCls="icon-save" plain="true" id="save" onClick="MsBudgetYarn.submit()">Save</a>
        <a href="javascript:void(0)" class="easyui-linkbutton c6" style="height:25px;border-radius:1px" iconCls="icon-remove" plain="true" id="delete" onClick="msApp.resetForm('budgetyarnFrm')" >Reset</a>
        <a href="javascript:void(0)" class=" easyui-linkbutton c5" style="height:25px;border-radius:1px" iconCls="icon-remove" plain="true" id="delete" onClick="MsBudgetYarn.remove()" >Delete</a>
    </div>

  </form>
</div>
</div>
<script type="text/javascript" src="<?php echo url('/');?>/js/Util/MsBudgetYarnController.js"></script>
