...
<table cellspacing="0" cellpadding="2">
    <tr>
        ...
        <td width="130" align="left"><strong>Total</strong></td>
        <td width="100" align="right">@if ($data['master']->do_for==2){{ number_format($tQty,2) }}@endif</td>
    ...
    <tr>
        <td width="110" align="left"></td>
        <td width="130" align="left"><strong>Amount Received</strong></td>
        <td width="100" align="right"></td>
        <td width="100" align="right"></td>
    ...
    <tr>
        <td width="110" align="left"></td>
        <td width="130" align="left"><strong>Yet to Receive</strong></td>
        <td width="100" align="right"></td>
        <td width="100" align="right"></td>
    ...
    <tr>
        <td width="110" align="left"></td>
        <td width="130" align="left"><strong>Previous Outstandings</strong></td>
        <td width="100" align="right"></td>
        <td width="100" align="right"></td>
    ...
    <tr>
        <td width="110" align="left"></td>
        <td width="130" align="left"><strong>Total Outstandings</strong></td>
        <td width="100" align="right"></td>
        <td width="100" align="right"></td>
