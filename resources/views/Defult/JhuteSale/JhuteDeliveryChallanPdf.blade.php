<table>
    <tr>
        ...
        <td align="left" width="200">Driver Name:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{ $data['master']->driver_name }}<br/>Driver Contact:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{ $data['master']->driver_contact_no }}<br/>Driver License No:{{ $data['master']->driver_license_no }}
        </td>
        <td align="left" width="130">Truck No: {{ $data['master']->truck_no }}<br/>Lock No:&nbsp;&nbsp;{{ $data['master']->lock_no }}</td>
        <td align="left" width="120">Challan No: {{ $data['master']->dlv_no }}<br/>Challan Date:{{ $data['master']->dlv_date }}</td>
    </tr>
    <tr>
...
<table border="1" cellspacing="0" cellpadding="2">
    <tr>
        ...
        <td align="center" width="250"><strong>Remarks</strong></td>
    </tr>
    <?php
        $i=1;
    ?>
    ...
    <tbody>
        <tr>
            ...
            <td align="left" width="250">{{ $rows->order_item_remarks }}</td>
        </tr>
    </tbody> 
    @endforeach
</table>
...
<table>
    ...
    <tr>
        ...
        <td width="100" align="left"></td>
        <td width="100" align="left"></td>
        <td width="180" align="left">@if ($data['master']->approvedby_signature)<img src="{{ $data['master']->approvedby_signature }}" width="100", height="40" />
        @endif</td>
    </tr>
    <tr>
        ...
        <td width="100" align="left"></td>
        <td width="100" align="left"></td>
        <td width="180" align="left"><strong>{{$data['master']->approvedby_user_name}}<br/>{{$data['master']->approvedby_designation}}</strong></td>
    </tr>
</table>