...
<table id="offerstatementTbl" style="width:1890px">
<thead>
    <tr>
        <th data-options="field:'ck',checkbox:true" width="70" halign:'center'>#</th>
        <th data-options="field:'pdf',halign:'center'" width="40" halign:'center' formatter="MsOfferStatement.formatpdf" align="center">Details</th>
        ...
        <th data-options="field:'flie_src',halign:'center',align:'center'" formatter="MsOfferStatement.formatimage" width="30">Image</th>
        ...
        <th data-options="field:'price',halign:'center',styler:MsOfferStatement.quotedprice" width="60" align="right">Quote <br/> Price /Pcs</th>
...
<div id="ft3" style="padding:0px 0px; text-align:right; background:#F3F3F3;" >
        <a href="javascript:void(0)" class="easyui-linkbutton  c1" style="height:25px; border-radius:1px" iconCls="icon-save" plain="true" id="save" onClick="MsOfferStatement.show()">Show</a>
    </div>
</div>
<div data-options="region:'west',border:true,title:'Search',footer:'#ft2'" style="width:350px; padding:2px">
<form id="offerstatementFrm">
    <div id="container">
         <div id="body">
           <code>
    ...
    <div id="ft2" style="padding:0px 0px; text-align:right; background:#F3F3F3;" >
        <a href="javascript:void(0)" class="easyui-linkbutton  c1" style="height:25px; border-radius:1px" iconCls="icon-save" plain="true" id="save" onClick="MsOfferStatement.get()">Show</a>
        <a href="javascript:void(0)" class="easyui-linkbutton c6" style="height:25px;border-radius:1px" iconCls="icon-remove" plain="true" id="delete" onClick="MsOfferStatement.resetForm('offerstatementFrm')" >Reset</a>
    </div>

  </form>
</div>
</div>
<div id="offerstatementImageWindow" class="easyui-window" title="Image" data-options="modal:true,closed:true,iconCls:'icon-save'" style="width:500px;height:500px;padding:2px;">
    <img id="offerstatementImageWindowoutput" src=""/>
</div>
{{-- File Src --}}
    ...
    <table id="filesrcTbl" style="width:500px">
        <thead>
            <tr>
                ...
                <th data-options="field:'original_name'" formatter="MsOfferStatement.formatShowFile" width="250px">Original Name</th>
            </tr>
        </thead>
    </table>
</div>
<script type="text/javascript" src="<?php echo url('/');?>/js/report/MsOfferStatementController.js"></script>
<script>
