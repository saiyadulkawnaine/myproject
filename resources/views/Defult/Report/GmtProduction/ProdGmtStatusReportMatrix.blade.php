...
<p align="right" style="width:80%"><strong>Garment Item: {{ $itemArr[$item_account_id]['item_description'] }}</strong><br>
            ...
            ?>
                <tr>
                    ...
                    @foreach ($data as $sizewise)
                        <td align="center"  width="60"><strong>{{ $sizewise->size_name }}</strong></td>
                    @endforeach
                    <td align="center"  width="80"><strong>TOTAL</strong></td>
                </tr>
                <tr>
                    <td align="left">Order Qty</td>
                    @foreach ($data as $sizewise)
                    <td align="right"  width="60">{{ $sizewise->qty }}</td>
                        <?php
                            $tStQty+=$sizewise->qty;
                        ?>
                    @endforeach
                    <td align="right"  width="80">{{ $tStQty }}</td>
                </tr>
                <tr>
                    ...
                    @foreach ($data as $sizewise)
                        ...
                        ?>
                        <td width="60" align="right" style="background-color:{{$cutting_color}}">{{ $sizewise->cut_qty }}</td>
                    @endforeach
                    <td width="80" align="right">{{ $tStCutQty }}</td>
                </tr>
                <tr>
                    <td align="left">Screen Print Req</td>
                    @foreach ($data as $sizewise)
                        <td width="60" align="right">{{ $sizewise->req_scr_qty }}</td>
                        <?php
                            $tStScrnReqQty+=$sizewise->req_scr_qty;
                        ?>
                    @endforeach
                    <td  width="80"align="right">{{ $tStScrnReqQty }}</td>
                </tr>
                <tr>
                    ...
                    ?>
                        <td width="60" align="right" style="background-color:{{$scr_print_color}}">{{ $sizewise->rcv_scr_qty }}</td>
                    @endforeach
                    <td width="80" align="right">{{ $tStScrnRcvQty }}</td>
                </tr>
                <tr>
                    <td align="left">Embroidery Req</td>
                    @foreach ($data as $sizewise)
                        <td width="60" align="right">{{ $sizewise->req_emb_qty }}</td>
                        <?php
                            $tStEmbReqQty+=$sizewise->req_emb_qty;
                        ?>
                    @endforeach
                    <td  width="80" align="right">{{ $tStEmbReqQty }}</td>
                </tr>
                <tr>
                    ...
                    @foreach ($data as $sizewise)
                        ...
                        ?>
                        <td width="60" align="right" style="background-color:{{$emb_color}}">{{ $sizewise->emb_rcv_qty }}</td>
                    @endforeach
                    <td  width="80" align="right">{{ $tStEmbRcvQty }}</td>
                </tr>
                <tr>
                    ...
                    @endforeach
                    <td align="right"><a href="javascript:void(0)" onClick="MsProdGmtStatusReport.detailWindow('{{$item_account_id}}','{{$color_id}}')">{{ $tStSewLineQty }}</a></td>
                </tr>
                <tr>
                    ...
                    ?>
                    <td  width="60" align="right" style="background-color:{{$sew_color}}">{{ $sizewise->sew_qty }}</td>
                    @endforeach
                    <td width="80" align="right"><a href="javascript:void(0)" onClick="MsProdGmtStatusReport.detailWindow('{{$item_account_id}}','{{$color_id}}')">{{ $tStSewQty }}</a></td>
                </tr>
                <tr>
                    ...
                    ?>
                    <td width="60" align="right" style="background-color:{{$iron_color}}">{{ $sizewise->iron_qty }}</td>
                    @endforeach
                    <td width="80" align="right">{{ $tStIronQty }}</td>
                </tr>
                <tr>
                    ...
                    ?>
                    <td width="60" align="right" style="background-color:{{$poly_color}}">{{ $sizewise->poly_qty }}</td>
                    @endforeach
                    <td width="80" align="right">{{ $tStPolyQty }}</td>
                </tr>
                <tr>
                    ...
                    ?>
                    <td width="60" align="right" style="background-color:{{$carton_color}}">{{ $sizewise->carton_qty }}</td>
                    @endforeach
                    <td width="80" align="right">{{ $tStCartonQty }}</td>
                </tr>
                <tr>
                    ...
                    ?>
                    <td width="60" align="right" style="background-color:{{$shipout_color}}">{{ $sizewise->ship_out_qty }}</td>
                    @endforeach
                    <td width="80" align="right">{{ $tStShipOutQty }}</td>
                </tr>
                <tr>
                    <td align="left">Yet to Ship</td>
                    @foreach ($data as $sizewise)
                        <td width="60" align="right">{{ $sizewise->ship_out_qty-$sizewise->qty }}</td>
                        
                    @endforeach
                    <td width="80" align="right">{{ $tStShipOutQty-$tStQty }}</td>
                </tr>
            </table> 
        </td>
    </tr>
...
<h3 align="center">Producing Company: {{ $salesorderArr[$sales_order_id]['produced_company_name'] }}</h3>
    ...
    @foreach ($order as $item_account_id => $orderitem)
        <p align="right" style="width:80%"><strong>Garment Item: {{ $salesordergmtItemArr[$item_account_id]['item_description'] }}</strong><br>
                        ...
                        ?>
                            <tr>
                                ...
                                @foreach ($orddata as $sizewiseorder)
                                    <td width="60" align="center"><strong>{{ $sizewiseorder->size_name }}</strong></td>
                                @endforeach
                                <td align="center" width="80"><strong>TOTAL</strong></td>
                            </tr>
                            <tr>
                                <td align="left">Order Qty</td>
                                @foreach ($orddata as $sizewiseorder)
                                <td align="right" width="60">{{ $sizewiseorder->qty }}</td>
                                    <?php
                                        $tOrderQty+=$sizewiseorder->qty;
                                    ?>
                                @endforeach
                                <td align="right" width="80">{{ $tOrderQty }}</td>
                            </tr>
                            <tr>
                                <td align="left">Cutting Qty</td>
                                @foreach ($orddata as $sizewiseorder)
                                    ...
                                    ?>
                                    <td width="60" align="right" style="background-color:{{$order_cut_color}}">{{ $sizewiseorder->cut_qty }}</td>
                                @endforeach
                                <td width="80" align="right">{{ $tOrderCutQty }}</td>
                            </tr>
                            <tr>
                                <td align="left">Screen Print Req</td>
                                @foreach ($orddata as $sizewiseorder)
                                    ...
                                    ?>
                                    <td width="60" align="right">{{ $sizewiseorder->req_scr_qty }}</td>
                                @endforeach
                                <td width="80" align="right">{{ $tOrderScrnReqQty }}</td>
                            </tr>
                            <tr>
                                <td align="left">Screen Print Done</td>
                                @foreach ($orddata as $sizewiseorder)
                                    ...
                                    ?>
                                    <td width="60" align="right" style="background-color:{{$order_scrrcv_color}}">{{ $sizewiseorder->rcv_scr_qty }}</td>
                                @endforeach
                                <td width="80" align="right">{{ $tOrderScrnRcvQty }}</td>
                            </tr>
                            <tr>
                                <td align="left">Embroidery Req</td>
                                @foreach ($orddata as $sizewiseorder)
                                    ...
                                    <td width="60" align="right">{{ $sizewise->req_emb_qty }}</td>
                                @endforeach
                                <td  width="80" align="right">{{ $tOrderEmbReqQty }}</td>
                            </tr>
                            <tr>
                                <td align="left">Embroidery Done</td>
                                @foreach ($orddata as $sizewiseorder)
                                    ...
                                    ?>
                                    <td width="60" align="right" style="background-color:{{$order_embrcv_color}}">{{ $sizewiseorder->emb_rcv_qty }}</td>
                                @endforeach
                                <td  width="80" align="right">{{ $tOrderEmbRcvQty }}</td>
                            </tr>
                            <tr>
                                <td align="left">Line Input</td>
                                @foreach ($orddata as $sizewiseorder)
                                    <?php
                                        $order_sewline_color='';
                                        if(/* $sizewiseorder->sew_line_qty !==NULL && */ $sizewiseorder->sew_line_qty < $sizewiseorder->qty){
                                            $order_sewline_color='LightPink';
                                        }
                                        $tOrderSewLineQty+=$sizewiseorder->sew_line_qty;
                                    ?>
                                    <td width="60" align="right" style="background-color:{{$order_sewline_color}}">{{ $sizewiseorder->sew_line_qty }}</td>
                                @endforeach
                                <td width="80" align="right">{{ $tOrderSewLineQty }}</td>
                            </tr>
                            <tr>
                                <td align="left">Sewing </td>
                                @foreach ($orddata as $sizewiseorder)
                                    ...
                                    ?>
                                    <td width="60" align="right" style="background-color:{{$order_sew_color}}">{{ $sizewiseorder->sew_qty }}</td>
                                @endforeach
                                <td width="80" align="right">{{ $tOrderSewQty }}</td>
                            </tr>
                            <tr>
                                <td align="left">Iron</td>
                                @foreach ($orddata as $sizewiseorder)
                                <?php
                                    $order_iron_color='';
                                    if(/* $sizewiseorder->iron_qty !==NULL && */ $sizewiseorder->iron_qty < $sizewiseorder->qty){
                                        $order_iron_color='LightPink';
                                    }
                                    $tOrderIronQty+=$sizewiseorder->iron_qty;
                                ?>
                                <td width="60" align="right" style="background-color:{{$order_iron_color}}">{{ $sizewiseorder->iron_qty }}</td>
                                @endforeach
                                <td width="80" align="right">{{ $tOrderIronQty }}</td>
                            </tr>
                            <tr>
                                <td align="left">Poly</td>
                                @foreach ($orddata as $sizewiseorder)
                                <?php
                                    $order_poly_color='';
                                    if(/* $sizewiseorder->poly_qty !==NULL && */ $sizewiseorder->poly_qty < $sizewiseorder->qty){
                                        $order_poly_color='LightPink';
                                    }
                                    $tOrderPolyQty+=$sizewiseorder->poly_qty;
                                ?>
                                <td width="60" align="right" style="background-color:{{$order_poly_color}}">{{ $sizewiseorder->poly_qty }}</td>
                                @endforeach
                                <td width="80" align="right">{{ $tOrderPolyQty }}</td>
                            </tr>
                            <tr>
                                <td align="left">Carton</td>
                                @foreach ($orddata as $sizewiseorder)
                                ...
                                ?>
                                <td width="60" align="right" style="background-color:{{$order_carton_color}}">{{ $sizewiseorder->carton_qty }}</td>
                                @endforeach
                                <td width="80" align="right">{{ $tOrderCartonQty }}</td>
                            </tr>
                            <tr>
                                <td align="left">Shipout</td>
                                @foreach ($orddata as $sizewiseorder)
                                ...
                                ?>
                                <td width="60" align="right" style="background-color:{{$order_shipout_color}}">{{ $sizewiseorder->ship_out_qty }}</td>
                                @endforeach
                                <td width="80" align="right">{{ $tOrderShipOutQty }}</td>
                            </tr>
                            <tr>
                                <td align="left">Yet to Ship</td>
                                @foreach ($orddata as $sizewiseorder)
                                    <td width="60" align="right">{{ $sizewiseorder->ship_out_qty-$sizewiseorder->qty }}</td>
                                    
                                @endforeach
                                <td width="80" align="right">{{ $tOrderShipOutQty-$tOrderQty }}</td>
                            </tr>
                        </table> 
                    </td>
                </tr>
...
<?php
    $sizewiseTotalArr=[];
    $assortment_name=isset($pkgratioAssortnameArr[$style_pkg_id]['assortment_name'])?$pkgratioAssortnameArr[$style_pkg_id]['assortment_name']:'';
?>
    <p><strong>{{$i++}}.Assortment Name:{{ $assortment_name }}</strong></p>
    <table border="1" nobr="true">
        <tr>
            <th width="150" align="center"><strong>Gmt Item</strong></th>
        ...
        <tbody>
            <tr>
                <td width="150" align="left">{{ $pkgratioGmtItemArr[$pkg_item_id]['item_description'] }}</td>
                
                <td colspan="{{ 2+($pkgdtl->count()) }}"><table border="1" style="padding-left: 0px margin-left:0px;border-bottom-color:#fff;border-top-color:#fff;">@foreach ($pkgratiocolorArr as $pkg_color_id=>$pkgcolor)
                        <tr>
                            <td width="69">{{ $pkgcolor }}</td>
                            <?php 
                            ...
                            ?>
                                <td width="40" align="right">{{ $pkg_qty }}</td>
                                <?php 
                            ...
                            ?>
                            @endforeach
                            <td width="50" align="right">{{ $sizewiseTotalPkgQty }}</td>
                        </tr>
                        @endforeach
                    </table>
                </td>
        ...
        <tfoot>
            <tr>
                <th width="150" align="center"><strong>Total</strong></th>
                <th width="70" align="center"></th>
                @foreach ($pkgdtl as $key=>$size_name)
                <th width="40" align="right"><strong>{{ $sizewiseTotalArr[$key] }}</strong></th>
                @endforeach 
                <th width="50" align="right"><strong>{{ array_sum( $sizewiseTotalArr) }}</strong></th>
            </tr>
        </tfoot>
    </table>
    <p></p>
