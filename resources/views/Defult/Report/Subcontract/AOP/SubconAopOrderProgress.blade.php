<div class="easyui-layout animated rollIn"  data-options="fit:true">
    <div data-options="region:'center',border:true,title:'Subcontract Aop Order Progress'" style="padding:2px">
        <table id="subconaoporderprogressTbl" style="width:1890px">
            <thead>
                <tr>
                    ...
                    <th width="160" align="center">14</th>
                    ...
                    <th width="70" align="center">40</th>
                    <th width="120" align="center">41</th>
                </tr>
                <tr>
                    ...
                    <th data-options="field:'local_pi_no_date'" width="160" >PI No & Date</th>
                    ...
                    <th data-options="field:'grey_isu_qty'" width="80" align="right">Grey Isu Qty</th>
                    ...
                    <th data-options="field:'aop_qty'" width="80"  align="right">Aop Qty</th>
                    <th data-options="field:'aop_wip'" width="80"  align="right">Aop WIP</th>
                    <th data-options="field:'aop_bal'" width="80"  align="right">Aop Bal</th>
                    ...
                    <th data-options="field:'so_aop_id'" width="120" align="center">Order ID</th>
                </tr>
            </thead>
        </table>
    </div>
    <div data-options="region:'west',border:true,title:'Search',footer:'#subconaoporderprogressFrmFt'" style="width:350px; padding:2px">
        <form id="subconaoporderprogressFrm">
            <div id="container">
                <div id="body">
                    <code>
            ...
            <div id="subconaoporderprogressFrmFt" style="padding:0px 0px; text-align:right; background:#F3F3F3;" >
                <a href="javascript:void(0)" class="easyui-linkbutton  c1" style="height:25px; border-radius:1px" iconCls="icon-save" plain="true" id="save" onClick="MsSubconAopOrderProgress.get()">Show</a>
                <a href="javascript:void(0)" class="easyui-linkbutton c6" style="height:25px;border-radius:1px" iconCls="icon-remove" plain="true" id="delete" onClick="MsSubconAopOrderProgress.resetForm('subconaoporderprogressFrm')" >Reset</a>
            </div>
      </form>
    </div>
</div>
<script type="text/javascript" src="<?php echo url('/');?>/js/report/Subcontract/AOP/MsSubconAopOrderProgressController.js"></script>
<script>
    (function(){
      ...
      $('#subconaoporderprogressFrm [id="buyer_id"]').combobox();
      $('#subconaoporderprogressFrm [id="teammember_id"]').combobox();
