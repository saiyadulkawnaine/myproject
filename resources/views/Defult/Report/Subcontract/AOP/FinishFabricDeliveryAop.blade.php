<div class="easyui-layout animated rollIn"  data-options="fit:true">
    <div data-options="region:'center',border:true" style="padding:2px;width:100%;height:100%;">
        <table id="finishfabricdeliveryaopTbl" style="width:100%">
            <thead>
                <tr>
                    ...
                    <th align="center" width="50">14</th>
                    <th align="center" width="80">15</th>
                    <th align="center" width="50">16</th>
                    <th align="center" width="70">17</th>
                    <th align="center" width="70">18</th>
                    <th align="center" width="40">19</th>
                    <th align="center" width="70">20</th>
                    <th align="center" width="80">21</th>
                    <th align="center" width="80">22</th>
                    <th align="center"  width="60">23</th>
                    <th align="center" width="40">24</th>
                    <th align="center" width="100">25</th>
                ...
                <tr>
                    ...
                    <th data-options="field:'aop_sales_order_no'" width="80">AOP<br>Sales Order</th>
    ...
    <div data-options="region:'west',border:true,title:'Aop Finish Fabric Delivery and Invoice',footer:'#ft2'" style="width:350px; padding:2px">
        <form id="finishfabricdeliveryaopFrm">
            <div id="container">
                <div id="body">
                    <code>
            ...
            <div id="ft2" style="padding:0px 0px; text-align:right; background:#F3F3F3;" >
                <a href="javascript:void(0)" class="easyui-linkbutton  c1" style="height:25px; border-radius:1px" plain="true" id="save" onClick="MsFinishFabricDeliveryAop.getSelf()">Self Order</a>
                <a href="javascript:void(0)" class="easyui-linkbutton  c1" style="height:25px; border-radius:1px" plain="true" id="save" onClick="MsFinishFabricDeliveryAop.getSubcontract()">Subcontract</a>
                <a href="javascript:void(0)" class="easyui-linkbutton c6" style="height:25px;border-radius:1px" iconCls="icon-remove" plain="true" id="delete" onClick="MsFinishFabricDeliveryAop.resetForm('finishfabricdeliveryaopFrm')">Reset</a> 
            </div>
        </form>
    </div>
</div>
...
<div id="subcontractWindow" class="easyui-window" title=" Date Wise Issue Report" data-options="modal:true,closed:true,iconCls:'icon-save'" style="width:100%;height:600px;">
    <div id="containerWindow" style="width:100%;height:100%;padding:0px;">
        <table id="subcontractfinishfabricdeliveryaopTbl" style="width:100%;height:100%">
            <thead>
                <tr>
                    <th align="center" width="60">1</th>
                    ...
                    <th align="center" width="150">22</th>
                </tr>
                <tr>
                    <th data-options="field:'company_code'" width="60">Company</th>
...
<script type="text/javascript" src="<?php echo url('/');?>/js/report/Subcontract/AOP/MsFinishFabricDeliveryAopController.js"></script>
<script>
    (function(){
       ...
       $('#finishfabricdeliveryaopFrm [id="buyer_id"]').combobox();
    })(jQuery);
</script>
