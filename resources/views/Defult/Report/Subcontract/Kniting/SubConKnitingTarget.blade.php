<div class="easyui-layout animated rollIn"  data-options="fit:true" id="subconknitingtargetpanel">
    <div data-options="region:'center',border:true,title:'AOP Party Wise Fabric Stock Report'" style="padding:2px">
        
        
                <table id="subconknitingtargetTbl" style="width:1890px">
                    <thead>
                        <tr>
                            
                            <th data-options="field:'buyer_name'" width="180" formatter="MsSubconKnitingTarget.formatContact">Customer</th>
                            ...
                            <th data-options="field:'receive_qty'" width="80" align="right">Yarn Received</th>
    ...
    <div data-options="region:'west',border:true,title:'Search',footer:'#subconknitingtargetFrmFt'" style="width:350px; padding:2px">
        <form id="subconknitingtargetFrm">
            <div id="container">
                <div id="body">
                <code>
            ...
            <div id="subconknitingtargetFrmFt" style="padding:0px 0px; text-align:right; background:#F3F3F3;" >
                <a href="javascript:void(0)" class="easyui-linkbutton  c1" style="height:25px; border-radius:1px" iconCls="icon-save" plain="true" id="save" onClick="MsSubconKnitingTarget.get()">Show</a>
                <a href="javascript:void(0)" class="easyui-linkbutton c6" style="height:25px;border-radius:1px" iconCls="icon-remove" plain="true" id="delete" onClick="MsSubconKnitingTarget.resetForm('subconknitingtargetFrm')" >Reset</a>
            </div>
      </form>
    </div>
</div>
<div id="subconknitingtargetWindow" class="easyui-window" title="Buyer Contact" data-options="modal:true,closed:true,iconCls:'icon-save'" style="width:100%;height:500px;padding:2px;">
    <div class="easyui-layout"  data-options="fit:true">
    <div data-options="region:'center'">
        <table id="subconknitingtargetcontactTbl">
            <thead>
                <tr>
...
<script type="text/javascript" src="<?php echo url('/');?>/js/report/Subcontract/Kniting/MsSubconKnitingTargetController.js"></script>
<script>
