<div class="easyui-layout animated rollIn"  data-options="fit:true" id="yystck">
    <div data-options="region:'center',border:true,title:'General Stock Report'" style="padding:2px">
        
        
                <table id="generalstockTbl" style="width:1890px">
                    <thead>
                        <tr>
    ...
    <div data-options="region:'west',border:true,title:'Search',footer:'#ft2'" style="width:350px; padding:2px">
        <form id="generalstockFrm">
            <div id="container">
                ...
                <code>
                    ...
                    <div class="row middle">
                        ...
                        <div class="col-sm-8">
                        {!! Form::select('item_category_id', $itemcategory,'',array('id'=>'item_category_id','style'=>'border:2px;width:100%')) !!}                        
                        </div>
                    </div>
                    <div class="row middle">
            ...
            <div id="ft2" style="padding:0px 0px; text-align:right; background:#F3F3F3;" >
                <a href="javascript:void(0)" class="easyui-linkbutton  c1" style="height:25px; border-radius:1px" iconCls="icon-save" plain="true" id="save" onClick="MsGeneralStock.get()">Show</a>
                <a href="javascript:void(0)" class="easyui-linkbutton c6" style="height:25px;border-radius:1px" iconCls="icon-remove" plain="true" id="delete" onClick="MsGeneralStock.resetForm('generalstockFrm')" >Reset</a>
            </div>
      </form>
    </div>
</div>
...
<script type="text/javascript" src="<?php echo url('/');?>/js/report/Inventory/MsGeneralStockController.js"></script>
<script>
    ...
    $('#generalstockFrm [id="item_category_id"]').combobox();
</script>