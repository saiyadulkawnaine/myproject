<div class="easyui-layout animated rollIn"  data-options="fit:true" id="dyechempurchaselcwisePanel">
    <div data-options="region:'center',border:true,title:'LC Wise Yarn Purchase  Report'" style="padding:2px">
                <table id="dyechempurchaselcwiseTbl" style="width:1890px">
                    <thead>
                        <tr>
                            <th width="60">1</th>
                            <th width="120">2</th>
                        ...
                        <tr>
                            ...
                            <th data-options="field:'lc_qty',halign:'center'" width="100" align="right" formatter="MsDyeChemPurchaseLcWise.formatLcQty">LC Qty</th>
                            ...
                            <th data-options="field:'qty',halign:'center'" width="80" align="right" formatter="MsDyeChemPurchaseLcWise.formatRcvQty">Receive Qty</th>
    ...
    <div data-options="region:'west',border:true,title:'Search',footer:'#ft2'" style="width:350px; padding:2px">
        <form id="dyechempurchaselcwiseFrm">
            <div id="container">
                <div id="body">
                <code>
            ...
            <div id="ft2" style="padding:0px 0px; text-align:right; background:#F3F3F3;" >
                <a href="javascript:void(0)" class="easyui-linkbutton  c1" style="height:25px; border-radius:1px" iconCls="icon-save" plain="true" id="save" onClick="MsDyeChemPurchaseLcWise.get()">Show</a>
                <a href="javascript:void(0)" class="easyui-linkbutton c6" style="height:25px;border-radius:1px" iconCls="icon-remove" plain="true" id="delete" onClick="MsDyeChemPurchaseLcWise.resetForm('dyechempurchaselcwiseFrm')" >Reset</a>
            </div>
      </form>
    </div>
</div>

<div id="lcwisedyechempurlcqtydtlWindow" class="easyui-window" title="Lc Qty Details" data-options="modal:true,closed:true,iconCls:'icon-save'" style="width:100%;height:100%;padding:2px;">
    <table id="lcwisedyechempurlcqtydtlTbl" style="width:900px">
        <thead>
            <tr>
                ...
                <th data-options="field:'specification',halign:'center'" width="70">Specification</th>
...
<div id="lcwisedyechempurrcvqtydtlWindow" class="easyui-window" title="Receive Qty Details" data-options="modal:true,closed:true,iconCls:'icon-save'" style="width:100%;height:100%;padding:2px;">
    <table id="lcwisedyechempurrcvqtydtlTbl" style="width:900px">
        <thead>
            <tr>
            <th data-options="field:'receive_no'" width="80px">MRR</th>
            <th data-options="field:'receive_date'" width="80px">Receive Date</th>
            <th data-options="field:'itemcategory_name',halign:'center'" width="100" >Category</th>
            <th data-options="field:'itemclass_name',halign:'center'" align="left" width="100">Item Class</th>
            <th data-options="field:'sub_class_name',halign:'center'" align="left" width="80">Sub Class</th>
            <th data-options="field:'item_desc',halign:'center'" width="250">Item Description</th>
            <th data-options="field:'specification',halign:'center'" width="70">Specification</th>
            <th data-options="field:'qty'" width="70px" align="right">Qty</th>
            <th data-options="field:'rate'" width="60px" align="right">Rate</th>
...
<script type="text/javascript" src="<?php echo url('/');?>/js/report/Inventory/MsDyeChemPurchaseLcWiseController.js"></script>
<script>
