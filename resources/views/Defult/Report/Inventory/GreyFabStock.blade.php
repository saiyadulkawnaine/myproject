<div class="easyui-layout animated rollIn"  data-options="fit:true" id="greyfabstck">
    <div data-options="region:'center',border:true,title:'Grey Fabric Stock Report'" style="padding:2px">
        
        
                <table id="greyfabstockTbl" style="width:1890px">
                    <thead>
                        <tr>
    ...
    <div data-options="region:'west',border:true,title:'Search',footer:'#ft2'" style="width:350px; padding:2px">
        <form id="greyfabstockFrm">
            ...
            <div id="ft2" style="padding:0px 0px; text-align:right; background:#F3F3F3;" >
                <a href="javascript:void(0)" class="easyui-linkbutton  c1" style="height:25px; border-radius:1px" iconCls="icon-save" plain="true" id="save" onClick="MsGreyFabStock.get()">Show</a>
                <a href="javascript:void(0)" class="easyui-linkbutton c6" style="height:25px;border-radius:1px" iconCls="icon-remove" plain="true" id="delete" onClick="MsGreyFabStock.resetForm('greyfabstockFrm')" >Reset</a>
            </div>
      </form>
    </div>
</div>
...
<script type="text/javascript" src="<?php echo url('/');?>/js/report/Inventory/MsGreyFabStockController.js"></script>
<script>
