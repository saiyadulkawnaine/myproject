<div class="easyui-layout animated rollIn"  data-options="fit:true" id="kpwystck">
    <div data-options="region:'center',border:true,title:'Kniting Party Wise Yarn Stock Report'" style="padding:2px">
                ...
                <table id="yarnstockknitingpartyTbl" style="width:1890px">
                    <thead>
                        <tr>
                            ...
                            <th data-options="field:'issue_qty',halign:'center'" width="80" align="right" formatter="MsYarnStockKnitingParty.formatIssued">Issued</th>
                            <th data-options="field:'total_issue_qty',halign:'center'" width="80" align="right">Total issued</th>
                            <th data-options="field:'used_qty',halign:'center'" width="80" align="right" formatter="MsYarnStockKnitingParty.formatUsed">Yarn Used</th>
                            <th data-options="field:'return_qty',halign:'center'" width="80" align="right" formatter="MsYarnStockKnitingParty.formatReturn">Yarn Returned</th>
    ...
    <div data-options="region:'west',border:true,title:'Search',footer:'#yarnstockknitingpartyFrmFt'" style="width:350px; padding:2px">
        <form id="yarnstockknitingpartyFrm">
            <div id="container">
                <div id="body">
                <code>
            ...
            <div id="yarnstockknitingpartyFrmFt" style="padding:0px 0px; text-align:right; background:#F3F3F3;" >
                <a href="javascript:void(0)" class="easyui-linkbutton  c1" style="height:25px; border-radius:1px" iconCls="icon-save" plain="true" id="save" onClick="MsYarnStockKnitingParty.get()">Show</a>
                <a href="javascript:void(0)" class="easyui-linkbutton c6" style="height:25px;border-radius:1px" iconCls="icon-remove" plain="true" id="delete" onClick="MsYarnStockKnitingParty.resetForm('yarnstockknitingpartyFrm')" >Reset</a>
            </div>
      </form>
    </div>
</div>
...
<div id="yarnstockknitingpartyissuedWindow" class="easyui-window" title="Issued" data-options="modal:true,closed:true,iconCls:'icon-save'" style="width:100%;height:500px;padding:2px;">
    <div class="easyui-layout"  data-options="fit:true">
    <div data-options="region:'center'">
        <table id="yarnstockknitingpartyissuedTbl">
            <thead>
                <tr>
...
<div id="yarnstockknitingpartyreturnWindow" class="easyui-window" title="Return" data-options="modal:true,closed:true,iconCls:'icon-save'" style="width:100%;height:500px;padding:2px;">
    <div class="easyui-layout"  data-options="fit:true">
    <div data-options="region:'center'">
        <table id="yarnstockknitingpartyreturnTbl">
            <thead>
                <tr>
...
<div id="yarnstockknitingpartyusedWindow" class="easyui-window" title="Used" data-options="modal:true,closed:true,iconCls:'icon-save'" style="width:100%;height:500px;padding:2px;">
    <div class="easyui-layout"  data-options="fit:true">
    <div data-options="region:'center'">
        <table id="yarnstockknitingpartyusedTbl">
            <thead>
                <tr>
...
<script type="text/javascript" src="<?php echo url('/');?>/js/report/Inventory/MsYarnStockKnitingPartyController.js"></script>
<script>
