<div class="easyui-layout"  data-options="fit:true" id="centraldyeingplanlayout">
    <div data-options="region:'center',border:true,title:'Ship Date Wise Central Dyeing Plan'" style="padding:2px">
        <table id="centraldyeingplanTbl" style="width:100%">
            <thead>    
                <tr>
                    ...
                    <th data-options="field:'flie_src',halign:'center',align:'center'" formatter="MsCentralDyeingPlan.formatimage" width="30">Image</th>
                    ...
                    <th data-options="field:'dyeing_days',halign:'center'" width="100" align="right">Dyeing Days</th>
                    <th data-options="field:'no_of_line',halign:'center'" width="100" align="right">No Of Machine (Tips)</th>
    ...
    <div data-options="region:'west',border:true,title:'Search',footer:'#ft2'" style="width:350px; padding:2px">
        ...
        <div id="ft2" style="padding:0px 0px; text-align:right; background:#F3F3F3;" >
            <a href="javascript:void(0)" class="easyui-linkbutton  c1" style="height:25px; border-radius:1px" plain="true" id="save" onClick="MsCentralDyeingPlan.get()">Show</a>
            <a href="javascript:void(0)" class="easyui-linkbutton c6" style="height:25px;border-radius:1px" iconCls="icon-remove" plain="true" id="delete" onClick="MsCentralDyeingPlan.resetForm('centraldyeingplanFrm')" >Reset</a>
        </div>

      </form>
    </div>
</div>
<div id="centraldyeingplanImageWindow" class="easyui-window" title="Image" data-options="modal:true,closed:true,iconCls:'icon-save'" style="width:500px;height:500px;padding:2px;">
    <img id="centraldyeingplanImageWindowoutput" src=""/>
</div>


<script type="text/javascript" src="<?php echo url('/');?>/js/report/MsCentralDyeingPlanController.js"></script>
<script>
