<table>
    <tr>
    <td colspan="10" align="center"><strong>Import Lc Reference Ledger ( {{ date("d-M-Y",strtotime($start_date))}} To {{ date("d-M-Y",strtotime($end_date))}} )</strong></td>
    </tr>
    </table>
    <br/>
    <table  border="1">
        <thead>
            <tr>
                ...
                <th align="center" width="70" class="text-center">Import LC Reference</th>
        ...
        <tr>
            ...
            <td width="70" align="center">{{ $row->import_lc_ref_no}}</td>
