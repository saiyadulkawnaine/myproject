...
<th width="100" class="text-center">% on Total</th>
...
<td width="150" align="right" colspan="2">Grand Total</td>
@foreach($comp2 as $key=>$company_code)
<td width="100" align="right">{{number_format($comTot2['amount'][$key],0)}}</td>
@endforeach
<td width="150" align="right">{{number_format(array_sum($comTot2['amount']),0)}}</td>
