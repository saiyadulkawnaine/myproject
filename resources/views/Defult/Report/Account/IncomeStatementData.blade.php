...
<table  border="0" style="margin: 0 auto;">
     <caption style="text-align: center;"><img src="{{url('/').'/images/logo/'.$company->logo}}" width="300" height="70" /><br/>{{$company->address}} <br/><font style="font-size: 12px; font-weight: bold;">Income  Statement for ( {{ $currentPeriod }} )<br>{{ $captionAccYear }} <br>{{ $profit_center_name }}</font></caption>
        <thead>
        ...
        <tr><td colspan="4"><strong>A. {{ $accchartgroup[16] }}</strong></td></tr>
        <?php
        $lastTotal16=0;
        $currentTotal16=0;
        $yearTotal16=0;
        ...
        <tr><td colspan="4"><strong>B. {{ $accchartgroup[19] }}</strong></td></tr>
        <?php
        ...
        <tr><td colspan="4"><strong>D. {{ $accchartgroup[22] }}</strong></td></tr>
        <?php
        $currentTotal22=0;
         $lastTotal22=0;
        $yearTotal22=0;
        ...
        <tr><td colspan="4"><strong>F. {{ $accchartgroup[24] }}</strong></td></tr>
        <?php
        $currentTotal24=0;
        $lastTotal24=0;
        $yearTotal24=0;
        ...
        <tr><td colspan="4"><strong>G. {{ $accchartgroup[25] }}</strong></td></tr>
        <?php
        $currentTotal25=0;
        $lastTotal25=0;
        $yearTotal25=0;
        ...
        <tr><td colspan="4"><strong>I. {{ $accchartgroup[28] }}</strong></td></tr>
        <?php
        $currentTotal28=0;
        $lastTotal28=0;
        $yearTotal28=0;
        ...
        <tr><td colspan="4"><strong>J. {{ $accchartgroup[50] }}</strong></td></tr>
        <?php
        $currentTotal50=0;
        $lastTotal50=0;
        $yearTotal50=0;
        ...
        <tr><td colspan="4"><strong>L. {{ $accchartgroup[55] }}</strong></td></tr>
        <?php
        $currentTotal55=0;
        $lastTotal55=0;
        $yearTotal55=0;
