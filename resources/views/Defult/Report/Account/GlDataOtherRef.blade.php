<table  border="1" style="margin: 0 auto;">
    <caption style="text-align: center;"><img src="{{url('/').'/images/logo/'.$company->logo}}" width="300" height="70" /><br/>{{$company->address}} <br/><font style="font-size: 12px; font-weight: bold;">Other Reference Ledger ( {{ date("d-M-Y",strtotime($start_date))}} To {{ date("d-M-Y",strtotime($end_date))}} )</font></caption>
        <thead>
            <tr>
                ...
                <th width="80" class="text-center">Other Reference</th>
   ...
   @if(count($data)>0)     
           ...
           <tr>
               <td colspan="9"><strong>{{ $supkey }}</strong></td>
               <td></td>
           </tr>
   @foreach($supvalue as $key=>$value)  
       ...
       ?>
           ...
           <tr>
               ...
               <td width="50" align="center"><a href="javascript:void(0)" onClick="MsGlOtherRef.showJournal({{ $row->id}})">{{ $row->trans_no}}</a></td>
               <td width="90" align="center">{{ $row->trans_date}}</td>
               <td width="50" align="center"></td>
               <td width="80" align="center"></td>
               <td width="80" align="center">{{ $row->other_ref_name}}</td>
           ...
           <tr>
                ...
                <td width="80" align="right"><strong>{{ number_format($total_debit,2,'.',',')}}</strong></td>
   ...
   @elseif (count($data) <= 0)
       ...
       <?php
        ...
        ?>
        <tr>
            <td colspan="9"><strong>{{$value[0]->acc_ctrl_head_name}} </strong></td>
        </tr>
        <tr> 
