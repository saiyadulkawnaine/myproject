<table>
<tr>
<td colspan="10" align="center"><strong>Loan Reference Ledger ( {{ date("d-M-Y",strtotime($start_date))}} To {{ date("d-M-Y",strtotime($end_date))}} )</strong></td>
</tr>
</table>
<br/>
<table  border="1">
        ...
        <th align="center" width="70" class="text-center">Loan Reference</th>
...
@foreach($supvalue as $key=>$value)
        ...
        <td width="70" align="center">{{ $row->loan_ref_name}}</td>
