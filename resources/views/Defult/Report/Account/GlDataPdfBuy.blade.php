<table>
<tr>
<td colspan="10" align="center"><strong>Buyer Ledger ( {{ date("d-M-Y",strtotime($start_date))}} To {{ date("d-M-Y",strtotime($end_date))}} )</strong></td>
</tr>
</table>
<br/>
<table  border="1">
        ...
        <th align="center" width="70" class="text-center">Buyer</th>
