...
<tbody>
    ...
    <tr align="right">
        ...
        <td width="80" rowspan="3" align="center"><a href="javascript:void(0)" onClick="MsBudgetAndCostingComparison.teamleaderWindow({{ $row->teamleader_id }})">{{$row->team_name}}</a></td>
        <td width="100" rowspan="3" align="center"><a href="javascript:void(0)" onClick="MsBudgetAndCostingComparison.dlmerchantWindow({{ $row->user_id }})">{{$row->team_member_name}}</a></td>
        <td width="100" rowspan="3" align="left">{{$row->delivery_date}}</td>
        
        <td width="60" rowspan="3" align="left">{{$row->buyer_name}}</td>
        <td width="60" rowspan="3" align="left"><a href="javascript:void(0)" onClick="MsBudgetAndCostingComparison.buyingAgentWindow({{ $row->buying_agent_id }})">{{ $row->buying_agent_name }}</a></td>
        <td width="80" rowspan="3" align="left"><a href="javascript:void(0)" onClick="MsBudgetAndCostingComparison.bacfileWindow({{ $row->style_id }})">{{ $row->style_ref }}</a></td>
   ...
   <tr align="right">
        ...
        <td width="80"><a href="javascript:void(0)" onClick="MsBudgetAndCostingComparison.detailsConsDznWindow({{$row->id}})">{{number_format($row->fin_fab_cons,2)}}</a></td>
        <td width="80"><a href="javascript:void(0)" onClick="MsBudgetAndCostingComparison.detailsFabPurWindow({{$row->id}})">{{number_format($row->fab_pur_amount,2)}}</a></td>
        <td width="80"><a href="javascript:void(0)" onClick="MsBudgetAndCostingComparison.detailsYarnWindow({{$row->id}})">{{number_format($row->yarn_amount,2)}}</a></td>
        <td width="80"><a href="javascript:void(0)" onClick="MsBudgetAndCostingComparison.detailsTrimWindow({{$row->id}})">{{number_format($row->trim_amount,2)}}</a></td>
        <td width="80"><a href="javascript:void(0)" onClick="MsBudgetAndCostingComparison.detailsYarnDyeingWindow({{$row->id}})">{{number_format($row->yarn_dying_amount,2)}}</a></td>
        <td width="80"><a href="javascript:void(0)" onClick="MsBudgetAndCostingComparison.detailsKnitWindow({{$row->id}})">{{number_format($row->kniting_amount,2)}}</a></td>
        <!-- <td  width="80">Weaving</td> -->
        <td width="80"><a href="javascript:void(0)" onClick="MsBudgetAndCostingComparison.detailsDyeingWindow({{$row->id}})">{{number_format($row->dying_amount,2)}}</a></td>
        <td width="80"><a href="javascript:void(0)" onClick="MsBudgetAndCostingComparison.detailsAopWindow({{$row->id}})">{{number_format($row->aop_amount,2)}}</a></td>
        <td width="80"><a href="javascript:void(0)" onClick="MsBudgetAndCostingComparison.detailsBocWindow({{$row->id}})">{{number_format($row->burn_out_amount,2)}}</a></td>
        <!-- <td  width="80" align="right">Finishing</td> -->
        <td width="80"><a href="javascript:void(0)" onClick="MsBudgetAndCostingComparison.detailsFwcWindow({{$row->id}})">{{number_format($row->washing_amount,2)}}</a></td>
        <td width="80"><a href="javascript:void(0)" onClick="MsBudgetAndCostingComparison.detailsGpcWindow({{$row->id}})">{{number_format($row->printing_amount,2)}}</a></td>
        <td width="80"><a href="javascript:void(0)" onClick="MsBudgetAndCostingComparison.detailsGecWindow({{$row->id}})">{{number_format($row->emb_amount,2)}}</a></td>
        <td width="80"><a href="javascript:void(0)" onClick="MsBudgetAndCostingComparison.detailsGsecWindow({{$row->id}})">{{number_format($row->spemb_amount,2)}}</a></td>
        <td width="80"><a href="javascript:void(0)" onClick="MsBudgetAndCostingComparison.detailsGdcWindow({{$row->id}})">{{number_format($row->gmt_dyeing_amount,2)}}</a></td>
        <td width="80"><a href="javascript:void(0)" onClick="MsBudgetAndCostingComparison.detailsGwcWindow({{$row->id}})">{{number_format($row->gmt_washing_amount,2)}}</a></td>
        <td width="80"><a href="javascript:void(0)" onClick="MsBudgetAndCostingComparison.detailsOthWindow({{$row->id}})">{{number_format($row->courier_amount,2)}}</a></td>
        <td width="80"><a href="javascript:void(0)" onClick="MsBudgetAndCostingComparison.detailsWindow({{$row->id}})">{{number_format($row->freight_amount,2)}}</a></td>
        <td width="80"><a href="javascript:void(0)" onClick="MsBudgetAndCostingComparison.detailsWindow({{$row->id}})">{{number_format($row->cm_amount,2)}}</a></td>
        <td width="80"><a href="javascript:void(0)" onClick="MsBudgetAndCostingComparison.detailsWindow({{$row->id}})">{{number_format($row->commi_amount,2)}}</a></td>
        <td width="80"><a href="javascript:void(0)" onClick="MsBudgetAndCostingComparison.detailsWindow('+row.id+')">{{number_format($row->commer_amount,2)}}</a></td>
