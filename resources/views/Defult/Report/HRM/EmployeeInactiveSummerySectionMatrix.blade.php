...
<table border="1" cellpadding="3" cellspacing="2" style="margin: 0 auto">
  ...
  <tr>
    ...
    ?>
    @endforeach
    <td width="70" class="text-center"><a href="javascript:void(0)" onClick="MsEmployeeInactiveSummery.sectionEmployeeDetailWindow({{$section_id}})"><strong>{{ $sectionwiseTotal }}</strong></a></td>
  </tr>
