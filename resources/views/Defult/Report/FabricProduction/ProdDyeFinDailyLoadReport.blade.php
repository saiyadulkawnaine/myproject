<div class="easyui-layout animated rollIn"  data-options="fit:true">
    <div data-options="region:'center',border:true,title:'Daily Dyeing/Finishing M/C Wise Production'" style="padding:2px">
        <table id="proddyefindailyloadreportTbl" style="width:100%">
            <thead>
                <tr>
    ...
    <div data-options="region:'west',border:true,title:'Search',footer:'#ft2'" style="width:320px; padding:2px">
        <form id="proddyefindailyloadreportFrm">
            <div id="container">
                <div id="body">
                    <code>
            ...
            <div id="ft2" style="padding:0px 0px; text-align:right; background:#F3F3F3;" >
                <a href="javascript:void(0)" class="easyui-linkbutton  c1" style="height:25px; border-radius:1px" iconCls="icon-save" plain="true" id="save" onClick="MsProdDyeFinDailyLoadReport.get()">Show</a>
                <a href="javascript:void(0)" class="easyui-linkbutton c6" style="height:25px;border-radius:1px" iconCls="icon-remove" plain="true" id="delete" onClick="MsProdDyeFinDailyLoadReport.resetForm('proddyefindailyloadreportFrm')" >Reset</a>
            </div>
        </form>
    </div>
</div>
    
<script type="text/javascript" src="<?php echo url('/');?>/js/report/FabricProduction/MsProdDyeFinDailyLoadReportController.js"></script>
<script>
    ...
    $('#proddyefindailyloadreportFrm [id="production_process_id"]').combobox();
</script>