<div class="easyui-tabs" style="width:100%;height:100%; border:none" id="poknitserviceshortapprovaltabs">
 <div title="Waiting For Approval" style="padding:2px">
  <div class="easyui-layout" data-options="fit:true">
   <div data-options="region:'center',border:true,title:'List'" style="padding:2px">
    <table id="poknitserviceshortapprovalTbl" style="width:100%">
     <thead>
      <tr>
       <th data-options="field:'app'" width="60" formatter='MsPoKnitServiceShortApproval.approveButton'>
       </th>
       <th data-options="field:'id'" width="80">ID</th>
       <th data-options="field:'po_no'" formatter='MsPoKnitServiceShortApproval.formatsummery' width="80">WO No</th>
       <th data-options="field:'po_date'" width="80">WO Date</th>
       <th data-options="field:'po_type',styler:MsPoKnitServiceShortApproval.formatpotype" width="80">PO
        Type</th>
       ...
       <th data-options="field:'pdf'" width="60" formatter='MsPoKnitServiceShortApproval.formatPdf'>PDF
       </th>
      </tr>
     </thead>
    </table>
   ...
   <div
    data-options="region:'west',border:true,title:'Sreach',iconCls:'icon-more',hideCollapsedContent:false,collapsed:false,footer:'#poknitserviceshortapprovalFrmFt'"
    style="width:350px; padding:2px">
    <div id="container">
     <div id="body">
      <code>
                            <form id="poknitserviceshortapprovalFrm">
    ...
    <div id="poknitserviceshortapprovalFrmFt" style="padding:0px 0px; text-align:right; background:#CCC;">
     <a href="javascript:void(0)" class="easyui-linkbutton c1" style="height:25px; border-radius:1px"
      iconCls="icon-save" plain="true" id="save" onClick="MsPoKnitServiceShortApproval.get()">Search</a>
     <a href="javascript:void(0)" class="easyui-linkbutton c6" style="height:25px;border-radius:1px"
      iconCls="icon-remove" plain="true" id="delete"
      onClick="msApp.resetForm('poknitserviceshortapprovalFrm')">Reset</a>
 ...
 <div title="Approved List" style="padding:2px">
  <div class="easyui-layout" data-options="fit:true">
   <div data-options="region:'center',border:true,title:'List'" style="padding:2px">
    <table id="poknitserviceshortapprovedTbl" style="width:100%">
     <thead>
      <tr>
       <th data-options="field:'app'" width="80" formatter='MsPoKnitServiceShortApproval.unapproveButton'></th>
       <th data-options="field:'id'" width="80">ID</th>
   ...
   <div
    data-options="region:'west',border:true,title:'Sreach',iconCls:'icon-more',hideCollapsedContent:false,collapsed:false,footer:'#poknitserviceshortapprovedFrmFt'"
    style="width:350px; padding:2px">
    <div id="container">
     <div id="body">
      <code>
                            <form id="poknitserviceshortapprovedFrm">
                                <div class="row middle">
                                    <div class="col-sm-4">Company</div>
                                    <div class="col-sm-8">
                                        {!! Form::select('company_id', $company,'',array('id'=>'company_id')) !!}
    ...
    <div id="poknitserviceshortapprovedFrmFt" style="padding:0px 0px; text-align:right; background:#CCC;">
     <a href="javascript:void(0)" class="easyui-linkbutton c1" style="height:25px; border-radius:1px"
      iconCls="icon-save" plain="true" id="save" onClick="MsPoKnitServiceShortApproval.getApp()">Search</a>
     <a href="javascript:void(0)" class="easyui-linkbutton c6" style="height:25px;border-radius:1px"
      iconCls="icon-remove" plain="true" id="delete"
      onClick="msApp.resetForm('poknitserviceshortapprovedFrm')">Reset</a>
    </div>
   </div>
  </div>
 </div>
...
<script type="text/javascript" src="<?php echo url('/');?>/js/approval/MsPoKnitServiceShortApprovalController.js">
</script>
<script>
 $(".datepicker" ).datepicker({
  ...
  $('#poknitserviceshortapprovalFrm [id="supplier_id"]').combobox();
  $('#poknitserviceshortapprovedFrm [id="supplier_id"]').combobox();
