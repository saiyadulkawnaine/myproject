<div class="easyui-tabs" style="width:100%;height:100%; border:none" id="poembserviceapprovaltabs">
 <div title="Waiting For Approval" style="padding:2px">
  <div class="easyui-layout" data-options="fit:true">
   <div data-options="region:'center',border:true,title:'List'" style="padding:2px">
    <table id="poembserviceapprovalTbl">
     <thead>
      <tr>
       <th data-options="field:'app'" width="60" formatter='MsPoEmbServiceApproval.approveButton'></th>
       <th data-options="field:'id'" width="50">ID</th>
       <th data-options="field:'po_no'" formatter='MsPoEmbServiceApproval.formatsummery' width="100">PO No</th>
       ...
       <th data-options="field:'pdf'" formatter='MsPoEmbServiceApproval.formatPdf' width="60">PDF</th>
      </tr>
     </thead>
    </table>
   </div>
   <div
    data-options="region:'west',border:true,title:'Sreach',iconCls:'icon-more',hideCollapsedContent:false,collapsed:false,footer:'#poembserviceapprovalFrmFt'"
    style="width:350px; padding:2px">
    <div id="container">
     <div id="body">
      <code>
        <form id="poembserviceapprovalFrm">
    ...
    <div id="poembserviceapprovalFrmFt" style="padding:0px 0px; text-align:right; background:#CCC;">
     <a href="javascript:void(0)" class="easyui-linkbutton c1" style="height:25px; border-radius:1px"
      iconCls="icon-save" plain="true" id="save" onClick="MsPoEmbServiceApproval.get()">Search</a>
     <a href="javascript:void(0)" class="easyui-linkbutton c6" style="height:25px;border-radius:1px"
      iconCls="icon-remove" plain="true" id="delete" onClick="msApp.resetForm('poembserviceapprovalFrm')">Reset</a>
 ...
 <div title="Approved List" style="padding:2px">
  <div class="easyui-layout" data-options="fit:true">
   <div data-options="region:'center',border:true,title:'List'" style="padding:2px">
    <table id="poembserviceapprovedTbl">
     <thead>
      <tr>
       <th data-options="field:'unapp'" width="80" formatter='MsPoEmbServiceApproval.unapproveButton'></th>
       <th data-options="field:'id'" width="50">ID</th>
       <th data-options="field:'po_no'" formatter='MsPoEmbServiceApproval.formatsummery' width="100">PO No</th>
       <th data-options="field:'po_date'" width="80">WO Date</th>
       <th data-options="field:'company_code'" align="center" width="60">Producing<br />Company</th>
   ...
   <div
    data-options="region:'west',border:true,title:'Sreach',iconCls:'icon-more',hideCollapsedContent:false,collapsed:false,footer:'#poembserviceapprovedFrmFt'"
    style="width:350px; padding:2px">
    <div id="container">
     <div id="body">
      <code>
       <form id="poembserviceapprovedFrm">
         <div class="row middle">
          <div class="col-sm-4">Company</div>
          <div class="col-sm-8">
           {!! Form::select('company_id', $company,'',array('id'=>'company_id')) !!}
    ...
    <div id="poembserviceapprovedFrmFt" style="padding:0px 0px; text-align:right; background:#CCC;">
     <a href="javascript:void(0)" class="easyui-linkbutton c1" style="height:25px; border-radius:1px"
      iconCls="icon-save" plain="true" id="save" onClick="MsPoEmbServiceApproval.getApp()">Search</a>
     <a href="javascript:void(0)" class="easyui-linkbutton c6" style="height:25px;border-radius:1px"
      iconCls="icon-remove" plain="true" id="delete" onClick="msApp.resetForm('poembserviceapprovedFrm')">Reset</a>
    </div>
   </div>
  </div>
 </div>
...
<script type="text/javascript" src="<?php echo url('/');?>/js/approval/MsPoEmbServiceApprovalController.js">
</script>
<script>
 $(".datepicker" ).datepicker({
  ...
  $('#poembserviceapprovalFrm [id="supplier_id"]').combobox();
  $('#poembserviceapprovedFrm [id="supplier_id"]').combobox();
