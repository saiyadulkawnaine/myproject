...
<table align="center" cellpadding="2" cellspacing="2">
 <tr>
  <td width="655px" style="font-size: 15px"><strong>Work Order No : </strong>{{ $data['master']->po_no }}</td>
  <td width="655px"></td>
 </tr>
 <tr>
...
<table align="center" border="1" cellpadding="2" cellspacing="2">
 <tr>
  ...
  <td width="70px" align="center">GMT. Part</td>
  <td width="70px" align="center">GMT. Item</td>
  <td width="70px" align="center">Emb. Name</td>
  <td width="70px" align="center">Emb. Type</td>
  <td width="70px" align="center">Emb. Size</td>
 ...
 <tbody>
  ...
  <tr>
   ...
   <td width="70px" align="center">{{$row->gmtspart_name}}</td>
   <td width="70px" align="center">{{$row->item_description}}</td>
   <td width="70px" align="center">{{$row->embelishment_name}}</td>
   <td width="70px" align="center">{{$row->embelishment_type}}</td>
   <td width="70px" align="center">{{$row->embelishment_size}}</td>
   ...
   <td width="70px" align="right"><a href="javascript:void(0)"
     onClick="MsPoDyeingServiceApproval.podyeingservicedetailWindow('{{$row->style_id}}','{{$row->company_id}}','{{$row->style_embelishment_id}}','{{$row->budget_emb_id}}')">{{ number_format($row->total_po_qty,2) }}</a>
   </td>
 ...
 <tr>
  ...
  <td width="70px" align="right" style="color:black;background-color:#a2e2e6;margin:0 auto">
   <strong>{{ number_format($tBalQty,2) }}</strong>
  </td>
  <td width="40px" align="right"></td>
