<div class="easyui-tabs" style="width:100%;height:100%; border:none" id="poyarndyeingapprovaltabs">
  <div title="Waiting For Approval" style="padding:2px">
    <div class="easyui-layout" data-options="fit:true">
      <div data-options="region:'center',border:true,title:'List'" style="padding:2px">
        <table id="poyarndyeingapprovalTbl">
          <thead>
            <tr>
              <th data-options="field:'app'" width="80" formatter='MsPoYarnDyeingApproval.approveButton'></th>
              <th data-options="field:'id'" width="60">ID</th>
              <th data-options="field:'po_no'" width="80" formatter="MsPoYarnDyeingApproval.formatpoyarndyeingpdf">PO No
              </th>
      ...
      <div
        data-options="region:'west',border:true,title:'Sreach',iconCls:'icon-more',hideCollapsedContent:false,collapsed:false,footer:'#poyarndyeingapprovalFrmFt'"
        style="width:350px; padding:2px">
        <div id="container">
          <div id="body">
            <code>
        <form id="poyarndyeingapprovalFrm">
        ...
        <div id="poyarndyeingapprovalFrmFt" style="padding:0px 0px; text-align:right; background:#CCC;">
          <a href="javascript:void(0)" class="easyui-linkbutton c1" style="height:25px; border-radius:1px"
            iconCls="icon-save" plain="true" id="save" onClick="MsPoYarnDyeingApproval.get()">Search</a>
          <a href="javascript:void(0)" class="easyui-linkbutton c6" style="height:25px;border-radius:1px"
            iconCls="icon-remove" plain="true" id="delete"
            onClick="msApp.resetForm('poyarndyeingapprovalFrm')">Reset</a>
  ...
  <div title="Approved List" style="padding:2px">
    <div class="easyui-layout" data-options="fit:true">
      <div data-options="region:'center',border:true,title:'List'" style="padding:2px">
        <table id="poyarndyeingapprovedTbl">
          <thead>
            <tr>
              <th data-options="field:'unapp'" width="80" formatter='MsPoYarnDyeingApproval.unapproveButton'></th>
              <th data-options="field:'id'" width="60">ID</th>
              <th data-options="field:'po_no'" formatter="MsPoYarnDyeingApproval.formatpoyarndyeingpdf" width="80">PO No
              </th>
              <th data-options="field:'company_code'" width="60" align="center">Beneficiary<br />Company</th>
              <th data-options="field:'supplier_code'" width="160">Supplier</th>
              <th data-options="field:'pi_no'" width="160">PI No</th>
              ...
              <th data-options="field:'rcv_qty'" align="right" width="70"
                formatter='MsPoYarnDyeingApproval.formatRcvNo'>Receive Qty</th>
            </tr>
          </thead>
        </table>
      </div>
      <div
        data-options="region:'west',border:true,title:'Sreach',iconCls:'icon-more',hideCollapsedContent:false,collapsed:false,footer:'#poyarndyeingapprovedFrmFt'"
        style="width:350px; padding:2px">
        <div id="container">
          <div id="body">
            <code>
       <form id="poyarndyeingapprovedFrm">
         <div class="row middle">
          <div class="col-sm-4">Company</div>
          <div class="col-sm-8">
           {!! Form::select('company_id', $company,'',array('id'=>'company_id')) !!}
        ...
        <div id="poyarndyeingapprovedFrmFt" style="padding:0px 0px; text-align:right; background:#CCC;">
          <a href="javascript:void(0)" class="easyui-linkbutton c1" style="height:25px; border-radius:1px"
            iconCls="icon-save" plain="true" id="save" onClick="MsPoYarnDyeingApproval.getApp()">Search</a>
          <a href="javascript:void(0)" class="easyui-linkbutton c6" style="height:25px;border-radius:1px"
            iconCls="icon-remove" plain="true" id="delete"
            onClick="msApp.resetForm('poyarndyeingapprovedFrm')">Reset</a>
        </div>
      </div>
    </div>
  </div>
...
<script type="text/javascript" src="<?php echo url('/');?>/js/approval/MsPoYarnDyeingApprovalController.js">
</script>
<script>
  ...
  $('#poyarndyeingapprovalFrm [id="supplier_id"]').combobox();
  $('#poyarndyeingapprovedFrm [id="supplier_id"]').combobox();
