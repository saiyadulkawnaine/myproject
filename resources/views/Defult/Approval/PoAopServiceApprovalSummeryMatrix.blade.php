...
<table align="center" border="1" cellpadding="2" cellspacing="2">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td width="70px" align="right"><a href="javascript:void(0)" onClick="MsPoAopServiceApproval.poaopservicedetailWindow('{{$row->style_id}}','{{$row->company_id}}','{{$row->style_fabrication_id}}','{{$row->budget_fabric_prod_id}}')">{{ number_format($row->total_po_qty,2) }}</a></td>
