...
<div title="Jobs" style="padding:1px" data-options="selected:true">
  <div class="easyui-layout"  data-options="fit:true">
    <div data-options="region:'center',border:true,title:'List'" style="padding:2px">
      <table id="jobTbl" style="width:100%">
        <thead>
            <tr>
...
@includeFirst(['Sales.SalesOrderCountry', 'Defult.Sales.SalesOrderCountry'])
   ...
   <div id="jobw" class="easyui-window" title="Style Window" data-options="modal:true,closed:true,iconCls:'icon-save'" style="width:1000px;height:500px;padding:2px;">
   <div class="easyui-layout" data-options="fit:true">
			<div data-options="region:'north',split:true, title:'Search'" style="height:130px">
            <div class="easyui-layout" data-options="fit:true">
                    <div id="body">
                        <code>
                            <form id="jobstylesearch">
                                <div class="row">
			...
			<div data-options="region:'center'" style="padding:10px;">
				<table id="jobstyleTbl" style="width:610px">
          <thead>
              <tr>
			...
			<div data-options="region:'south',border:false" style="text-align:right;padding:5px 0 0;">
				<a class="easyui-linkbutton c1" data-options="iconCls:'icon-ok'" href="javascript:void(0)" onclick="$('#jobw').window('close')" style="width:80px">Close</a>
			</div>
		</div>
	</div>
...
<script>
  (function(){
    ...
    $('#jobstylesearch [id="buyer_id"]').combobox();
  })(jQuery);
</script>
