<div class="easyui-layout" data-options="fit:true">
 <div data-options="region:'center',border:true,title:'List',footer:'#statusTblFt'" style="padding:2px;width:600px">
  <table id="salesordershipdatechangeTbl" style="width:100%">
   <thead>
    <tr>
     ...
     <th data-options="field:'old_ship_date'" width="80">Old Ship Date</th>
  ...
  <div id="statusTblFt" style="padding:0px 0px; text-align:right; background:#F3F3F3;">
   ...
   <a href="javascript:void(0)" class="easyui-linkbutton c1" style="height:25px; border-radius:1px"
    iconCls="icon-search" plain="true" id="save" onClick="MsSalesOrderShipDateChange.searchAllShipDateChange()">Show</a>
  </div>
 </div>
 <div data-options="region:'west',border:true,title:'Change Sales Order Shipdate',footer:'#employeehrstatusFrmFT'"
  style="width: 400px; padding:2px">
  <form id="salesordershipdatechangeFrm">
   <div id="container">
    <div id="body">
     <code>
                        ...
                        <div class="row middle">
                            ...
                            <div class="col-sm-7">
                                <input type="text" name="sale_order_no" id="sale_order_no" ondblclick="MsSalesOrderShipDateChange.openSalesOrderSearchWindow()" placeholder=" Click Here" value="" />
                        ...
                        <div class="row middle">
                            <div class="col-sm-5">Prev.Ship Date</div>
                            <div class="col-sm-7">
                                <input type="text" name="old_ship_date" id="old_ship_date" disabled />
                            </div>
                        </div>
                        <div class="row middle">
     ...
     <code>
                        <div class="row middle">
                            <div class="col-sm-5 req-text">Ship Date</div>
                            <div class="col-sm-7">
                                <input type="text" name="ship_date" id="ship_date" class="datepicker" placeholder="yyyy-mm-dd" />
                            </div>
                        </div>
                        <div class="row middle">
   ...
   <div id="employeehrstatusFrmFT" style="padding:0px 0px; text-align:right; background:#F3F3F3;">
    <a href="javascript:void(0)" class="easyui-linkbutton  c1" style="height:25px; border-radius:1px"
     iconCls="icon-save" plain="true" id="save" onClick="MsSalesOrderShipDateChange.submit()">Save</a>
    <a href="javascript:void(0)" class="easyui-linkbutton c6" style="height:25px;border-radius:1px"
     iconCls="icon-remove" plain="true" id="delete" onClick="MsSalesOrderShipDateChange.resetForm()">Reset</a>
    <a href="javascript:void(0)" class=" easyui-linkbutton c5" style="height:25px;border-radius:1px"
     iconCls="icon-remove" plain="true" id="delete" onClick="MsSalesOrderShipDateChange.remove()">Delete</a>
   </div>
  </form>
 </div>
</div>
...
<div id="opensalesordersearchwindow" class="easyui-window" title="Sales Order Search Window"
 ...
 <div class="easyui-layout" data-options="fit:true">
   ...
   <div class="easyui-layout" data-options="fit:true">
    ...
    <p class="footer">
     <a href="javascript:void(0)" class="easyui-linkbutton c2" style="width:70px; height:25px"
      onClick="MsSalesOrderShipDateChange.searchSalesOrder()">Search</a>
    </p>
   </div>
  </div>
  ...
  <div data-options="region:'south',border:false" style="text-align:right;padding:5px 0 0;">
   <a class="easyui-linkbutton c1" data-options="iconCls:'icon-ok'" href="javascript:void(0)"
    onclick="$('#opensalesordersearchwindow').window('close')" style="width:80px">Close</a>
  </div>
 </div>
</div>

<script type="text/javascript" src="<?php echo url('/');?>/js/Util/MsSalesOrderShipDateChangeController.js"></script>
<script>
 (function(){
