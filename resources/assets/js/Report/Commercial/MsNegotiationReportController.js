let MsNegotiationReportModel = require('./MsNegotiationReportModel');
require('./../../datagrid-filter.js');

class MsNegotiationReportController {
	constructor(MsNegotiationReportModel)
	{
   ...
   getbuyersummery(){
		let params=this.getParams();
		let d= axios.get(this.route+'/buyersummery',{params})
		.then(function (response) {
   ...
   showGridBuyer(data)
	...
	getbuyerfollowup(){
		let params=this.getParams();
		let d= axios.get(this.route+'/buyerfollowupdata',{params})
		.then(function (response) {
