...
class MsProdTxtCapacityAchievementGraphDayController {
	...
	createChart(response){
		...
		var txtcapgraphwindowcontainerdaylayoutcenter = document.getElementById('txtcapgraphwindowcontainerdaylayoutcenter');
		txtcapgraphwindowcontainerdaylayoutcenter.innerHTML = '';
		$.each(response.data, function(key, value) {
			...
			var containerid='txtcapgraphwindowcontainerday'+key;
			$('#txtcapgraphwindowcontainerdaylayoutcenter').append('<div id="'+containerid+'"></div>');
			$('#'+containerid).append('<h1 style="background:#ccc ">'+key+'</h1>');
            var canvasid='txtcapgraphwindowcontainerdaycom'+key;
