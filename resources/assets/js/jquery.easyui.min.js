...
//item.domId="_easyui_tree_"+_1c0++; //this was system defult
item.domId=ul.id+"_easyui_tree_"+_1c0++;// I have edited this. 
cc.push("<li>");
...
if(!tree){
//tree=$("<ul></ul>").appendTo(_ac1);//This was system defult
tree=$("<ul id='"+_abf.id+"'></ul>").appendTo(_ac1);// I edit this
_ac0.tree=tree;
}
