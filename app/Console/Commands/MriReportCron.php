...
use App\Mail\SendMailMriReport;
use Mail;
use Illuminate\Support\Facades\DB;
use App\Repositories\Contracts\Marketing\StyleRepository;
use Illuminate\Support\Carbon;

class MriReportCron extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'mrireport:cron';
     ...
     * @var string
     */
    protected $description = 'MRI Report';
    ...
    public function handle()
    {
        ...
        return $q->where('sales_orders.receive_date', '=',$date_to);
        })
        ->where([['sales_orders.order_status','!=',4]])
        ...
        Mail::to(['monzu@lithegroup.com','md@lithegroup.com','siddiquee@lithegroup.com'])->send(new SendMailMriReport($rows));
