...
class ProdFinishDlvRollController extends Controller {
    ...
    ) 
    {
       ...
       /*$this->middleware('permission:view.prodfinishdlvrolls',   ['only' => ['create', 'index','show']]);
        $this->middleware('permission:create.prodfinishdlvrolls', ['only' => ['store']]);
        $this->middleware('permission:edit.prodfinishdlvrolls',   ['only' => ['update']]);
        $this->middleware('permission:delete.prodfinishdlvrolls', ['only' => ['destroy']]); */
    }
