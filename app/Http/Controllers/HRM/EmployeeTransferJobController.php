...
use App\Http\Requests\HRM\EmployeeTransferJobRequest;

class EmployeeTransferJobController extends Controller {
    ...
    public function __construct(
        ...
        $this->middleware('permission:view.employeetransferjobs',   ['only' => ['create', 'index','show']]);
        $this->middleware('permission:create.employeetransferjobs', ['only' => ['store']]);
        $this->middleware('permission:edit.employeetransferjobs',   ['only' => ['update']]);
        $this->middleware('permission:delete.employeetransferjobs', ['only' => ['destroy']]);
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(EmployeeTransferJobRequest $request) {
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(EmployeeTransferJobRequest $request, $id) {
