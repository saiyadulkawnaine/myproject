...
class PoAopServiceShortApprovalController extends Controller
{
 ...
 public function __construct(
  ...
  // $this->middleware('permission:approve.poaopserviceshorts',   ['only' => ['approved', 'index', 'reportData', 'reportDataApp', 'unapproved']]);
 }
 public function index()
 {
  $company = array_prepend(array_pluck($this->company->get(), 'name', 'id'), '-Select-', '');
  $supplier = array_prepend(array_pluck($this->supplier->get(), 'name', 'id'), '-Select-', '');
  return Template::loadView('Approval.PoAopServiceShortApproval', ['company' => $company, 'supplier' => $supplier]);
 }
 public function reportData()
 {
  ...
  $rows = $this->poaopservice
   ...
   ->where([['po_aop_services.po_type_id', '=', 2]])
