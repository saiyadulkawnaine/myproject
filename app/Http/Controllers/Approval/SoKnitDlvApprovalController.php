...
use App\Library\Sms;
class SoKnitDlvApprovalController extends Controller
{
    private $soknitdlv;
    private $user;
    private $buyer;
    ...
    public function __construct(
        ...
        $this->middleware('permission:approve.soknitdlvs',   ['only' => ['approved', 'index','reportData']]);
    ...
    public function index() {
        ...
        return Template::loadView('Approval.SoKnitDlvApproval',['company'=>$company,'buyer'=>$buyer,'currency'=>$currency]);
    }
	...
	public function reportData() {
		return response()->json(
			...
			$join->on('so_knit_dlvs.currency_id', '=', 'currencies.id');
			})
    ...
    public function approved (Request $request)
    {
		...
		$soknitdlv = $this->soknitdlv->update($id,[
			'approved_by' => $user->id,  
	...
	public function reportDataApp() {
		return response()->json(
			...
			->whereNotNull('so_knit_dlvs.approved_at')
			->orderBy('so_knit_dlvs.id','desc')
			->get([
			'so_knit_dlvs.*',
