...
class PoTrimApprovalController extends Controller
{
 private $potrim;
 private $user;
 private $supplier;
 ...
 public function __construct(
  ...
  $this->middleware('permission:approve.potrims',   ['only' => ['approved', 'index', 'reportData', 'reportDataApp']]);
  $this->middleware('permission:unapprove.potrims',   ['only' => ['unapproved']]);
 }
 ...
 public function index()
 {
  ...
  return Template::loadView('Approval.PoTrimApproval', ['company' => $company, 'supplier' => $supplier]);
 }
