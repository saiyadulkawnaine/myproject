...
use App\Library\Sms;
class SoDyeingDlvApprovalController extends Controller
{
    private $sodyeingdlv;
    private $user;
    private $buyer;
    ...
    public function __construct(
        ...
        $this->middleware('permission:approve.sodyeingdlvs',   ['only' => ['approved', 'index','reportData']]);
    ...
    public function index() {
        ...
        return Template::loadView('Approval.SoDyeingDlvApproval',['company'=>$company,'buyer'=>$buyer,'currency'=>$currency]);
    }
	...
	public function reportData() {
		return response()->json(
			...
			->whereNull('so_dyeing_dlvs.approved_at')
    ...
    public function approved (Request $request)
    {
		...
		$sodyeingdlv = $this->sodyeingdlv->update($id,[
			'approved_by' => $user->id,  
    ...
    public function reportDataApp() {
        return response()->json(
        	...
        	->whereNotNull('so_dyeing_dlvs.approved_at')
        	->orderBy('so_dyeing_dlvs.id','desc')
			->get([
				'so_dyeing_dlvs.*',
				'buyers.name as buyer_name',
