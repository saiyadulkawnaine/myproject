...
class PoEmbServiceApprovalController extends Controller
{
  ...
  public function __construct(
    ...
    // $this->middleware('permission:approve.poembservices',   ['only' => ['approved', 'index', 'reportData', 'reportDataApp', 'unapproved']]);
  }
  ...
  public function index()
  {
    ...
    return Template::loadView('Approval.PoEmbServiceApproval', ['company' => $company, 'supplier' => $supplier, 'menu' => $menu]);
  }
