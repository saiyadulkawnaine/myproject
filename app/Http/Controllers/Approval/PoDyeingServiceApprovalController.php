...
use App\Library\Sms;
class PoDyeingServiceApprovalController extends Controller
{
    ...
    public function __construct(
       ...
       $this->middleware('permission:approve.podyeingservices',   ['only' => ['approved', 'index','reportData','reportDataApp','unapproved']]);

    }
    public function index() {
		$company=array_prepend(array_pluck($this->company->get(),'name','id'),'-Select-','');
		$supplier=array_prepend(array_pluck($this->supplier->get(),'name','id'),'-Select-','');
        return Template::loadView('Approval.PoDyeingServiceApproval',['company'=>$company,'supplier'=>$supplier]);
    }
    ...
    public function getDyeingServiceSummery(){
      ...
      //  dd($details);die;
        ...
        return Template::loadView('Approval.PoDyeingServiceApprovalSummeryMatrix',['data'=>$data]);
    }
