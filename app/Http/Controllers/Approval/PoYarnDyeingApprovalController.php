...
class PoYarnDyeingApprovalController extends Controller
{
  ...
  public function __construct(
    ...
    // $this->middleware('permission:approve.PoYarnDyeing',   ['only' => ['approved', 'index','reportData','reportDataApp','unapproved']]);
  }
  ...
  public function index()
  {
    ...
    return Template::loadView('Approval.PoYarnDyeingApproval', ['company' => $company, 'supplier' => $supplier, 'menu' => $menu]);
  }
