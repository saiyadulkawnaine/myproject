...
class PoFabricApprovalController extends Controller
{
 private $pofabric;
 private $user;
 private $supplier;
 ...
 public function __construct(
  ...
  // $this->middleware('permission:approve.pofabrics',   ['only' => ['approved', 'index', 'reportData', 'reportDataApp', 'unapproved']]);
 }
 public function index()
 {
  $company = array_prepend(array_pluck($this->company->get(), 'name', 'id'), '-Select-', '');
  $supplier = array_prepend(array_pluck($this->supplier->get(), 'name', 'id'), '-Select-', '');
  return Template::loadView('Approval.PoFabricApproval', ['company' => $company, 'supplier' => $supplier]);
 }
