...
class ExpRepLcScController extends Controller {
    ...
    public function __construct(ExpRepLcScRepository $expreplcsc,ExpLcScRepository $explcsc) {
        ...
        $this->middleware('permission:view.expreplcscs',   ['only' => ['create', 'index','show']]);
        $this->middleware('permission:create.expreplcscs', ['only' => ['store']]);
        $this->middleware('permission:edit.expreplcscs',   ['only' => ['update']]);
        $this->middleware('permission:delete.expreplcscs', ['only' => ['destroy']]);
    }
