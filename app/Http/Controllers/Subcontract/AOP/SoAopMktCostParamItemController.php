...
use App\Http\Requests\Subcontract\AOP\SoAopMktCostParamItemRequest;

class SoAopMktCostParamItemController extends Controller {
    ...
    public function __construct(
        ...
        SoAopMktCostParamItemRepository $soaopmktcostparamitem,
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(SoAopMktCostParamItemRequest $request) {
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(SoAopMktCostParamItemRequest $request, $id) {
