...
class SoDyeingFabricRcvInhController extends Controller {
    ...
    public function __construct(
        ...
        $this->middleware('permission:view.sodyeingfabricrcvinhs',   ['only' => ['create', 'index','show']]);
        $this->middleware('permission:create.sodyeingfabricrcvinhs', ['only' => ['store']]);
        $this->middleware('permission:edit.sodyeingfabricrcvinhs',   ['only' => ['update']]);
        $this->middleware('permission:delete.sodyeingfabricrcvinhs', ['only' => ['destroy']]);
    ...
    public function index() {
       return response()->json(
          ...
          ->join('companies as companybuyer', function($join)  {
          $join->on('companybuyer.id', '=', 'buyers.company_id');
          })
          ->where([['so_dyeing_fabric_rcvs.is_self','=',1]])
    ...
    public function create(Request $request) {
        ...
        return Template::LoadView('Subcontract.Dyeing.SoDyeingFabricRcvInh',['company'=>$company,'buyer'=>$buyer,'uom'=>$uom,'currency'=>$currency]);
    }
