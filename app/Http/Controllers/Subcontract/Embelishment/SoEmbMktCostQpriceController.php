...
use App\Http\Requests\Subcontract\Embelishment\SoEmbMktCostQpriceRequest;

class SoEmbMktCostQpriceController extends Controller {
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(SoEmbMktCostQpriceRequest $request) {
    ...
    public function edit($id) {
        ...
        $row ['fromData'] = $rows;
        $dropdown['soaopmktcostqpricedtlcosi'] = "'".Template::loadView('Subcontract.AOP.SoEmbMktCostQpricedtlMatrix',['rows'=>$new,'saved'=>$saved])."'";
    ...
    public function update(SoEmbMktCostQpriceRequest $request, $id) {
    ...
    public function getPdf(){
        ...
        $view= \View::make('Defult.Subcontract.AOP.SoEmbMktCostQuotationPdf',[
            'datas'=>$datas,
            'is_html'=>0,
        ]);
        ...
        $filename = storage_path() . '/SoEmbMktCostQuotationPdf.pdf';
        $pdf->output($filename);
    }
    ...
    public function getHtml () {
        ...
        return Template::loadView('Subcontract.AOP.SoEmbMktCostQuotationPdf', [
            'datas'=>$datas,
            'company'=>$company,
            'is_html'=>1,
