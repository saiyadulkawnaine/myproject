...
use App\Http\Requests\Subcontract\Embelishment\SoEmbMktCostRequest;

class SoEmbMktCostController extends Controller {
    ...
    public function index() {
      ...
      ->where([['sub_inb_marketings.production_area_id','=',45]])
    ...
    public function create() {
        ...
        return Template::LoadView('Subcontract.Embelishment.SoEmbMktCost',[
          'company'=>$company,
          'buyer'=>$buyer,
          'uom'=>$uom,
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(SoEmbMktCostRequest $request) {
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(SoEmbMktCostRequest $request, $id) {
