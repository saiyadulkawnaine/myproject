...
class PoYarnDyeingItemController extends Controller
{
   ...
   private $colorrange;
    ...
    )
	{
		...
		$this->middleware('permission:view.poyarndyeingitems',   ['only' => ['create', 'index','show']]);
		$this->middleware('permission:create.poyarndyeingitems', ['only' => ['store']]);
		$this->middleware('permission:edit.poyarndyeingitems',   ['only' => ['update']]);
		$this->middleware('permission:delete.poyarndyeingitems', ['only' => ['destroy']]);
	}
    ...
    {
      $poyarndyeingitem = $this->poyarndyeingitem->update($id, 
      [
        //'po_yarn_dyeing_id'=>$request->po_yarn_dyeing_id,
        //'inv_yarn_item_id'=>$request->inv_yarn_item_id,
        //'qty'=>$request->qty,
