...
class PoYarnDyeingItemBomQtyController extends Controller
{
   ...
   private $colorrange;
  ...
  )
	{
        ...
        $this->middleware('permission:view.poyarndyeingitembomqties',   ['only' => ['create', 'index','show']]);
        $this->middleware('permission:create.poyarndyeingitembomqties', ['only' => ['store']]);
        $this->middleware('permission:edit.poyarndyeingitembomqties',   ['only' => ['update']]);
        $this->middleware('permission:delete.poyarndyeingitembomqties', ['only' => ['destroy']]);
	}
