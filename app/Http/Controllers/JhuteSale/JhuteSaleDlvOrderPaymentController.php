...
use App\Http\Requests\JhuteSale\JhuteSaleDlvOrderPaymentRequest;

class JhuteSaleDlvOrderPaymentController extends Controller
{
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(JhuteSaleDlvOrderPaymentRequest $request)
    {
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(JhuteSaleDlvOrderPaymentRequest $request,$id)
    {
