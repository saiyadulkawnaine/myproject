...
class CentralSewingPlanController extends Controller
{
	private $style;
	private $company;
	private $buyer;
    ...
    public function index() 
    {
        ...
        return Template::loadView('Report.CentralSewingPlan',['company'=>$company,'buyer'=>$buyer]);
    }
    ...
    private function getData()
    {
        ...
        foreach($gmtitems as $gmtitem)
        {
        	...
        	$smvArr[$gmtitem->entry_id][]=$gmtitem->smv;
        ...
        ->map(function($data) use($gmtArr,$smvArr) {
        	...
        	$data->smv=array_sum($smvArr[$data->entry_id]);
        	$data->booked_minute=$data->qty*$data->smv;
        	$data->remarks='';
