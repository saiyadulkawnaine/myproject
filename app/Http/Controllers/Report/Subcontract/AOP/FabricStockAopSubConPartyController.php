...
class FabricStockAopSubConPartyController extends Controller
{
  ...
  public function index() {
    ...
    return Template::loadView('Report.Subcontract.AOP.FabricStockSubConAopParty',[]);
  }
  public function reportData() {
        ...
        where buyer_natures.contact_nature_id = 58) m group by m.buyer_name,m.id order by m.id
    ...
    public function receiveDtl(){
        ...
        $buyerCond='';
        if($buyer_id){
          $buyerCond= ' and so_aops.buyer_id= '.$buyer_id;
        }
        else{
          $buyerCond= '';
        }
        ...
        $results = collect(
          \DB::select("
				...
				join so_aop_fabric_rcv_items on so_aop_fabric_rcvs.id=so_aop_fabric_rcv_items.so_aop_fabric_rcv_id
				join so_aops on so_aops.id=so_aop_fabric_rcvs.so_aop_id
				join so_aop_items on so_aop_items.so_aop_ref_id=so_aop_fabric_rcv_items.so_aop_ref_id
				left join colors on colors.id=so_aop_items.fabric_color_id
				left join colorranges on colorranges.id=so_aop_items.colorrange_id
				left join gmtsparts on gmtsparts.id=so_aop_items.gmtspart_id
				where 
				so_aop_fabric_rcvs.receive_date >= ?
				and so_aop_fabric_rcvs.receive_date <= ?
				$buyerCond
    ...
    public function usedDtl(){
        ...
        $buyerCond='';
        if($buyer_id){
          $buyerCond= ' and so_aop_dlvs.buyer_id= '.$buyer_id;
        }
        else{
          $buyerCond= '';
        }
        ...
        $results = collect(
          \DB::select("
			...
			sum(so_aop_dlv_items.grey_used)*greyusedrate.rate as amount
			from 
			so_aop_dlvs
			join so_aop_dlv_items on so_aop_dlvs.id=so_aop_dlv_items.so_aop_dlv_id
			join so_aop_items on so_aop_items.so_aop_ref_id=so_aop_dlv_items.so_aop_ref_id
			left join colors on colors.id=so_aop_items.fabric_color_id
			left join colorranges on colorranges.id=so_aop_items.colorrange_id
			left join gmtsparts on gmtsparts.id=so_aop_items.gmtspart_id
			join(
    ...
    public function returnDtl(){
        ...
        $buyerCond='';
        if($buyer_id){
          $buyerCond= ' and so_aop_fabric_rtns.buyer_id= '.$buyer_id;
        }
        else{
          $buyerCond= '';
        }
        ...
        $results = collect(
          \DB::select("
			...
			so_aop_fabric_rtns
			join so_aop_fabric_rtn_items on so_aop_fabric_rtns.id=so_aop_fabric_rtn_items.so_aop_fabric_rtn_id
			join so_aop_items on so_aop_items.so_aop_ref_id=so_aop_fabric_rtn_items.so_aop_ref_id
			left join colors on colors.id=so_aop_items.fabric_color_id
			left join colorranges on colorranges.id=so_aop_items.colorrange_id
			left join gmtsparts on gmtsparts.id=so_aop_items.gmtspart_id
			join(
			...
			and so_aop_fabric_rtns.return_date <= ?
			$buyerCond
			and so_aop_fabric_rtns.company_id=6
			and so_aop_fabric_rtn_items.deleted_at is null
			and so_aop_fabric_rtns.deleted_at is null
			group by 
			so_aop_fabric_rtns.buyer_id,
    ...
    public function closingDtl(){
        ...
        $results = collect(
          \DB::select("
			...
			so_aops.buyer_id,
			so_aop_fabric_rcv_items.so_aop_ref_id
			) fabric_rcv_opening on  so_aop_fabric_rcv_items.so_aop_ref_id=fabric_rcv_opening.so_aop_ref_id
			...
			so_aop_dlv_items.so_aop_ref_id,
			greyusedrate.rate
			) fabric_dlv_opening on  so_aop_fabric_rcv_items.so_aop_ref_id=fabric_dlv_opening.so_aop_ref_id
			...
			so_aop_fabric_rtn_items.so_aop_ref_id,
			greyrtnrate.rate
			) fabric_rtn_opening on  so_aop_fabric_rcv_items.so_aop_ref_id=fabric_rtn_opening.so_aop_ref_id
			...
			so_aops.buyer_id,
			so_aop_fabric_rcv_items.so_aop_ref_id
			) fabric_rcv on  so_aop_fabric_rcv_items.so_aop_ref_id=fabric_rcv.so_aop_ref_id
			...
			so_aop_dlv_items.so_aop_ref_id,
			greyusedrate.rate
			) fabric_dlv on  so_aop_fabric_rcv_items.so_aop_ref_id=fabric_dlv.so_aop_ref_id
			...
			so_aop_fabric_rtn_items.so_aop_ref_id,
			greyrtnrate.rate
			) fabric_rtn on   so_aop_fabric_rcv_items.so_aop_ref_id=fabric_rtn.so_aop_ref_id
			where 
			so_aop_fabric_rcvs.receive_date <= ?
			$buyerCond
			and so_aops.company_id=6
			...
			and so_aop_fabric_rcvs.deleted_at is null
			and so_aops.deleted_at is null
			and so_aop_items.deleted_at is null
			group by
			so_aops.buyer_id,
			so_aop_fabric_rcv_items.so_aop_ref_id,
			so_aop_items.autoyarn_id,
