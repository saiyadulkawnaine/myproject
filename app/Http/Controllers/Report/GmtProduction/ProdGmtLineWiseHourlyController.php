...
class ProdGmtLineWiseHourlyController extends Controller
{
  private $subsection;
  ...
  private $prodgmtsewing;
    ...
    public function index() {
      ...
      return Template::loadView('Report.GmtProduction.ProdGmtLineWiseHourly',['location'=> $location,'productionsource'=> $productionsource,'shiftname'=> $shiftname,'ordersource'=>$ordersource,'company'=>$company,'supplier'=>$supplier,'buyer'=>$buyer]);
    }
     ...
     $currentItem=array();
      ...
      $prods = collect(
        \DB::select("
            ...
            order by m.id
            ",[$date_to,$date_to,$company_id,$date_to])
        );
...
//target
      ...
      if($used_mint)
      {
        ...
        $prodgmtsewing->effi_per=number_format($prodgmtsewing->produced_mint/$used_mint*100,0)." %";
      }
      ...
      //$prodgmtsewing->cm_earned_tk=number_format($cm*82,2);
      ...
      $prodgmtsewing->cm_earned_tk=number_format($cm_earned_usd*82,2);
      ...
      $prodgmtsewing->prodused_fob_tk=number_format($prodgmtsewing->prodused_fob*82,2);
      ...
      $prodgmtsewing->day_target=number_format($day_target,0);
      $prodgmtsewing->target_per_hour_ach=number_format($target_per_hour_ach,2)." %";
      $prodgmtsewing->target_per_hour_var=number_format($target_per_hour_var,0);
      $prodgmtsewing->actual_terget=number_format($prodgmtsewing->actual_terget,0);
