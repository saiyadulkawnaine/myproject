...
class GlOpnController extends Controller
{
	private $company;
	private $accyear;
	private $buyer;
    ...
    public function index() {
      ...
      return Template::loadView('Report.Account.GlOpn',['company'=>$company,'accyear'=>$accyear]);
    }
...
//==============
	...
	public function html() {
		return Template::loadView('Report.Account.GlDataOpn',$this->getData());
    }
	...
	$view= \View::make('Defult.Report.Account.GlDataPdfOpn',$data);
