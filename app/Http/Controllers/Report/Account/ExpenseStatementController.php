...
class ExpenseStatementController extends Controller
{
	...
	)
    {
		...
		//$this->middleware('permission:view.expensestatement',   ['only' => ['create', 'index','show']]);
    }
    public function index() {
      ...
      return Template::loadView('Report.Account.ExpenseStatement',['company'=>$company,'accyear'=>$accyear,'profitcenter'=>$profitcenter]);
    }
    ...
    public function getPeriods(){
     ...
     private function getData()
     {
		...
		return ['data'=>$reportData,'company'=>$company,'accchartgroup'=>$accchartgroup,'lastPeriod'=>$lastPeriod,'currentPeriod'=>$currentPeriod,'yearUpto'=>$yearUpto];
     }
	public function html() {
		return Template::loadView('Report.Account.ExpenseStatementData',$this->getData());
    }
	...
	$view= \View::make('Defult.Report.Account.ExpenseStatementDataPdf',$data);
	$html_content=$view->render();
	$pdf->SetY(42);
	$pdf->WriteHtml($html_content, true, false,true,false,'');
    $filename = storage_path() . '/ExpenseStatementDataPdf.pdf';
