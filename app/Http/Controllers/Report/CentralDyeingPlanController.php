...
class CentralDyeingPlanController extends Controller
{
	private $style;
	private $company;
	private $buyer;
    ...
    public function index() 
    {
        ...
        return Template::loadView('Report.CentralDyeingPlan',['company'=>$company,'buyer'=>$buyer]);
    }
    ...
    private function getData()
    {
        ...
        \DB::select("
			    ...
			    where target_transfers.process_id=2 $company $buyer  $datefrom  $dateto
        ...
        ->map(function($data) use($gmtArr) {
			...
			$dyeingDays = $date_to->diffInDays($date_from)+1;
			...
			$data->no_of_line=0;//ceil($data->qty/$dyeingDays/2200);
