...
use App\Http\Requests\Inventory\GeneralStore\InvGeneralIsuRtnItemRequest;

class InvGeneralIsuRtnItemController extends Controller {
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(InvGeneralIsuRtnItemRequest $request) {
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(InvGeneralIsuRtnItemRequest $request, $id) {
      $invyarnrcv=$this->invrcv->find($request->inv_rcv_id);
    ...
    public function getOrder()
    {
          ...
          $invrcv=$this->invrcv->find(request('inv_general_rcv_id',0));
          $rows=$this->job
          ->join('sales_orders', function($join){
