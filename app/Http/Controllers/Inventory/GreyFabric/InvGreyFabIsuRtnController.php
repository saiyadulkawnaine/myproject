...
use App\Http\Requests\Inventory\GreyFabric\InvGreyFabIsuRtnRequest;

class InvGreyFabIsuRtnController extends Controller {
    ...
    public function create() {
      ...
      return Template::loadView('Inventory.GreyFabric.InvGreyFabIsuRtn',['company'=>$company,'currency'=>$currency, 'invreceivebasis'=>$invreceivebasis,'supplier'=>$supplier,'store'=>$store,'menu'=>$menu]);
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(InvGreyFabIsuRtnRequest $request) {
      $max=$this->invrcv
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(InvGreyFabIsuRtnRequest $request, $id) {
        $invgreyfabrcv=$this->invrcv->update($id,$request->except(['id','inv_grey_fab_rcv_id','company_id','receive_basis_id','receive_against_id','supplier_id','from_company_id']));
        if($invgreyfabrcv){
