...
use App\Http\Requests\Inventory\GreyFabric\InvGreyFabIsuRequest;

class InvGreyFabIsuController extends Controller {
    ...
    public function create() {
        ...
        return Template::loadView('Inventory.GreyFabric.InvGreyFabIsu',['company'=>$company,'currency'=>$currency,'purchasesource'=>$purchasesource, 'invissuebasis'=>$invissuebasis,'supplier'=>$supplier,'store'=>$store,'menu'=>$menu,'location'=>$location,'buyer'=>$buyer]);
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(InvGreyFabIsuRequest $request) {
        $max=$this->invisu
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(InvGreyFabIsuRequest $request, $id) {
    ...
    public function getPdf()
    {
        ...
        $header['title']='Grey Fabric Issue Challan / Gate Pass';
        ...
        $pdf->SetTitle('Grey Fabric Issue Challan / Gate Pass');
    ...
    public function getPdfTwo()
    {
        ...
        sum(m.qty) as qty,
        sum(m.qty_pcs) as qty_pcs,
        m.prod_knit_item_roll_id as number_of_roll 
        from (
        select 
        inv_grey_fab_isu_items.qty,
        prod_knit_dlv_rolls.id, 
        ...
        $prodknitqc->machine_info=$prodknitqc->machine_no.", ".$prodknitqc->machine_dia." x ".$prodknitqc->machine_gg;
        $prodknitqc->machine_info=$prodknitqc->machine_no?$prodknitqc->machine_info:$prodknitqc->machine_info_outside;
        return $prodknitqc;
        });
