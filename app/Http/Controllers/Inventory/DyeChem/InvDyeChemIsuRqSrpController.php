...
use App\Http\Requests\Inventory\DyeChem\InvDyeChemIsuRqSrpRequest;

class InvDyeChemIsuRqSrpController extends Controller {
    ...
    public function __construct(
        ...
        $this->middleware('permission:view.invdyechemisurqsrp',   ['only' => ['create', 'index','show']]);
        $this->middleware('permission:create.invdyechemisurqsrp', ['only' => ['store']]);
        $this->middleware('permission:edit.invdyechemisurqsrp',   ['only' => ['update']]);
        $this->middleware('permission:delete.invdyechemisurqsrp', ['only' => ['destroy']]);
    }
    ...
    public function create() {
      ...
      $aoptype=array_prepend(array_pluck($this->embelishmenttype->getEmbelishmentTypes(),'name','id'),'-Select-','');



      return Template::loadView('Inventory.DyeChem.InvDyeChemIsuRqSrp',['company'=>$company,'location'=>$location, 'buyer'=>$buyer, 'colorrange'=>$colorrange,'dyeingsubprocess'=>$dyeingsubprocess,'aoptype'=>$aoptype]);
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(InvDyeChemIsuRqSrpRequest $request) {
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(InvDyeChemIsuRqSrpRequest $request, $id) {
