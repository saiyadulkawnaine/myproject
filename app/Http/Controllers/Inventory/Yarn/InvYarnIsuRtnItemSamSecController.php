...
use App\Http\Requests\Inventory\Yarn\InvYarnIsuRtnItemSamSecRequest;

class InvYarnIsuRtnItemSamSecController extends Controller {
    private $invrcv;
    private $invyarnrcv;
    ...
    public function store(InvYarnIsuRtnItemSamSecRequest $request) {
    ...
    public function edit($id) {
       ...
       ->map(function($rows) use($yarnDropdown) {
        ...
        $join->on('styles.id','=','inv_yarn_rcv_items.style_id');
        })
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(InvYarnIsuRtnItemSamSecRequest $request, $id) {
