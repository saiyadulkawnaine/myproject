...
use App\Http\Requests\Inventory\Yarn\InvYarnIsuRtnRequest;

class InvYarnIsuRtnController extends Controller {
    ...
    public function create() {
      $invreceivebasis=array_prepend(array_only(config('bprs.invreceivebasis'),[4]), '-Select-','');
      ...
      return Template::loadView('Inventory.Yarn.InvYarnIsuRtn',['company'=>$company,'currency'=>$currency,'invreceivebasis'=>$invreceivebasis, 'supplier'=>$supplier,'store'=>$store,'location'=>$location,'menu'=>$menu]);
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(InvYarnIsuRtnRequest $request) {
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(InvYarnIsuRtnRequest $request, $id) {
